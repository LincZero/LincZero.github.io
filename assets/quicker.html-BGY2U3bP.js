import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,a as p}from"./app-BAt33Ddg.js";const t={},o=p(`<p>甚至可视化编程</p><p>这里以一个最简单的程序（单斜杠转化为双斜杠格式）为例，看一下这个动作导出的格式：</p><p>本质是一个json存储的节点树，而非代码存储</p><div class="language-json line-numbers-mode" data-ext="json" data-title="json"><pre class="language-json"><code><span class="token punctuation">{</span>

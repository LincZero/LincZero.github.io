import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,a as e}from"./app-pvGL4vXS.js";const t={},i=e(`<h1 id="文件" tabindex="-1"><a class="header-anchor" href="#文件"><span>文件</span></a></h1><p>核心：</p><ul><li>os包，及里面的File结构体，可以开关文件。详见 studygolang.com/pkgdoc</li><li>io包，io流相关，可以读写文件。</li><li>io/ioutil包，读写文件</li></ul><p>核心操作：</p><ul><li>内容操作：开 闭 写 读</li><li>整体操作：增 删 剪 拷</li></ul><h2 id="文件打开" tabindex="-1"><a class="header-anchor" href="#文件打开"><span>文件打开</span></a></h2><h3 id="os-open" tabindex="-1"><a class="header-anchor" href="#os-open"><span>os.Open</span></a></h3><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token comment">// 原型</span>

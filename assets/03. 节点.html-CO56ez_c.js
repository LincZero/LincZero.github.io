import{_ as d,c as f,e as r,b as n,a as t,f as e,d as o,o as c,r as s}from"./app-C-bjNnVy.js";const _={},u={href:"https://www.bilibili.com/video/BV1pZ421b7t7/",target:"_blank",rel:"noopener noreferrer"};function b(v,l){const i=s("VueFlow"),a=s("ExternalLinkIcon");return c(),f("div",null,[l[2]||(l[2]=r('<h1 id="节点" tabindex="-1"><a class="header-anchor" href="#节点"><span>节点</span></a></h1><p>右键可以新键节点</p><h2 id="按工作流" tabindex="-1"><a class="header-anchor" href="#按工作流"><span>按工作流</span></a></h2><h3 id="默认文生图工作流" tabindex="-1"><a class="header-anchor" href="#默认文生图工作流"><span>默认文生图工作流</span></a></h3>',4)),n(i,{type:"nodeflow-list",data:`- nodes

import{_ as o,e as n,g as l,f as t,k as e,j as s,o as i}from"./app-DpI9FnpE.js";const a={};function d(f,r){return i(),n("div",null,r[0]||(r[0]=[l('<h1 id="文件分类系统" tabindex="-1"><a class="header-anchor" href="#文件分类系统"><span>文件分类系统</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="v5-提出er层的概念" tabindex="-1"><a class="header-anchor" href="#v5-提出er层的概念"><span>V5（提出Er层的概念）</span></a></h1><h2 id="概念" tabindex="-1"><a class="header-anchor" href="#概念"><span>概念</span></a></h2><h3 id="分类优先级" tabindex="-1"><a class="header-anchor" href="#分类优先级"><span>分类优先级</span></a></h3><p>分类优先级</p><ul><li>第零分类: 物理隔绝</li><li>第一分类: 隐私安全</li><li>第二分类: 性能类型<br> （常见误区: 该分类是区分的文件类型, 然后文件再按照文件类型区分. 例如Video是可编辑资源, 但电影是只读资源, 但应该分类到Editor而非Viewer）<br> （?????? 但设计开发与数据生产类就不符合了吧，网易云酷狗这种你能把他归纳到Editor里吗，编辑器和查看器相分离到底是不是一个好主意？）<br> （判断的一个依据是，原图/原视频是否具有较好的独立观赏性。<br> 例如电影混剪好看，但电影单独就已经相当好看了，而像电影的一些特效素材等没有观赏性。<br> 再比如一张需要ps或加工的图原本就好看，但一些独立的素材本身并不剧本什么观赏性） <ul><li>Viewer (学习类) &gt; Editor &gt; Viewer (其他)</li><li>实物格式 &gt;&gt; 电子格式 (隔绝)</li></ul></li><li>第三分类: 内容 (适用场景: 如果没有性能区别, 就按内容区分)</li><li>第四分类: 交互对象</li></ul><h3 id="层" tabindex="-1"><a class="header-anchor" href="#层"><span>层</span></a></h3><p>层的补充, 为了一致性, 我们对层的称呼不是嵌套层数 (前缀表示的是该路径下的内容属于第几层, 而非该路径属于第几层)<br> 巧记: <mark>硬盘隔绝第零层, 资源软件第一层, 无嵌Er第二层</mark>. 之所以叫Er层, 是因为该层下的文件夹基本都以er结尾.<br> 一般到了Er层后我们就不叫第二层了, 只叫Er层, 因为<strong>Er层是能嵌套的</strong>. Er层不一定是第二层, 第二层一般是但不一定是Er层 (比如C/C_PC).</p>',9),t("div",{class:"ab-note drop-shadow"},[t("div",{class:"ab-list-table-parent"},[t("table",{class:"ab-table ab-list-table ab-table-folder"},[t("tbody",null,[t("tr",{class:"ab-foldable-tr",tr_level:"0",is_fold:"false",able_fold:"true",type:"零层 Local"},[t("td",{rowspan:"1",onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
...
`},[t("td",{rowspan:"1",onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
          ...
          `},[t("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round",class:"lucide lucide-fold-vertical-icon lucide-fold-vertical"},[t("path",{d:"M12 22v-6"}),t("path",{d:"M12 8V2"}),t("path",{d:"M4 12H2"}),t("path",{d:"M10 12H8"}),t("path",{d:"M16 12h-2"}),t("path",{d:"M22 12h-2"}),t("path",{d:"m15 19-3-3-3 3"}),t("path",{d:"m15 5-3 3-3-3"})])])])],-1),l('<h3 id="er层结构" tabindex="-1"><a class="header-anchor" href="#er层结构"><span>Er层结构</span></a></h3><h4 id="大er层" tabindex="-1"><a class="header-anchor" href="#大er层"><span>大Er层</span></a></h4><p>结构</p><ul><li>Data Er层 - 数据 Er层</li><li>Abst Er层 - 抽象 Er层</li><li>Enti Er层 - 实物 Er层</li></ul><p>在旧笔记名中</p><ul><li><ol><li>DesignAndDevelop，<s>01. 设计开发与数据生产</s></li></ol></li><li><ol start="2"><li>SubjectAndKnowledge，<s>02. 十二门类与纯粹知识</s></li></ol></li><li><ol start="3"><li>SkillAndProduction，<s>03. 生活技能与生活生产</s> (部分冲突)</li></ol></li><li>私人</li></ul><h4 id="data-er层" tabindex="-1"><a class="header-anchor" href="#data-er层"><span>Data Er层</span></a></h4><p>Data Er层</p>',8),t("div",{class:"ab-note drop-shadow"},[t("div",{class:"ab-list-table-parent"},[t("table",{class:"ab-table ab-list-table ab-table-folder"},[t("tbody",null,[t("tr",{class:"ab-foldable-tr",tr_level:"0",is_fold:"false",able_fold:"true",type:"Editor"},[t("td",{rowspan:"1",onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
            const l_tr = tr.parentNode.querySelectorAll("tr")
            const i = 0
...
`},[t("td",{rowspan:"1",onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
          ...
          `},[t("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round",class:"lucide lucide-fold-vertical-icon lucide-fold-vertical"},[t("path",{d:"M12 22v-6"}),t("path",{d:"M12 8V2"}),t("path",{d:"M4 12H2"}),t("path",{d:"M10 12H8"}),t("path",{d:"M16 12h-2"}),t("path",{d:"M22 12h-2"}),t("path",{d:"m15 19-3-3-3 3"}),t("path",{d:"m15 5-3 3-3-3"})])])])],-1),l('<h3 id="q" tabindex="-1"><a class="header-anchor" href="#q"><span>Q</span></a></h3><h4 id="到底是否应该分开专业知识和生活知识" tabindex="-1"><a class="header-anchor" href="#到底是否应该分开专业知识和生活知识"><span>到底是否应该分开专业知识和生活知识？</span></a></h4><p>有两个情况：</p><ul><li>Editor &amp; Other</li><li>十二门类 &amp; 生活技能</li></ul><p>明确Soft不分开，Soft没必要分开得太死，不过万能查看器怎么办</p><h4 id="soft分公有和私有吗" tabindex="-1"><a class="header-anchor" href="#soft分公有和私有吗"><span>Soft分公有和私有吗</span></a></h4><p>目前没见过私有软件，破解软件应该不算？</p><p>至少Soft_Local没有分享忌讳，应该不分</p><h4 id="图床与git" tabindex="-1"><a class="header-anchor" href="#图床与git"><span>图床与Git</span></a></h4><p>图床可以进一步地提高性能分割度，使纯文本笔记能够快速备份和同步</p><h2 id="v5-0-beta3" tabindex="-1"><a class="header-anchor" href="#v5-0-beta3"><span>V5.0 Beta3</span></a></h2><p><strong>（彻底不让Er嵌套了）</strong></p><h3 id="根" tabindex="-1"><a class="header-anchor" href="#根"><span>根</span></a></h3>',13),t("div",{class:"ab-note drop-shadow"},[t("div",{class:"ab-list-table-parent"},[t("table",{class:"ab-table ab-list-table ab-table-folder"},[t("tbody",null,[t("tr",{class:"ab-foldable-tr",tr_level:"0",is_fold:"false",able_fold:"true",type:"Local"},[t("td",{rowspan:"1",onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
            const l_tr = tr.parentNode.querySelectorAll("tr")
            const i = 0

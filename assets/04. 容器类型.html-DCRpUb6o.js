...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="【高级容器】boost-any" tabindex="-1"><a class="header-anchor" href="#【高级容器】boost-any"><span>【高级容器】Boost::any</span></a></h2>`,37),u={href:"https://www.cnblogs.com/qiangxia/p/4578667.html",target:"_blank",rel:"noopener noreferrer"},v=l(`<h3 id="使用-4" tabindex="-1"><a class="header-anchor" href="#使用-4"><span>使用</span></a></h3><p>用法示例（一个可以存任意不同类型的数组，类似于python的列表）</p><p>补充：Python列表的原理：参考：https://cloud.tencent.com/developer/article/1820193</p><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>#include &lt;iostream&gt;
#include &lt;list&gt;

import{_ as s,c as d,e as t,a as n,b as i,d as a,o as r,r as c}from"./app-CR1DZRQy.js";const v={},p={href:"https://www.cnblogs.com/qicosmos/p/4325949.html",target:"_blank",rel:"noopener noreferrer"},m={href:"https://blog.csdn.net/alex1997222/article/details/78639991",target:"_blank",rel:"noopener noreferrer"},o={href:"https://www.cnblogs.com/ProjectDD/p/11796998.html",target:"_blank",rel:"noopener noreferrer"};function u(h,e){const l=c("ExternalLinkIcon");return r(),d("div",null,[e[4]||(e[4]=t('<h1 id="c" tabindex="-1"><a class="header-anchor" href="#c"><span>C++</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="可变参数模板-variadic-templates" tabindex="-1"><a class="header-anchor" href="#可变参数模板-variadic-templates"><span>可变参数模板 Variadic Templates</span></a></h1><p>本篇参考：</p>',4)),n("ul",null,[n("li",null,[n("a",p,[e[0]||(e[0]=i("【博客园】泛化之美--C++11可变模版参数的妙用")),a(l)])]),n("li",null,[n("a",m,[e[1]||(e[1]=i("【CSDN】C++可变参数的两种方法")),a(l)])]),n("li",null,[e[3]||(e[3]=i("感觉有点像ts的三点运算符，")),n("a",o,[e[2]||(e[2]=i("【博客园】ts中的三点运算符")),a(l)])])]),e[5]||(e[5]=t(`<h2 id="可变参数函数" tabindex="-1"><a class="header-anchor" href="#可变参数函数"><span>可变参数函数</span></a></h2><p>三个点<code>...</code>的写法以前就有，但不是在模板里</p><p>printf 源码</p><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>int __cdecl printf (
	const char *fromat,
	...	// 可以接受任意变量
	)
{

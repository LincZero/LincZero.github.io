...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></div></div></div><p>class Filesplitter // 文件分割器（把大文件分割成多个小文件方便拷贝） { string m_filePath; int m_fileNumber; //ProgressBar* m_progressBar; IProgress* m_iprogress; // 【新增】抽象通知机制 public: FileSplitter(const string&amp; filePath, int fileNumber ,IProgressBar* iprogressBar // 【新增】传入通知机制 ): m_filePath(filePath), m_progress(iprogress), // 【新增】初始化通知机制 m_fileNumber(fileNumber){// 传入文件和文件分割数量</p><pre><code>}
...
</code></pre><p>protected: void onProgress(float value){ // 【新增】更新通知机制 if(m_iprogress != nullptr){ m_iprogress-&gt;DoProgress(value); } } };</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>
运行代码

import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as i,c as n,e as a}from"./app-DB4LL_FL.js";const s={},l=a(`<h1 id="autohotkey" tabindex="-1"><a class="header-anchor" href="#autohotkey"><span>AutoHotKey</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="常用命令" tabindex="-1"><a class="header-anchor" href="#常用命令"><span>常用命令</span></a></h1><h2 id="输入识别类" tabindex="-1"><a class="header-anchor" href="#输入识别类"><span>输入识别类</span></a></h2><h3 id="热键" tabindex="-1"><a class="header-anchor" href="#热键"><span>热键</span></a></h3><div class="language-assembly line-numbers-mode" data-ext="assembly" data-title="assembly"><pre class="language-assembly"><code>^j::

import{_ as d,c as p,b as n,a as t,d as i,f as e,e as l,r as a,o as h}from"./app-DKMVrBFj.js";const f={};function c(_,s){const o=a("Mermaid"),r=a("VPIcon");return h(),p("div",null,[s[13]||(s[13]=n(`<h1 id="vuepress-hope主题-源码分析" tabindex="-1">Vuepress Hope主题 源码分析</h1><h2 id="贡献指南" tabindex="-1">贡献指南</h2><p>https://theme-hope.vuejs.press/zh/contribution.html，这个位置有点迷，研究走了点弯路后，我才看到有这么一页，居然要点 &quot;常见问题&quot; 才能在这个完整版的侧边栏底部看到</p><h3 id="项目文件结构" tabindex="-1">项目文件结构</h3><p>本项目是一个 monorepo，使用 pnpm 管理。</p><ul><li>docs: 放置各插件与主题的文档，每个子文件夹为一个项目</li><li>demo: 主题演示项目</li><li>packages: 放置各<strong>插件与主题</strong>的代码，每个子文件夹为一个项目</li></ul><div class="language-js line-numbers-mode" data-highlighter="shiki" data-ext="js" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-js"><span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">.</span></span>

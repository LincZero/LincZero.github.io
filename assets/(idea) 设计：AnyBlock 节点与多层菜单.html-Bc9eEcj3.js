import{_ as n,c as a,b as i,a as t,d as e,f as l,o as r}from"./app-DKxZAgoa.js";const o={};function d(c,s){return r(),a("div",null,[...s[0]||(s[0]=[i('<h1 id="idea-设计-anyblock-节点与多层菜单" tabindex="-1">(idea) 设计：AnyBlock 节点与多层菜单</h1><h2 id="介绍" tabindex="-1">介绍</h2><h3 id="应用场景" tabindex="-1">应用场景</h3><p>一是表单、二是节点转用表单</p><h3 id="对比" tabindex="-1">对比</h3><ul><li>json类型 <ul><li>类型(8): Number、String、Boolean、Array/Object、null、Value(any)、Whitespace</li><li>但最后两种没怎么见过，只适配6种应该也行</li></ul></li><li>请求表单 - json <ul><li>类型(8)：string、integer/number、boolean、array <strong>/object、null/any</strong></li></ul></li><li>请求表单 - params <ul><li>类型(6): string、integer/number、boolean、array、<strong>file</strong></li></ul></li><li>请求表单 - 表单实体 <ul><li>基本同上，但输入框类型还分：数字类型(是否密码)/文本单多行属性/约束等等</li></ul></li><li>节点表单类型 <ul><li>新增节点输入、节点输出类型<br> (特点：允许给一个字符串作为二次类型、通常没有Key名字，取之替代的是二次类型名)</li></ul></li><li>简化 - Schema码类型 <ul><li>删除了嵌套功能，节点类型删除Object/Array</li><li>删除了约束 (范围、必填等)</li><li>主要属性：&quot;type&quot;、&quot;default&quot;</li></ul></li></ul><h3 id="相似产品" tabindex="-1">相似产品</h3><p>我记得 plantuml 有一个东西可以用于 UI 页面的绘制，甚至能着色、绘制按钮、显示菜单的展开状态等</p><p>但我这里并不需要，更需要的是稳定的格式</p><h3 id="anyblock-用-card-dir-模拟节点" tabindex="-1">AnyBlock 用 card+dir 模拟节点</h3><p>之前是用 card + dir 来模拟节点，例如：</p>',11),t("div",{class:"ab-note drop-shadow"},[t("div",{class:"ab-items ab-card ab-lay-vfall ab-col2"},[t("div",{class:"ab-items-item"},[t("div",{class:"ab-items-title markdown-rendered"},[t("div",null,[t("p",null,"Load Checkpoint")])]),t("div",{class:"ab-items-content markdown-rendered"},[t("div",null,[t("p",null,[e("中文：Checkpoint加载器(简易)"),t("br"),e(" 作用：加载扩散模型")]),t("ul",null,[t("li",null,"Checkpoint名称: 加载大模型"),t("li",null,"(O) 模型"),t("li",null,"(O) CLIP"),t("li",null,"(O) VAE")])])])]),t("div",{class:"ab-items-item"},[t("div",{class:"ab-items-title markdown-rendered"},[t("div",null,[t("p",null,"CLIP Text Encode (Prompt)")])]),t("div",{class:"ab-items-content markdown-rendered"},[t("div",null,[t("p",null,[e("中文：CLIP文本编码器 (提示词) (正面)"),t("br"),e(" 作用：CLIP (ContrastiveLanguageImagePretraining) 理解输入文字的意思")]),t("ul",null,[t("li",null,"(I) CLIO"),t("li",null,"文本"),t("li",null,"(O) 条件")])])])]),t("div",{class:"ab-items-item"},[t("div",{class:"ab-items-title markdown-rendered"},[t("div",null,[t("p",null,"CLIP Text Encode (Prompt)")])]),t("div",{class:"ab-items-content markdown-rendered"},[t("div",null,[t("p",null,"中文：CLIP文本编码器 (提示词) (负面)"),t("ul",null,[t("li",null,"(I) CLIO"),t("li",null,"文本"),t("li",null,"(O) 条件")])])])]),t("div",{class:"ab-items-item"},[t("div",{class:"ab-items-title markdown-rendered"},[t("div",null,[t("p",null,"Empty Latent Image")])]),t("div",{class:"ab-items-content markdown-rendered"},[t("div",null,[t("p",null,[e("中文：空Laten"),t("br"),e(" 作用：潜空间，内部流程中的图像格式 (例如图生图时，先VAE编码转化为Laten数据，然后处理完再解码回图像)，可以用于设置图片大小")]),t("ul",null,[t("li",null,"宽度"),t("li",null,"高度"),t("li",null,"批次大小")])])])]),t("div",{class:"ab-items-item"},[t("div",{class:"ab-items-title markdown-rendered"},[t("div",null,[t("p",null,"KSampler")])]),t("div",{class:"ab-items-content markdown-rendered"},[t("div",null,[t("p",null,"中文：K采样器"),t("div",{class:"ab-note drop-shadow"},[t("div",{class:"ab-list-table-parent"},[t("table",{class:"ab-table ab-list-table ab-table-folder"},[t("tbody",null,[t("tr",{class:"ab-foldable-tr",tr_level:"0",is_fold:"false",able_fold:"false",type:"(I) 模型"},[t("td",{rowspan:"1",onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
          ...
          `},[t("div",{class:"ab-list-table-svg"},[t("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 384 512"},[l("!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc."),t("path",{d:"M320 464c8.8 0 16-7.2 16-16l0-288-80 0c-17.7 0-32-14.3-32-32l0-80L64 48c-8.8 0-16 7.2-16 16l0 384c0 8.8 7.2 16 16 16l256 0zM0 64C0 28.7 28.7 0 64 0L229.5 0c17 0 33.3 6.7 45.3 18.7l90.5 90.5c12 12 18.7 28.3 18.7 45.3L384 448c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 64z"})])]),t("div",{class:"ab-list-table-witharrow"},"steps 步数")])]),t("tr",{class:"ab-foldable-tr",tr_level:"0",is_fold:"false",able_fold:"false",type:"CFG"},[t("td",{rowspan:"1",onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
            ...
            if (flag_do_fold) tr.setAttribute("is_fold", tr_isfold=="true"?"false":"true")
          `},[t("div",{class:"ab-list-table-svg"},[t("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 384 512"},[l("!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc."),t("path",{d:"M320 464c8.8 0 16-7.2 16-16l0-288-80 0c-17.7 0-32-14.3-32-32l0-80L64 48c-8.8 0-16 7.2-16 16l0 384c0 8.8 7.2 16 16 16l256 0zM0 64C0 28.7 28.7 0 64 0L229.5 0c17 0 33.3 6.7 45.3 18.7l90.5 90.5c12 12 18.7 28.3 18.7 45.3L384 448c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 64z"})])]),t("div",{class:"ab-list-table-witharrow"},"CFG")])]),t("tr",{class:"ab-foldable-tr",tr_level:"0",is_fold:"false",able_fold:"false",type:"sampler_name"},[t("td",{rowspan:"1",onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
            const l_tr = tr.parentNode.querySelectorAll("tr")
            const i = 12
...
`},[t("td",{rowspan:"1",onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
            ...
            if (flag_do_fold) tr.setAttribute("is_fold", tr_isfold=="true"?"false":"true")
          `},[t("div",{class:"ab-list-table-svg"},[t("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 384 512"},[l("!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc."),t("path",{d:"M320 464c8.8 0 16-7.2 16-16l0-288-80 0c-17.7 0-32-14.3-32-32l0-80L64 48c-8.8 0-16 7.2-16 16l0 384c0 8.8 7.2 16 16 16l256 0zM0 64C0 28.7 28.7 0 64 0L229.5 0c17 0 33.3 6.7 45.3 18.7l90.5 90.5c12 12 18.7 28.3 18.7 45.3L384 448c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 64z"})])]),t("div",{class:"ab-list-table-witharrow"},"(O) Latent")])])])]),t("button",{class:"ab-table-fold",is_fold:"false",onclick:`          const btn = this;
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">        }</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">    },</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="需要实现接口" tabindex="-1">需要实现接口</h3><ol><li>表格转Schema</li><li>Schema生成表单</li><li>扩展：节点的 (I/O) Flag</li></ol>`,20)])])}const h=n(o,[["render",d]]),u=JSON.parse('{"path":"/MdNote_Public/ProductDoc/Plugin/(idea)%20%E8%AE%BE%E8%AE%A1%EF%BC%9AAnyBlock%20%E8%8A%82%E7%82%B9%E4%B8%8E%E5%A4%9A%E5%B1%82%E8%8F%9C%E5%8D%95.html","title":"(idea) 设计：AnyBlock 节点与多层菜单","lang":"zh-CN","frontmatter":{"description":"(idea) 设计：AnyBlock 节点与多层菜单 介绍 应用场景 一是表单、二是节点转用表单 对比 json类型 类型(8): Number、String、Boolean、Array/Object、null、Value(any)、Whitespace 但最后两种没怎么见过，只适配6种应该也行 请求表单 - json 类型(8)：string、int...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"(idea) 设计：AnyBlock 节点与多层菜单\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"],["meta",{"property":"og:url","content":"https://LincZero.github.io/MdNote_Public/ProductDoc/Plugin/(idea)%20%E8%AE%BE%E8%AE%A1%EF%BC%9AAnyBlock%20%E8%8A%82%E7%82%B9%E4%B8%8E%E5%A4%9A%E5%B1%82%E8%8F%9C%E5%8D%95.html"}],["meta",{"property":"og:site_name","content":"Linc 的小站"}],["meta",{"property":"og:title","content":"(idea) 设计：AnyBlock 节点与多层菜单"}],["meta",{"property":"og:description","content":"(idea) 设计：AnyBlock 节点与多层菜单 介绍 应用场景 一是表单、二是节点转用表单 对比 json类型 类型(8): Number、String、Boolean、Array/Object、null、Value(any)、Whitespace 但最后两种没怎么见过，只适配6种应该也行 请求表单 - json 类型(8)：string、int..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}]]},"git":{},"readingTime":{"minutes":3.47,"words":1041},"filePathRelative":"MdNote_Public/ProductDoc/Plugin/(idea) 设计：AnyBlock 节点与多层菜单.md","excerpt":"\\n<h2>介绍</h2>\\n<h3>应用场景</h3>\\n<p>一是表单、二是节点转用表单</p>\\n<h3>对比</h3>\\n<ul>\\n<li>json类型\\n<ul>\\n<li>类型(8): Number、String、Boolean、Array/Object、null、Value(any)、Whitespace</li>\\n<li>但最后两种没怎么见过，只适配6种应该也行</li>\\n</ul>\\n</li>\\n<li>请求表单 - json\\n<ul>\\n<li>类型(8)：string、integer/number、boolean、array <strong>/object、null/any</strong></li>\\n</ul>\\n</li>\\n<li>请求表单 - params\\n<ul>\\n<li>类型(6): string、integer/number、boolean、array、<strong>file</strong></li>\\n</ul>\\n</li>\\n<li>请求表单 - 表单实体\\n<ul>\\n<li>基本同上，但输入框类型还分：数字类型(是否密码)/文本单多行属性/约束等等</li>\\n</ul>\\n</li>\\n<li>节点表单类型\\n<ul>\\n<li>新增节点输入、节点输出类型<br>\\n(特点：允许给一个字符串作为二次类型、通常没有Key名字，取之替代的是二次类型名)</li>\\n</ul>\\n</li>\\n<li>简化 - Schema码类型\\n<ul>\\n<li>删除了嵌套功能，节点类型删除Object/Array</li>\\n<li>删除了约束 (范围、必填等)</li>\\n<li>主要属性：&quot;type&quot;、&quot;default&quot;</li>\\n</ul>\\n</li>\\n</ul>","autoDesc":true,"bioChainData":{"outlink":[],"backlink":[],"localMap":{"nodes":[{"id":"MdNote_Public/ProductDoc/Plugin/(idea) 设计：AnyBlock 节点与多层菜单.md","value":{"title":"(idea) 设计：AnyBlock 节点与多层菜单","path":"MdNote_Public/ProductDoc/Plugin/(idea) 设计：AnyBlock 节点与多层菜单.md","outlink":[],"backlink":[]}}],"links":[]}}}');export{h as comp,u as data};

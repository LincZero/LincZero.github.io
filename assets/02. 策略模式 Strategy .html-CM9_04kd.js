...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="比较两种写法" tabindex="-1"><a class="header-anchor" href="#比较两种写法"><span>比较两种写法</span></a></h4><p>考虑时间轴：以后可能会支持更多的国家的计算，当增加 “法国税收” 后</p><ul><li>第一种：违背类<code>开闭原则</code>，复用性少了</li><li>第二种：只需要添加一个新类，遵循了<code>开闭原则</code></li></ul><p>设计模式简介中画图的代码实现也是用到了这个<code>开闭原则</code>和<code>策略模式</code></p><h2 id="设计模式" tabindex="-1"><a class="header-anchor" href="#设计模式"><span>设计模式</span></a></h2><h3 id="模式定义" tabindex="-1"><a class="header-anchor" href="#模式定义"><span>模式定义</span></a></h3><blockquote><p>定义一系列算法，把它们一个个封装起来，并且使它们可互相替换（<strong>变化</strong>）。 该模式使得算法可独立于使用它的客户程序（<strong>稳定</strong>）而变化（<strong>扩展，子类化</strong>）。</p><p>——《设计模式》GoF</p></blockquote><h3 id="结构-structure" tabindex="-1"><a class="header-anchor" href="#结构-structure"><span>结构（Structure）</span></a></h3><p>（红色表示稳定）</p><p>​ 策略即算法接口，派生出多种不同的算法，以便可以在多种不同的算法之间进行切换</p>`,32),u=e("h3",{id:"要点总结",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#要点总结"},[e("span",null,"要点总结")])],-1),o=e("ul",null,[e("li",null,[t("Strategy及其子类为组件提供了一系列可重用的算法，从而可以使得类型在"),e("strong",null,"运行时"),t("方便地根据需要"),e("strong",null,"在各个算法之间进行切换")]),e("li",null,[t("Strategy模式提供了用条件判断语句以外的另一种选择，"),e("strong",null,"消除条件判断语句，就是在解耦合。含有许多条件判断语句的代码通常都需要Strategy模式"),t(" （条件判断是结构化编程的一种分而治之的策略，而设计模式提倡的是一种抽象的策略）")]),e("li",null,"如果Strategy对象没有实例变量，那么各个上下文可以共享同一个Strategy对象，从而节省对象开销")],-1);function m(p,b){const i=l("Mermaid");return a(),s("div",null,[v,r(i,{id:"mermaid-167",code:""}),u,o])}const g=n(c,[["render",m],["__file","02. 策略模式 Strategy .html.vue"]]),A=JSON.parse('{"path":"/MdNote_Public/01.%20%E8%AE%BE%E8%AE%A1%E5%BC%80%E5%8F%91%E4%B8%8E%E6%95%B0%E6%8D%AE%E7%94%9F%E4%BA%A7/Develop/03.%20Tools/02.%20%E7%AE%A1%E7%90%86%E5%B1%82/01.%20%E5%A4%9A%E7%B1%BB%E7%AE%A1%E7%90%86/%E8%AE%BE%E8%AE%A1%E6%A8%A1%E5%BC%8F/%E3%80%8AC__%E8%AE%BE%E8%AE%A1%E6%A8%A1%E5%BC%8F%E3%80%8B%E8%A7%86%E9%A2%91_%E6%9D%8E%E5%BB%BA%E5%BF%A0/02.%20%E7%AD%96%E7%95%A5%E6%A8%A1%E5%BC%8F%20Strategy%20.html","title":"策略模式 Strategy","lang":"zh-CN","frontmatter":{"description":"策略模式 Strategy 极简一句话： 策略模式：类A包含一个多态基类B指针（例如：订单业务类A包含一个国家税收多态类B指针） 所属分类——“组件协作” 模式 [省略] 动机（Motivation） 简概 在软件构建过程中，某些对象使用的算法可能多种多样，经常改变，如果将这些算法都编码到对象中，将会使对象变得异常复杂； 而且有时候支持不使用的算法也是...","head":[["meta",{"property":"og:url","content":"http://192.168.0.101:8080/MdNote_Public/01.%20%E8%AE%BE%E8%AE%A1%E5%BC%80%E5%8F%91%E4%B8%8E%E6%95%B0%E6%8D%AE%E7%94%9F%E4%BA%A7/Develop/03.%20Tools/02.%20%E7%AE%A1%E7%90%86%E5%B1%82/01.%20%E5%A4%9A%E7%B1%BB%E7%AE%A1%E7%90%86/%E8%AE%BE%E8%AE%A1%E6%A8%A1%E5%BC%8F/%E3%80%8AC__%E8%AE%BE%E8%AE%A1%E6%A8%A1%E5%BC%8F%E3%80%8B%E8%A7%86%E9%A2%91_%E6%9D%8E%E5%BB%BA%E5%BF%A0/02.%20%E7%AD%96%E7%95%A5%E6%A8%A1%E5%BC%8F%20Strategy%20.html"}],["meta",{"property":"og:site_name","content":"Linc 的小站"}],["meta",{"property":"og:title","content":"策略模式 Strategy"}],["meta",{"property":"og:description","content":"策略模式 Strategy 极简一句话： 策略模式：类A包含一个多态基类B指针（例如：订单业务类A包含一个国家税收多态类B指针） 所属分类——“组件协作” 模式 [省略] 动机（Motivation） 简概 在软件构建过程中，某些对象使用的算法可能多种多样，经常改变，如果将这些算法都编码到对象中，将会使对象变得异常复杂； 而且有时候支持不使用的算法也是..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"article:author","content":"LincZero"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"策略模式 Strategy\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"LincZero\\",\\"url\\":\\"https://github.com/LincZero/\\"}]}"]]},"headers":[{"level":1,"title":"策略模式 Strategy","slug":"策略模式-strategy","link":"#策略模式-strategy","children":[{"level":2,"title":"所属分类——“组件协作” 模式","slug":"所属分类——-组件协作-模式","link":"#所属分类——-组件协作-模式","children":[]},{"level":2,"title":"动机（Motivation）","slug":"动机-motivation","link":"#动机-motivation","children":[{"level":3,"title":"简概","slug":"简概","link":"#简概","children":[]},{"level":3,"title":"核心：if分支变成派生类分支","slug":"核心-if分支变成派生类分支","link":"#核心-if分支变成派生类分支","children":[]},{"level":3,"title":"代码体现","slug":"代码体现","link":"#代码体现","children":[{"level":4,"title":"举例 - 写法1","slug":"举例-写法1","link":"#举例-写法1","children":[]},{"level":4,"title":"举例 - 写法2（Strategy的写法）","slug":"举例-写法2-strategy的写法","link":"#举例-写法2-strategy的写法","children":[]},{"level":4,"title":"比较两种写法","slug":"比较两种写法","link":"#比较两种写法","children":[]}]}]},{"level":2,"title":"设计模式","slug":"设计模式","link":"#设计模式","children":[{"level":3,"title":"模式定义","slug":"模式定义","link":"#模式定义","children":[]},{"level":3,"title":"结构（Structure）","slug":"结构-structure","link":"#结构-structure","children":[]},{"level":3,"title":"要点总结","slug":"要点总结","link":"#要点总结","children":[]}]}]}],"git":{"createdTime":null,"updatedTime":null,"contributors":[]},"readingTime":{"minutes":4.26,"words":1278},"filePathRelative":"MdNote_Public/01. 设计开发与数据生产/Develop/03. Tools/02. 管理层/01. 多类管理/设计模式/《C++设计模式》视频_李建忠/02. 策略模式 Strategy .md","autoDesc":true}');export{g as comp,A as data};

import{_ as a}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as e,o as i,c as l,d as t,e as n}from"./app-HRMkW8Cz.js";const p={},c=n('<h1 id="操作系统-系统以下" tabindex="-1"><a class="header-anchor" href="#操作系统-系统以下"><span>操作系统 - 系统以下</span></a></h1><h2 id="物理内存-vs-程序员眼中的内存" tabindex="-1"><a class="header-anchor" href="#物理内存-vs-程序员眼中的内存"><span>物理内存 vs 程序员眼中的内存</span></a></h2><h3 id="内存的物理机制" tabindex="-1"><a class="header-anchor" href="#内存的物理机制"><span>内存的物理机制</span></a></h3><ul><li>内部部分 <ul><li>内存集成电路</li></ul></li><li>引脚 (接口) 部分 <ul><li>有多个电路引脚 (以那种单片机上黑色的<strong>22引脚</strong>的小内存为例) <ul><li>(2) VCC 电源，GND 电源</li><li>(10) A0-A9 地址信号引脚。= 10位 = 1024个地址 = 索引1024Byte的空间</li><li>(8) D0-D7 数据信号引脚。= 8位 = 一字节 = 每个地址可以存储8个字节</li><li>(2) RD WR 控制信号引脚。即读还是写</li></ul></li><li>信号引脚中，通过5V高电平，0V低电平，来表示10</li><li>顺序 <ul><li>写则依次：(1) 指定地址、(2) 输入数据、(3) 将WR设为1</li><li>读则依次：(1) 制定地址、(2) 将RD设为1、(3) 从数据引脚中获取</li></ul></li></ul></li></ul><h3 id="字节序" tabindex="-1"><a class="header-anchor" href="#字节序"><span>字节序</span></a></h3><p>详见CSAPP或内存管理相关笔记</p><h2 id="高级语言、汇编语言、机器语言" tabindex="-1"><a class="header-anchor" href="#高级语言、汇编语言、机器语言"><span>高级语言、汇编语言、机器语言</span></a></h2><p>略，详见CSAPP</p><p>objdump -d -S hello.o // -S可以看对应的C语言语句</p><p>不过还是Godbolt香 （戈伯特）</p><h2 id="cpu执行过程" tabindex="-1"><a class="header-anchor" href="#cpu执行过程"><span>CPU执行过程</span></a></h2><h3 id="物理" tabindex="-1"><a class="header-anchor" href="#物理"><span>物理</span></a></h3><p>集成电路，根据指令处理各种处理的电子电路，每个指令对对应相应的电子电路工作</p><ul><li>控制器：负责传入寄存器，得到结果后控制计算机</li><li>寄存器 (20~100个)：暂存指令、数据等（PC(计数器)有可能也在这个位置，例如IP就是指令指针寄存器）</li><li>运算器：运算</li></ul><p>流程</p><ol><li>读取：CPU从内存中读取指令</li><li>解码：将10串拆成操作码和操作数，知道要去执行什么操作</li><li>执行</li><li>（循环，根据计数器(PC)循环）</li></ol>',16),d=n(`<h3 id="cpu指令集" tabindex="-1"><a class="header-anchor" href="#cpu指令集"><span>CPU指令集</span></a></h3><ul><li>arm架构CPU</li><li>X86架构CPU</li></ul><p>查看CPU架构</p><ul><li>windows：systeminfo，找 &quot;系统类型&quot; 一栏</li><li>linux：lscpu，找 &quot;Architecture&quot; 一栏</li></ul><h3 id="常用指令" tabindex="-1"><a class="header-anchor" href="#常用指令"><span>常用指令</span></a></h3><p>详见SCAPP</p><ul><li>mov A,B</li><li>add A,B</li><li>push A</li><li>pop A</li><li>call A</li><li>ret 无</li></ul><h3 id="常用操作数" tabindex="-1"><a class="header-anchor" href="#常用操作数"><span>常用操作数</span></a></h3><ul><li>寄存器 <ul><li>rbp (register base pointer)：栈基址寄存器（栈帧指针），指向当前帧的栈底地址</li><li>rsp (register stack pointer)：栈顶寄存器（栈指针），指向栈顶元素</li><li>(函数调用时会使用上面两个)</li><li>rip：存储下一条指令的内存地址</li></ul></li><li>内存</li><li>常数</li></ul><h2 id="程序-机器码-的对应" tabindex="-1"><a class="header-anchor" href="#程序-机器码-的对应"><span>程序 - 机器码 的对应</span></a></h2><h3 id="函数调用" tabindex="-1"><a class="header-anchor" href="#函数调用"><span>函数调用</span></a></h3><div class="language-c line-numbers-mode" data-ext="c" data-title="c"><pre class="language-c"><code><span class="token keyword">int</span> <span class="token function">mod</span><span class="token punctuation">(</span><span class="token keyword">int</span> a<span class="token punctuation">,</span> <span class="token keyword">int</span> b<span class="token punctuation">)</span> <span class="token punctuation">{</span>

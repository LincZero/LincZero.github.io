...
`)])]),e("div",{class:"line-numbers","aria-hidden":"true"},[e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"}),e("div",{class:"line-number"})])],-1),S=r(`<p>通过这套灵活的处理器语法，假如原插件的语法是X，你能够自己定义一个新语法Y，让Y语法替换X语法的同时让原插件生效！</p><h3 id="别名系统" tabindex="-1"><a class="header-anchor" href="#别名系统"><span>别名系统</span></a></h3><p>当然，你可能嫌弃这样的做法会让指令变得长而不可读，没关系 —— 我们还有别名系统。能够让你用自己定义一个别名来表示一串指令！</p><p>例如插件自带的 <code>code2quote</code> 指令，就是使用了别名系统，本质上，<code>code2quote</code> 完全等同于 <code>Xcode|quote</code></p><p>插件自带了许多非常自然的别名（特别是<strong>中文</strong>别名），在实际使用中，更推荐你使用这些别名：</p><p>已支持的快捷别名：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>flow
流程图
mindmap
思维导图
脑图

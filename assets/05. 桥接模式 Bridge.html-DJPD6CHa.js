...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="分析-写法2" tabindex="-1"><a class="header-anchor" href="#分析-写法2"><span>分析 - 写法2</span></a></h4><p>代码结构</p><ul><li>运行代码：进行动态组装</li></ul>`,8),b=e("p",null,"分析",-1),p=e("ul",null,[e("li",null,[n("子类数量减少，类的数量为"),e("span",{class:"katex"},[e("span",{class:"katex-mathml"},[e("math",{xmlns:"http://www.w3.org/1998/Math/MathML"},[e("semantics",null,[e("mrow",null,[e("mn",null,"1"),e("mo",null,"+"),e("mi",null,"n"),e("mo",null,"+"),e("mi",null,"m")]),e("annotation",{encoding:"application/x-tex"},"1+n+m")])])]),e("span",{class:"katex-html","aria-hidden":"true"},[e("span",{class:"base"},[e("span",{class:"strut",style:{height:"0.7278em","vertical-align":"-0.0833em"}}),e("span",{class:"mord"},"1"),e("span",{class:"mspace",style:{"margin-right":"0.2222em"}}),e("span",{class:"mbin"},"+"),e("span",{class:"mspace",style:{"margin-right":"0.2222em"}})]),e("span",{class:"base"},[e("span",{class:"strut",style:{height:"0.6667em","vertical-align":"-0.0833em"}}),e("span",{class:"mord mathnormal"},"n"),e("span",{class:"mspace",style:{"margin-right":"0.2222em"}}),e("span",{class:"mbin"},"+"),e("span",{class:"mspace",style:{"margin-right":"0.2222em"}})]),e("span",{class:"base"},[e("span",{class:"strut",style:{height:"0.4306em"}}),e("span",{class:"mord mathnormal"},"m")])])]),n("，而运行时仍然有"),e("span",{class:"katex"},[e("span",{class:"katex-mathml"},[e("math",{xmlns:"http://www.w3.org/1998/Math/MathML"},[e("semantics",null,[e("mrow",null,[e("mi",null,"n"),e("mo",null,"∗"),e("mi",null,"m")]),e("annotation",{encoding:"application/x-tex"},"n*m")])])]),e("span",{class:"katex-html","aria-hidden":"true"},[e("span",{class:"base"},[e("span",{class:"strut",style:{height:"0.4653em"}}),e("span",{class:"mord mathnormal"},"n"),e("span",{class:"mspace",style:{"margin-right":"0.2222em"}}),e("span",{class:"mbin"},"∗"),e("span",{class:"mspace",style:{"margin-right":"0.2222em"}})]),e("span",{class:"base"},[e("span",{class:"strut",style:{height:"0.4306em"}}),e("span",{class:"mord mathnormal"},"m")])])]),n("的功能多样性")]),e("li",null,"将继承实现分为了平台抽象和业务抽象，这是两个不同的变化方向。代码中业务抽象的实现has-a包含平台抽象")],-1),g=l('<p>重构思路</p><ul><li>(1) 先把继承A变为包含指针A。然后找到两组不同的地方——包含的指针类型不同</li><li>(2) 把包含指针A变为其父类的指针ParentA，即变为多态</li><li>(3) 对原基类进行职责分离</li><li>(4) 最后再深入改善，提取派生类的共同点 <ul><li>马丁福勒：如果类的多个派生类中有同样的字段，那就要在中间再弄一个中间类来放这些相同的代码</li></ul></li></ul><h2 id="设计模式" tabindex="-1"><a class="header-anchor" href="#设计模式"><span>设计模式</span></a></h2><h3 id="模式定义" tabindex="-1"><a class="header-anchor" href="#模式定义"><span>模式定义</span></a></h3><blockquote><p>将抽象部分（业务功能）与实现部分（平台实现）分离，使它们都可以独立地变化</p><p>——《设计模式》GoF</p></blockquote><p>个人的话：</p><p>通过聚合，既保证了平台与应用两者的独立变化，同时又保证了两者之间的包含关系。</p><p>聚合像桥梁一样将两者连接到一块，所以这种设计模式又叫做<strong>桥接模式</strong></p><h3 id="结构-structure" tabindex="-1"><a class="header-anchor" href="#结构-structure"><span>结构（Structure）</span></a></h3><blockquote><h4 id="新" tabindex="-1"><a class="header-anchor" href="#新"><span>新</span></a></h4></blockquote><p>原写法</p>',11),h=e("p",null,"改写后",-1),A=e("blockquote",null,[e("h4",{id:"旧",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#旧"},[e("span",null,"旧")])])],-1),B=e("p",null,"（红色表示稳定）",-1),E=e("p",null,"其中Implementor与Abstraction之间的关系为桥接",-1),M=l('<h3 id="要点总结" tabindex="-1"><a class="header-anchor" href="#要点总结"><span>要点总结</span></a></h3><ul><li>Bridge模式使用 “对象间的组合关系&quot; 解耦了抽象和实现之间固有的绑定关系，使得抽象和实现可以沿着各自的维度来变化。 所谓抽象和实现沿着各自纬度的变化，即 “子类化” 它们</li><li>Bridge模式有时候类似于多继承方案，但是<strong>多继承方案往往违背单一职责原则（即一个类只有一个变化的原因）</strong>，复用性比较差。 Bridge模式是比多继承方案更好的解决方法。</li><li>Bridge模式的应用一般在 “两个非常强的变化维度”，有时一个类也有多于两个的变化维度，这时可以使用Bridge的扩展模式</li></ul><h3 id="个人体会" tabindex="-1"><a class="header-anchor" href="#个人体会"><span>个人体会</span></a></h3><h4 id="是抽象部分-abstraction-还是实现部分-implementor" tabindex="-1"><a class="header-anchor" href="#是抽象部分-abstraction-还是实现部分-implementor"><span>是抽象部分（Abstraction）还是实现部分（Implementor）</span></a></h4><blockquote><p>对Window子类的所有操作都是用WindowImp接口中的抽象操作实现的。 这就将<strong>窗口的抽象</strong>与<strong>系统平台相关的实现</strong>部分分离开来。 因此，我们将Window与WindowImp之间的关系称之为桥接，因为它在抽象类与它的实现之间起到了桥梁作用，使它们可以独立地变化。</p><p>——《设计模式：可复用面向对象软件的基础》</p></blockquote><hr><p>Q：桥接（Bridge）是用于把抽象化与实现化解耦。那应选取哪个部分为抽象部分、选取那个部分为实现部分？</p><p>A：new后是抽象的为实现部分？我怎么感觉结构反过来了？</p><ul><li><s>我本来的理解是 Abstraction中（平台）包含Implementor（应用）指针，和https://blog.csdn.net/qq_35423154/article/details/111085839差不多 感觉上是 “抽象”：平台，以及 “实现”：软件 <strong>应用可以不依赖平台单独存在</strong></s></li><li>而李老讲的和《设计模式：可复用面向对象软件的基础》中的是 Abstraction中（软件）包含Implementor（平台）指针 但在例程中，平台实现属于具体实现部分，而业务功能属于抽象部分 平台可以不装应用来单独存在</li></ul><h4 id="包含还是继承" tabindex="-1"><a class="header-anchor" href="#包含还是继承"><span>包含还是继承</span></a></h4><p>桥接模式中</p><ul><li>实现部分（平台）被继承（is-a），可脱离抽象部分（应用）独立存在</li><li>抽象部分（应用）被包含（has-a），不可脱离实现部分（平台）独立存在</li></ul><p>在例子装饰模式中也是同理</p><ul><li>主体部分，其基类被继承，可脱离装饰部分独立存在</li><li>装饰部分，其基类被包含，不可脱离主体部分独立存在</li></ul><h4 id="【对比】decorator与bridge-使用上区分" tabindex="-1"><a class="header-anchor" href="#【对比】decorator与bridge-使用上区分"><span>【对比】Decorator与Bridge（使用上区分）</span></a></h4>',15),x={href:"https://blog.csdn.net/qq_45570838/article/details/110430680",target:"_blank",rel:"noopener noreferrer"},S=l(`<p>感觉Bridge模式和Decorator模式非常相像</p><ul><li>共同点：都属于 “单一职责” 模式，都能划清职责并解决类爆炸问题。都用到了组合</li><li>桥接模式：？？？（看不懂参考里说的什么意思）</li><li>装饰模式：？？？（看不懂参考里说的什么意思）</li></ul><hr><p>个人的感觉是</p><ul><li>共同点：都属于 “单一职责” 模式，都能划清职责并解决类爆炸问题。都用到了组合</li><li>装饰模式 装配的两个部分是同一个祖先 侧重是在库类的基础上使用组合而不是继承进行<strong>扩展</strong></li><li>桥接模式 装配的两个部分不是同一祖先 侧重在设计库类时将实现部分与抽象部分分离开使两者能分别独立地<strong>变化</strong>、使用时再将他们通过继承+组合的方式结合起来</li></ul><h4 id="【对比】decorator与bridge-代码上" tabindex="-1"><a class="header-anchor" href="#【对比】decorator与bridge-代码上"><span>【对比】Decorator与Bridge（代码上）</span></a></h4><p>从代码角度区分</p><p>使用装饰模式时代码的典型特征</p><ul><li><p>典型特征1</p><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>DecoratorStream: public Stream{	// 继承Stream的同时	（is-a）
protected:

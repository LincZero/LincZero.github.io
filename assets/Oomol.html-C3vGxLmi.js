import{_ as o,e as d,g as i,f as t,k as s,j as l,h as a,i as r,r as h,o as p}from"./app-DpI9FnpE.js";const c="/assets/Pasted%20image%2020250222213636-AV6BDNXl.png",f={},k={class:"ab-note drop-shadow"},_={class:"ab-list-table-parent"},v={class:"ab-table ab-list-table ab-table-folder"},g={class:"ab-foldable-tr",tr_level:"2",is_fold:"false",able_fold:"false",type:"yaml`    "},u={rowspan:"1",onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
          ...
          `},b={class:"ab-list-table-witharrow"},y={class:"ab-foldable-tr",tr_level:"2",is_fold:"false",able_fold:"false",type:"json` "},m={rowspan:"1",onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
            const l_tr = tr.parentNode.querySelectorAll("tr")
            const i = 4
            ...
            if (flag_do_fold) tr.setAttribute("is_fold", tr_isfold=="true"?"false":"true")
          `},A={class:"ab-list-table-witharrow"};function w(B,e){const n=h("filename");return p(),d("div",null,[e[19]||(e[19]=i('<h1 id="oomol" tabindex="-1"><a class="header-anchor" href="#oomol"><span>Oomol</span></a></h1><h2 id="安装、使用体验" tabindex="-1"><a class="header-anchor" href="#安装、使用体验"><span>安装、使用体验</span></a></h2><h3 id="安装" tabindex="-1"><a class="header-anchor" href="#安装"><span>安装</span></a></h3><p>以 windows 版本为例，安装 windows 版本后，他会先让你安装并更新到最新的wsl2。这是为了跨平台统一</p><p>使用下来比较流程，没出什么幺蛾子</p><h3 id="项目" tabindex="-1"><a class="header-anchor" href="#项目"><span>项目</span></a></h3><p>他每个工作流都是一个项目 (以项目为单位进行分享)</p><ul><li>缺点 <ul><li>其易用性和大小没有 comfyui 工作流那种单文件强。<br> 不过 ts 项目也不算很大</li></ul></li><li>优点 <ul><li>项目为单位，提供了额外的灵活性：工作流可以有独立依赖、独立的配置</li><li>独立依赖这点还是比较好的，包括 js 的 npm依赖 (package.json)，包括 python 的 requirements.txt (不过python项目分享时，经常伴随一些AI库，依赖的安装还挺慢的)</li></ul></li></ul><h2 id="自定义程度" tabindex="-1"><a class="header-anchor" href="#自定义程度"><span>自定义程度</span></a></h2><h3 id="数据类别" tabindex="-1"><a class="header-anchor" href="#数据类别"><span>数据类别</span></a></h3><p>(相当于nodeflow中项的valueType)</p><p>注意：如果选择了 Variable/Array/Object 这种容器类型，那么后面可以再进行 type-value 的选择</p><ul><li>容器类 <ul><li>Variable | (不一定可选) df属于这个</li></ul></li><li>String</li><li>Number</li><li>FilePath, SavePath, DirPath</li><li>Secret</li><li>Boolean</li><li>Integer</li><li>Color</li><li>Text</li><li>Object</li><li>Array</li><li>Select | (不一定可选)</li><li>MultiSelect | (不一定可选)</li><li>Date</li><li>Any</li><li>AnyOf | (不一定可选)</li><li>Binary | (不一定可选)</li><li>Null</li></ul><h3 id="节点类别" tabindex="-1"><a class="header-anchor" href="#节点类别"><span>节点类别</span></a></h3>',14)),e[20]||(e[20]=t("div",{class:"ab-note drop-shadow"},[t("div",{class:"ab-list-table-parent"},[t("table",{class:"ab-table ab-list-table ab-table-folder"},[t("tbody",null,[t("tr",{class:"ab-foldable-tr",tr_level:"0",is_fold:"false",able_fold:"true",type:"folder"},[t("td",{rowspan:"1",onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
            const l_tr = tr.parentNode.querySelectorAll("tr")
            const i = 0
...
`},[t("td",{rowspan:"1",onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
          ...
          `},[t("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round",class:"lucide lucide-fold-vertical-icon lucide-fold-vertical"},[t("path",{d:"M12 22v-6"}),t("path",{d:"M12 8V2"}),t("path",{d:"M4 12H2"}),t("path",{d:"M10 12H8"}),t("path",{d:"M16 12h-2"}),t("path",{d:"M22 12h-2"}),t("path",{d:"m15 19-3-3-3 3"}),t("path",{d:"m15 5-3 3-3-3"})])])])],-1)),e[21]||(e[21]=i('<h2 id="分析-repo" tabindex="-1"><a class="header-anchor" href="#分析-repo"><span>分析 - repo</span></a></h2><h3 id="群组项目集" tabindex="-1"><a class="header-anchor" href="#群组项目集"><span>群组项目集</span></a></h3><p>这个群组有很多子项目 (2025-02-22 分了23个子项目)</p><ul><li>https://github.com/oomol-lab <ul><li>ovm-core | 运行podman所需的最小虚拟机</li><li>ovm | 在Apple虚拟化框架上运行ovm-core虚拟机</li><li>mac-power-monitor</li></ul></li></ul><h3 id="解决方案" tabindex="-1"><a class="header-anchor" href="#解决方案"><span>解决方案</span></a></h3><p>VSCode框架 (像cursor、oomal都用这个，还挺方便) + OVM (Oracle VirtualBox) 虚拟机</p><p>然后这两者都是跨平台的，VSCode框架甚至有 github.dev + codespace 的成熟方案可以参考</p><p>这是一个很不错的设计思路</p><h2 id="分析-工作流项目" tabindex="-1"><a class="header-anchor" href="#分析-工作流项目"><span>分析 - 工作流项目</span></a></h2><h3 id="项目结构" tabindex="-1"><a class="header-anchor" href="#项目结构"><span>项目结构</span></a></h3><p>项目结构比较简单</p>',11)),t("div",k,[t("div",_,[t("table",v,[t("tbody",null,[e[8]||(e[8]=t("tr",{class:"ab-foldable-tr",tr_level:"0",is_fold:"false",able_fold:"true",type:"folder"},[t("td",{rowspan:"1",onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
            const l_tr = tr.parentNode.querySelectorAll("tr")
            const i = 0
          ...
          `},[t("div",{class:"ab-list-table-svg"},[t("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 512 512"},[s("!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc."),t("path",{d:"M64 480H448c35.3 0 64-28.7 64-64V160c0-35.3-28.7-64-64-64H288c-10.1 0-19.6-4.7-25.6-12.8L243.2 57.6C231.1 41.5 212.1 32 192 32H64C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64z"})])]),t("div",{class:"ab-list-table-witharrow"},"`<工作流名>`")])],-1)),e[10]||(e[10]=t("tr",{class:"ab-foldable-tr",tr_level:"2",is_fold:"false",able_fold:"false",type:"folder"},[t("td",{rowspan:"1",onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
            ...
            if (flag_do_fold) tr.setAttribute("is_fold", tr_isfold=="true"?"false":"true")
          `},[t("div",{class:"ab-list-table-svg"},[t("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 512 512"},[s("!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc."),t("path",{d:"M64 480H448c35.3 0 64-28.7 64-64V160c0-35.3-28.7-64-64-64H288c-10.1 0-19.6-4.7-25.6-12.8L243.2 57.6C231.1 41.5 212.1 32 192 32H64C28.7 32 0 60.7 0 96V416c0 35.3 28.7 64 64 64z"})])]),t("div",{class:"ab-list-table-witharrow"},"scriptlets")]),t("td",{rowspan:"1"},[t("div",{class:"ab-list-table-witharrow markdown-rendered"},[t("div",null,[t("p",null,[l("里面可能有 "),t("code",null,".py"),l(" 脚本")])])])])],-1)),t("tr",g,[t("td",u,[e[2]||(e[2]=t("div",{class:"ab-list-table-svg"},[t("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 384 512"},[s("!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc."),t("path",{d:"M320 464c8.8 0 16-7.2 16-16l0-288-80 0c-17.7 0-32-14.3-32-32l0-80L64 48c-8.8 0-16 7.2-16 16l0 384c0 8.8 7.2 16 16 16l256 0zM0 64C0 28.7 28.7 0 64 0L229.5 0c17 0 33.3 6.7 45.3 18.7l90.5 90.5c12 12 18.7 28.3 18.7 45.3L384 448c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 64z"})])],-1)),t("div",b,[e[1]||(e[1]=l("`")),a(n,null,{default:r(()=>e[0]||(e[0]=[l(".oo.yaml`")])),_:1})])]),e[3]||(e[3]=t("td",{rowspan:"1"},[t("div",{class:"ab-list-table-witharrow markdown-rendered"},[t("div",null,[t("p",null,"工作流文件")])])],-1))]),t("tr",y,[t("td",m,[e[6]||(e[6]=t("div",{class:"ab-list-table-svg"},[t("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 384 512"},[s("!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc."),t("path",{d:"M320 464c8.8 0 16-7.2 16-16l0-288-80 0c-17.7 0-32-14.3-32-32l0-80L64 48c-8.8 0-16 7.2-16 16l0 384c0 8.8 7.2 16 16 16l256 0zM0 64C0 28.7 28.7 0 64 0L229.5 0c17 0 33.3 6.7 45.3 18.7l90.5 90.5c12 12 18.7 28.3 18.7 45.3L384 448c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 64z"})])],-1)),t("div",A,[e[5]||(e[5]=l("`.")),a(n,null,{default:r(()=>e[4]||(e[4]=[l(".ui.oo.json`")])),_:1})])]),e[7]||(e[7]=t("td",{rowspan:"1"},[t("div",{class:"ab-list-table-witharrow markdown-rendered"},[t("div",null,[t("p",null,"工作流文件的可选补充 (位置和尺寸)")])])],-1))]),e[11]||(e[11]=t("tr",{class:"ab-foldable-tr",tr_level:"0",is_fold:"false",able_fold:"true",type:"folder"},[t("td",{rowspan:"1",onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
            const l_tr = tr.parentNode.querySelectorAll("tr")
            const i = 5
          ...
          `},[t("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round",class:"lucide lucide-fold-vertical-icon lucide-fold-vertical"},[t("path",{d:"M12 22v-6"}),t("path",{d:"M12 8V2"}),t("path",{d:"M4 12H2"}),t("path",{d:"M10 12H8"}),t("path",{d:"M16 12h-2"}),t("path",{d:"M22 12h-2"}),t("path",{d:"m15 19-3-3-3 3"}),t("path",{d:"m15 5-3 3-3-3"})])],-1))])]),e[22]||(e[22]=i('<p>主要是 <code>flows</code> 文件夹那里，推荐结合后面的demo来看</p><h3 id="demo-helloworld-的-quick-start" tabindex="-1"><a class="header-anchor" href="#demo-helloworld-的-quick-start"><span>demo - HelloWorld 的 quick-start</span></a></h3><p>该工作流的流程：</p><ul><li>(1) <code>URL to path #1</code>: 从url中下载到一个 <code>.csv</code> 文件</li><li>(2) <code>Csv To Df #1</code>: 转换为df数据 (这是python Pandas库中的表格型数据结构 <code>DateFrame</code>)</li><li>(3) <code>DF Preview #1</code>: 表格方式查看DF数据</li><li>(3) <code>Column Number Filter #1</code>: 筛选过滤掉一部分</li><li>(4) <code>Bar Chart #1</code>: 画柱形图</li></ul><p><img src="'+c+`" alt="" loading="lazy"></p><div class="language-yml line-numbers-mode" data-highlighter="shiki" data-ext="yml" data-title="yml" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;"># hello-world/flows/1-quick-start/flow.oo.yaml</span></span>

...
<span class="token punctuation">(</span><span class="token car">deflayermap</span> <span class="token punctuation">(</span><span class="token car">custom-map-example</span><span class="token punctuation">)</span>
  ...
  <span class="token comment">;; You can use _ , __ or ___ instead of specifying a key name to map all</span>
  <span class="token comment">;; keys that are not explicitly mapped in the layer.</span>
  <span class="token comment">;; E.g. esc and caps above will not be overwritten.</span>
  <span class="token comment">;;</span>
  <span class="token comment">;; _    maps only keys that are in defsrc.</span>
  <span class="token comment">;; __   excludes mapping keys that are in defsrc.</span>
  <span class="token comment">;; ___  maps both, keys that are in \`defsrc\`, and keys that are not.</span>
  <span class="token comment">;;</span>
  <span class="token comment">;; The two- and three-underscore variants require</span>
  <span class="token comment">;; &quot;process-unmapped-keys yes&quot; in defcfg to work.</span>
  ...
  _ XX   <span class="token comment">;; maps all keys that are in defsrc and are not mapped in the layer</span>
  __ XX  <span class="token comment">;; maps all keys that are NOT in defsrc and are not mapped in the layer</span>
<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="defvar、defalias-变量" tabindex="-1"><a class="header-anchor" href="#defvar、defalias-变量"><span>defvar、defalias 变量</span></a></h2><h3 id="tap-timeout、hold-timeout、tap-hold-按住多少时间" tabindex="-1"><a class="header-anchor" href="#tap-timeout、hold-timeout、tap-hold-按住多少时间"><span>tap-timeout、hold-timeout、tap-hold 按住多少时间</span></a></h3><div class="language-lisp line-numbers-mode" data-ext="lisp" data-title="lisp"><pre class="language-lisp"><code><span class="token comment">;; Defvar可以用来声明常用的值</span>

import{_ as p,c as r,a as s,d as t,b as o,w as l,r as k,o as B,e as i}from"./app-CMpzP5QO.js";const c={};function A(u,n){const d=k("VueFlow"),h=k("Tabs");return B(),r("div",null,[n[6]||(n[6]=s("h1",{id:"nodeflow-列表语法",tabindex:"-1"},"NodeFlow 列表语法",-1)),n[7]||(n[7]=s("h2",{id:"一种基于markdown列表的便于输入的节点描述语法",tabindex:"-1"},"一种基于Markdown列表的便于输入的节点描述语法",-1)),n[8]||(n[8]=s("p",null,"新增一种能手写的格式，说真的有时设计语法比开发成就感还强……大家讨论讨论语法，看有没有什么可以优化的地方",-1)),n[9]||(n[9]=s("ol",null,[s("li",null,"该语法可以和AnyBlock插件配合，从列表进行声明"),s("li",null,"参考了：JSON、JSONL、YAML、Mermaid/Mehrmaid 流程图语法")],-1)),n[10]||(n[10]=s("h3",{id:"示例",tabindex:"-1"},"示例",-1)),t(h,{data:[{id:"Plugin effect (插件效果)"},{id:"md source code (md源码)"}]},{title0:l(({value:a,isActive:e})=>[...n[0]||(n[0]=[i("Plugin effect (插件效果)",-1)])]),title1:l(({value:a,isActive:e})=>[...n[1]||(n[1]=[i("md source code (md源码)",-1)])]),tab0:l(({value:a,isActive:e})=>[t(d,{type:"nodeflow-list",data:`- nodes
  - node1: KSample
    - Latent, o
    - model, i
    - positive, i

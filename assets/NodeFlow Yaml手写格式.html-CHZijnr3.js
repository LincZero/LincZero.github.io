...
<span class="token operator">-</span> self<span class="token operator">:</span> edge_id2 from_node<span class="token punctuation">,</span> from_socket to_node<span class="token punctuation">,</span> to_socket
    children<span class="token operator">:</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>即：每个object固定有且只有两个项</p><ul><li>我们省略了self项，用不缩进表示</li><li>我们省略了children项，用缩进表示</li></ul><p>在开发时，为了灵活性，我们增加了parent项。每一个树节点都有父子指针！</p><h2 id="语法确定" tabindex="-1"><a class="header-anchor" href="#语法确定"><span>语法确定</span></a></h2><h3 id="v1-1" tabindex="-1"><a class="header-anchor" href="#v1-1"><span>V1</span></a></h3>`,78)),a(e,{type:"list2",data:`- nodes
  - 1, name1
    - s11, name, input
    - s12, name, output
    - s13, name, value
...
`}),a(e,{type:"list-demo-old",data:""}),s[1]||(s[1]=n("p",null,"(默认类型为node)",-1)),a(e,{type:"list-demo2",data:`- nodes
  - 1, name1
    - s11, name: input
    - s12, name: output
    - s13, name: value
...
- edges
  - 1, s12, 2, s21
  - 2, s22, 3, s31
`}),s[2]||(s[2]=n("h3",{id:"配合anyblock",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#配合anyblock"},[n("span",null,"配合anyblock")])],-1)),n("div",d,[n("div",k,[n("div",null,[a(t,{type:"list-old",data:`- nodes
  - 1, name1
    - s11, name, input
    - s12, name, output
    - s13, name, value
...
`})])])]),s[3]||(s[3]=n("h3",{id:"v2-id-name-value-name",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#v2-id-name-value-name"},[n("span",null,"v2 id:name, value:name")])],-1)),n("div",r,[n("div",v,[n("div",null,[a(t,{type:"list-old",data:`- nodes
  - node1
    - s11:name, input
    - s12:name, output
    - s13:name, value

import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as t,o as l,c as d,a as n,b as s,d as o,e as a}from"./app-BP7mptqa.js";const c={},p=a('<h1 id="kramdown" tabindex="-1"><a class="header-anchor" href="#kramdown"><span>kramdown</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><p>官网文档：https://kramdown.gettalong.org/quickref.html</p><h1 id="kramdown基本语法" tabindex="-1"><a class="header-anchor" href="#kramdown基本语法"><span>kramdown基本语法</span></a></h1><h2 id="kramdown基本语法-1" tabindex="-1"><a class="header-anchor" href="#kramdown基本语法-1"><span>kramdown基本语法</span></a></h2>',5),r={href:"https://zhuanlan.zhihu.com/p/60838339",target:"_blank",rel:"noopener noreferrer"},u=a(`<h3 id="atx-风格标题-header" tabindex="-1"><a class="header-anchor" href="#atx-风格标题-header"><span>atx 风格标题 <code>{#header}</code></span></a></h3><div class="language-markdown line-numbers-mode" data-ext="md" data-title="md"><pre class="language-markdown"><code>~<span class="token strike"><span class="token punctuation">~~</span><span class="token content">
#         一级
##
###
####

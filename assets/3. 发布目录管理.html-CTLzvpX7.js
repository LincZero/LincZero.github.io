import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,a as e}from"./app-DGJmjHtg.js";const t={},i=e(`<h1 id="目录管理" tabindex="-1"><a class="header-anchor" href="#目录管理"><span>目录管理</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="发布目录管理" tabindex="-1"><a class="header-anchor" href="#发布目录管理"><span>发布目录管理</span></a></h1><h2 id="本地简易安装器-纯批处理" tabindex="-1"><a class="header-anchor" href="#本地简易安装器-纯批处理"><span>本地简易安装器 - 纯批处理</span></a></h2><h3 id="start-bat-windows" tabindex="-1"><a class="header-anchor" href="#start-bat-windows"><span>start.bat (Windows)</span></a></h3><div class="language-c line-numbers-mode" data-ext="c" data-title="c"><pre class="language-c"><code>@echo off

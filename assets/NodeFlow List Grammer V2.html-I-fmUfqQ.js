import{_ as h,c as k,a as i,d as t,b as c,w as e,r,o as p,e as s}from"./app-U6aqFarS.js";const B={};function m(u,n){const d=r("VueFlow"),o=r("Tabs");return p(),k("div",null,[n[6]||(n[6]=i("h1",{id:"nodeflow-列表语法",tabindex:"-1"},"NodeFlow 列表语法",-1)),n[7]||(n[7]=i("h2",{id:"一种基于markdown列表的便于输入的节点描述语法",tabindex:"-1"},"一种基于Markdown列表的便于输入的节点描述语法",-1)),n[8]||(n[8]=i("p",null,"新增一种能手写的格式，说真的有时设计语法比开发成就感还强……大家讨论讨论语法，看有没有什么可以优化的地方",-1)),n[9]||(n[9]=i("ol",null,[i("li",null,"该语法可以和AnyBlock插件配合，从列表进行声明"),i("li",null,"参考了：JSON、JSONL、YAML、Mermaid/Mehrmaid 流程图语法")],-1)),n[10]||(n[10]=i("h3",{id:"示例",tabindex:"-1"},"示例",-1)),t(o,{data:[{id:"Plugin effect (插件效果)"},{id:"md source code (md源码)"}]},{title0:e(({value:l,isActive:a})=>[...n[0]||(n[0]=[s("Plugin effect (插件效果)",-1)])]),title1:e(({value:l,isActive:a})=>[...n[1]||(n[1]=[s("md source code (md源码)",-1)])]),tab0:e(({value:l,isActive:a})=>[t(d,{type:"nodeflow-list",data:`- nodes
  - Load Checkpoint
    - only name, i
    - i2, i, *i2
    - i3, i, mul line
    ...
    - v5:, , only value
      ...
      v5-2
- edges
`})]),tab1:e(({value:l,isActive:a})=>[...n[2]||(n[2]=[i("div",{class:"language-md line-numbers-mode","data-highlighter":"shiki","data-ext":"md",style:{"--shiki-light":"#383A42","--shiki-dark":"#abb2bf","--shiki-light-bg":"#FAFAFA","--shiki-dark-bg":"#282c34"}},[i("pre",{class:"shiki shiki-themes one-light one-dark-pro vp-code"},[i("code",{class:"language-md"},[i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#ABB2BF"}},"```nodeflow-list")]),s(`
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#ABB2BF"}},"```")])])]),i("div",{class:"line-numbers","aria-hidden":"true",style:{"counter-reset":"line-number 0"}},[i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"}),i("div",{class:"line-number"})])],-1)])]),_:1}),n[11]||(n[11]=c('<h3 id="通用规则" tabindex="-1">通用规则</h3><ol><li><strong>一行一个项</strong>，“项” 有四种：节点、节点上I/O Socket或属性项、线、节点组，他们的声明方式： <ul><li>节点/组 <code>id(:name)?, ()=&quot;node&quot;</code><br> 不写冒号表示id和节点名是一样的，type可以不写，默认为 &quot;node&quot;</li><li>接口 <code>id(:name), (i|o|v|&quot;&quot;), (value)=&quot;&quot;</code><br> type为 <code>input</code>/<code>output </code>表述输入或输出接口，<code>value</code> 表示并非这两种之一属性</li><li>线条 <code>from, from socket, to, to socket, (name)?</code><br> 从哪个节点id，的哪个socket id，到哪个节点id，的哪个socket id</li></ul></li><li>缩进关系表示包含关系。例如节点组可以包含节点，节点可以包含节点组</li></ol><h3 id="特殊规则-进阶" tabindex="-1">特殊规则 (进阶)</h3><ol><li>最外层是两个特殊组，nodes和edges，固定的。 <ul><li>当然，有一个写法变形可以去掉最外层，用如果该项有四个参数就是edges组，否则则为nodes组，但我觉得虽然能写少了，但可能更容易造成混乱？待定</li></ul></li><li>当不声明节点socket时，会默认声明四个隐藏节点：left、right、top、bottom</li></ol><h2 id="超简化" tabindex="-1">超简化</h2>',5)),t(d,{type:"nodeflow-list",data:`
- nodes
  - GroupA
    - a1
    - a2
...
- edges
  ...
  - a1,r, c11,l
  - a1,r, d,l
`}),n[12]||(n[12]=i("h2",{id:"实际用例参考",tabindex:"-1"},"实际用例参考",-1)),t(o,{data:[{id:"Plugin effect (插件效果)"},{id:"md source code (md源码)"}]},{title0:e(({value:l,isActive:a})=>[...n[3]||(n[3]=[s("Plugin effect (插件效果)",-1)])]),title1:e(({value:l,isActive:a})=>[...n[4]||(n[4]=[s("md source code (md源码)",-1)])]),tab0:e(({value:l,isActive:a})=>[t(d,{type:"nodeflow-list",data:`- nodes
  - node1:KSample
    - Latent, o
    - model, i
    - positive, i
...
`})]),tab1:e(({value:l,isActive:a})=>[...n[5]||(n[5]=[i("div",{class:"language-md line-numbers-mode","data-highlighter":"shiki","data-ext":"md",style:{"--shiki-light":"#383A42","--shiki-dark":"#abb2bf","--shiki-light-bg":"#FAFAFA","--shiki-dark-bg":"#282c34"}},[i("pre",{class:"shiki shiki-themes one-light one-dark-pro vp-code"},[i("code",{class:"language-md"},[i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#ABB2BF"}},"```nodeflow-list")]),s(`
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#ABB2BF"}},"- nodes")]),s(`

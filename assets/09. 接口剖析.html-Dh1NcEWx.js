...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h5 id="注册计时事件-registerinterval" tabindex="-1"><a class="header-anchor" href="#注册计时事件-registerinterval"><span>注册计时事件（registerInterval）</span></a></h5><p>计时事件</p>`,27)),s("p",null,[n[2]||(n[2]=a("如果要以固定延迟重复调用函数，请使用 ")),s("a",u,[n[0]||(n[0]=s("code",null,"window.setInterval()",-1)),p(e)]),n[3]||(n[3]=a("功能与 ")),s("a",d,[n[1]||(n[1]=s("code",null,"registerInterval()",-1)),p(e)]),n[4]||(n[4]=a("方法。"))]),n[9]||(n[9]=t(`<p>以下示例在状态栏中显示当前时间，每秒更新一次：</p><div class="language-typescript line-numbers-mode" data-ext="ts" data-title="ts"><pre class="language-typescript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span> moment<span class="token punctuation">,</span> Plugin <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&quot;obsidian&quot;</span><span class="token punctuation">;</span>
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token keyword">class</span> <span class="token class-name">ExamplePlugin</span> <span class="token keyword">extends</span> <span class="token class-name">Plugin</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2)),s("p",null,[n[6]||(n[6]=a("其中， ")),s("a",k,[n[5]||(n[5]=a("Moment ")),p(e)]),n[7]||(n[7]=a("是一个流行的 JavaScript 库，用于处理日期和时间。 Obsidian 内部使用 Moment，因此您无需自行安装。 您可以改为从 Obsidian API 导入它"))]),n[10]||(n[10]=t(`<h5 id="注册编辑建议-registereditorsuggest" tabindex="-1"><a class="header-anchor" href="#注册编辑建议-registereditorsuggest"><span>注册编辑建议（registerEditorSuggest）</span></a></h5><p>（插件 Ad 中使用过）</p><h5 id="注册视图窗口-registerview" tabindex="-1"><a class="header-anchor" href="#注册视图窗口-registerview"><span>注册视图窗口（registerView）</span></a></h5><p>略，详见：第三方文档 &gt; 用户界面 &gt; 视图</p><h5 id="注册其他" tabindex="-1"><a class="header-anchor" href="#注册其他"><span>注册其他</span></a></h5><p>形如 <code>register……</code> 的方法，主要是Plugin2和Component接口声明的</p><p>（有五个没见过，其他都见过有插件用）</p><div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre class="language-javascript"><code><span class="token comment">// Plugin_2 (8)</span>

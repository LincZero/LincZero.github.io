import{_ as a,c as r,e as l,a as e,d as i,b as s,o,r as d}from"./app-C-bjNnVy.js";const u={},c={href:"https://docs.python.org/zh-cn/3.7/extending/index.html",target:"_blank",rel:"noopener noreferrer"},p={href:"https://blog.csdn.net/wzyaiwl/article/details/115298127",target:"_blank",rel:"noopener noreferrer"},v={href:"https://blog.csdn.net/wzyaiwl/article/details/115298127",target:"_blank",rel:"noopener noreferrer"};function m(y,n){const t=d("ExternalLinkIcon");return o(),r("div",null,[n[5]||(n[5]=l('<h1 id="qt" tabindex="-1"><a class="header-anchor" href="#qt"><span>Qt</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="py-应用程序脚本" tabindex="-1"><a class="header-anchor" href="#py-应用程序脚本"><span>.py 应用程序脚本</span></a></h1><p>与C/C++调用Python程序的原理是一样的，QT也没有什么特殊的地方</p><p>参考：</p>',5)),e("ul",null,[e("li",null,[e("a",c,[n[0]||(n[0]=i("【Python官网文档】扩展和嵌入 Python 解释器")),s(t)])]),e("li",null,[e("a",p,[n[1]||(n[1]=i("【CSDN】QT——调用Python脚本")),s(t)])]),n[2]||(n[2]=e("li",null,"c和c++调用Python，https://www.xzhongwei.com/post/127，好总结，重要参考",-1))]),n[6]||(n[6]=l('<h2 id="简概" tabindex="-1"><a class="header-anchor" href="#简概"><span>简概</span></a></h2><h3 id="py与-js区别" tabindex="-1"><a class="header-anchor" href="#py与-js区别"><span>.py与.js区别</span></a></h3><p>.py用作脚本的话和.js脚本类型，有略微不同</p><ul><li>Qt工程上的区别： <ul><li>.py：<mark>可以直接创建，不用加入到.qrc资源文件当中</mark>，会归类到 “Other files” 当中</li><li>.js：<mark>无法直接创建，但可以添加进.qrc资源文件中</mark></li></ul></li><li>语言自身性质区别：python可以创建类，面向对象编程</li><li>Qt支持上的区别：python有<code>PySide2 / PyQt5</code>模块的支持，这能让Python像C++一样使用Qt框架</li></ul><h3 id="基本配置" tabindex="-1"><a class="header-anchor" href="#基本配置"><span>基本配置</span></a></h3><h4 id="qt中运行python脚本" tabindex="-1"><a class="header-anchor" href="#qt中运行python脚本"><span>QT中运行Python脚本</span></a></h4><p>（图文版见参考链接）</p>',7)),n[7]||(n[7]=e("blockquote",null,[e("p",null,"工具->选项->环境->外部工具"),e("ol",null,[e("li",null,"添加->添加目录 (双击可任意更改名称这里更改为RunPy)"),e("li",null,"添加->添加工具(双击可任意更改名称这里更改为Python3)"),e("li",null,[i("点击Python3，配置执行档、参数等配置： "),e("ul",null,[e("li",null,"执行档：（根据python安装路径设置，D:\\Soft\\Dev\\All\\Python_Anaconda\\python.exe )"),e("li",{"CurrentDocument:FilePath":""},"参数：%"),e("li",{"CurrentDocument:Path":""},"工作目录：%")])])])],-1)),n[8]||(n[8]=l(`<h4 id="c-中调用python脚本" tabindex="-1"><a class="header-anchor" href="#c-中调用python脚本"><span>C++中调用Python脚本</span></a></h4><blockquote><p>项目文件下右键 -&gt; 添加库</p><ol><li>选择链接到库的类型 -&gt; 外部库 -&gt; 下一步</li><li>制定链接库和包含路径 <ul><li>Library type：WIndows</li><li>库文件：（根据安装路径设置，D:\\Soft\\Dev\\All\\Python_Anaconda\\libs\\python37.lib）</li><li>包含路径：（根据安装路径设置，D:\\Soft\\Dev\\All\\Python_Anaconda\\libs）</li><li>平台：取选Linux、Mac，只留Windows（默认全勾选）</li><li>链接：静态（默认是动态）</li><li>Windows：取选：为debug版本添加 &#39;d&#39; 作为后缀 <strong>（教程里勾选但实际应该是取选。比如勾选的话他会找我的python37d.lib，但我没有啊。当然也可以后期在.pro里删掉 &#39;d&#39;）</strong></li></ul></li></ol></blockquote><h3 id="基本使用" tabindex="-1"><a class="header-anchor" href="#基本使用"><span>基本使用</span></a></h3><p>测试代码1</p><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>#include &lt;Python.h&gt;
Py_Initialize();
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="坑非常多-建议逐步测试" tabindex="-1"><a class="header-anchor" href="#坑非常多-建议逐步测试"><span>坑非常多，建议逐步测试</span></a></h2><p>逐步测试详见Python笔记中的编译DLL一章</p>`,17)),e("p",null,[n[4]||(n[4]=i("更多的坑见：")),e("a",v,[n[3]||(n[3]=i("【CSDN】QT——调用Python脚本")),s(t)])]),n[9]||(n[9]=l(`<h3 id="首先检查" tabindex="-1"><a class="header-anchor" href="#首先检查"><span><mark>首先检查</mark></span></a></h3><h4 id="修改py文件时要修改两处" tabindex="-1"><a class="header-anchor" href="#修改py文件时要修改两处"><span>修改py文件时要修改两处</span></a></h4><p><mark>更新py文件时要注意，exe目录和源项目中的py文件都要更新，别忘了前者</mark></p><h4 id="推荐每一步-if-一下-看哪步出错了" tabindex="-1"><a class="header-anchor" href="#推荐每一步-if-一下-看哪步出错了"><span>推荐每一步 if 一下，看哪步出错了</span></a></h4><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>void runPy(){
    Py_SetPythonHome(L&quot;D:\\\\Soft\\\\Dev\\\\All\\\\Python_Anaconda&quot;);

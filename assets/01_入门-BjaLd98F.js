import{a as e,c as t,d as n,l as r,m as i,u as a}from"./app-s9ZLnBRD.js";var o=JSON.parse(`{"path":"/MdNote_Public/01.%20DesignAndDevelop/Develop/01.%20Language/Go/01_%E7%BC%96%E7%A8%8B%E8%AF%AD%E8%A8%80/01_%E5%85%A5%E9%97%A8.html","title":"入门","lang":"zh-CN","frontmatter":{"create_time":"2024-04-02T00:00:00.000Z","description":"入门 知识 背景 go语言的于2007年在谷歌创建，2012年发布开源版本1.0 团队：罗伯特 格瑞史莫、罗勃 派克、肯 汤普逊 发明人之一 肯 汤普逊，他还发明了B和C编程语言 吉祥物：金花鼠 Gordon 特点 特点 简单高效：它的设计初衷呢就是简单高效，这也是为什么我们常常说go而不是golang的原因 编译型语言，静态类型语言：源代码被编译成机...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"入门\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"],["meta",{"property":"og:url","content":"https://LincZero.github.io/MdNote_Public/01.%20DesignAndDevelop/Develop/01.%20Language/Go/01_%E7%BC%96%E7%A8%8B%E8%AF%AD%E8%A8%80/01_%E5%85%A5%E9%97%A8.html"}],["meta",{"property":"og:site_name","content":"Linc 的小站"}],["meta",{"property":"og:title","content":"入门"}],["meta",{"property":"og:description","content":"入门 知识 背景 go语言的于2007年在谷歌创建，2012年发布开源版本1.0 团队：罗伯特 格瑞史莫、罗勃 派克、肯 汤普逊 发明人之一 肯 汤普逊，他还发明了B和C编程语言 吉祥物：金花鼠 Gordon 特点 特点 简单高效：它的设计初衷呢就是简单高效，这也是为什么我们常常说go而不是golang的原因 编译型语言，静态类型语言：源代码被编译成机..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}]],"date":"2024-04-02T00:00:00.000Z"},"git":{},"readingTime":{"minutes":7.17,"words":2151},"filePathRelative":"MdNote_Public/01. DesignAndDevelop/Develop/01. Language/Go/01_编程语言/01_入门.md","excerpt":"\\n<h2>知识</h2>\\n<h3>背景</h3>\\n<ul>\\n<li>go语言的于2007年在谷歌创建，2012年发布开源版本1.0</li>\\n<li>团队：罗伯特 格瑞史莫、罗勃 派克、肯 汤普逊</li>\\n<li>发明人之一 肯 汤普逊，他还发明了B和C编程语言</li>\\n</ul>\\n<p>吉祥物：金花鼠 Gordon</p>\\n<h3>特点</h3>\\n<ul>\\n<li>特点\\n<ul>\\n<li>简单高效：它的设计初衷呢就是简单高效，这也是为什么我们常常说go而不是golang的原因</li>\\n<li>编译型语言，静态类型语言：源代码被编译成机器代码后，意味着它通常优于解释型语言，尽管构成一种静态类型语言</li>\\n<li>极快的编译时间：但它以极快的编译时间而闻名，这也得益于依赖性的分析方法，更为类型推断提供了非常简洁和实用的语法</li>\\n<li>模块系统：此外它还具有一个我们所知道的 package包和某种模块系统，便于在项目之间的进行导入和导出代码</li>\\n<li>垃圾回收：支持</li>\\n</ul>\\n</li>\\n<li>语法特点\\n<ul>\\n<li>从语法上讲 go就像C或C++的简明版本。例如声明一个变量，其中的word关键字后，跟其名称和类型并用一个值进行初始化，或者你也可以用短赋值语法来替代word，并自动推断类型，你还可以在一行中定义多个变量构</li>\\n<li>具有编程语言中所期望的所有功能，如数组啊，map循环控制</li>\\n<li>它也允许你使用指针存储值的内存地址，但不允许使用智能算法，这会导致很多不可预测的行为</li>\\n<li>此外go还支持并发历程，go历程是利用CPU上的多个线程，与其他函数同时运行的函数</li>\\n</ul>\\n</li>\\n</ul>","autoDesc":true,"bioChainData":{"outlink":[],"backlink":[],"localMap":{"nodes":[{"id":"MdNote_Public/01. DesignAndDevelop/Develop/01. Language/Go/01_编程语言/01_入门.md","value":{"title":"01_入门","path":"MdNote_Public/01. DesignAndDevelop/Develop/01. Language/Go/01_编程语言/01_入门.md","outlink":[],"backlink":[]}}],"links":[]}}}`),s={name:`01_入门.md`};function c(e,o,s,c,l,u){return i(),a(`div`,null,[...o[0]||=[n(`<h1 id="入门" tabindex="-1">入门</h1><h2 id="知识" tabindex="-1">知识</h2><h3 id="背景" tabindex="-1">背景</h3><ul><li>go语言的于2007年在谷歌创建，2012年发布开源版本1.0</li><li>团队：罗伯特 格瑞史莫、罗勃 派克、肯 汤普逊</li><li>发明人之一 肯 汤普逊，他还发明了B和C编程语言</li></ul><p>吉祥物：金花鼠 Gordon</p><h3 id="特点" tabindex="-1">特点</h3><ul><li>特点 <ul><li>简单高效：它的设计初衷呢就是简单高效，这也是为什么我们常常说go而不是golang的原因</li><li>编译型语言，静态类型语言：源代码被编译成机器代码后，意味着它通常优于解释型语言，尽管构成一种静态类型语言</li><li>极快的编译时间：但它以极快的编译时间而闻名，这也得益于依赖性的分析方法，更为类型推断提供了非常简洁和实用的语法</li><li>模块系统：此外它还具有一个我们所知道的 package包和某种模块系统，便于在项目之间的进行导入和导出代码</li><li>垃圾回收：支持</li></ul></li><li>语法特点 <ul><li>从语法上讲 go就像C或C++的简明版本。例如声明一个变量，其中的word关键字后，跟其名称和类型并用一个值进行初始化，或者你也可以用短赋值语法来替代word，并自动推断类型，你还可以在一行中定义多个变量构</li><li>具有编程语言中所期望的所有功能，如数组啊，map循环控制</li><li>它也允许你使用指针存储值的内存地址，但不允许使用智能算法，这会导致很多不可预测的行为</li><li>此外go还支持并发历程，go历程是利用CPU上的多个线程，与其他函数同时运行的函数</li></ul></li></ul><h3 id="实用性" tabindex="-1">实用性</h3><ul><li>应用领域 <ul><li>Go服务器端/游戏软件工程师</li><li>Go分布式/云计算软件工程师</li><li>区块链工程师</li></ul></li><li>落地 <ul><li>Docker就是用Golang编写的，它在容器化方面表现出色</li></ul></li><li>就业 <ul><li>Google、Facebook、腾讯、百度、京东、小米、360、美团、滴滴、阿里、七牛等</li></ul></li></ul><h3 id="快速入门" tabindex="-1">快速入门</h3><ul><li>使用流程 <ul><li>安装：go的使用需要先进行安装</li><li>编写：然后在系统上打开一个空目录，创建一个点go结尾的文件，顶部添加package，main里创建一个独立的可执行文件，接着声明一个main函数，该函数就是程序开始执行的地方，都有一个标准的核心，包括用于处理常见的需求 像我们的数学呀 网络呀 格式化呀，通过导入format 我们可以将这一行内容打印为标准输出</li><li>编译：运行go build命令，它可以将源代码和依赖下 快速编译成可执行的二进制文件</li><li>依赖解决：说到依赖项 我们还可以连接到GITHUB上的远程包，例如运行go mode in it 这将创建一个go模块文件，已启用依赖性跟踪。</li></ul></li></ul><h2 id="软件环境" tabindex="-1">软件环境</h2><h3 id="安装-ide" tabindex="-1">安装 - IDE</h3><ul><li>Visual Stuido Code</li><li>Sublime Tet</li><li>Vim</li><li>Emacs</li><li>Eclipse</li><li>LiteIDE</li><li>JetBrains</li></ul><p>这里选 VSC</p><p>取消目录折叠 设置：右下设置 &gt; User &gt; Features &gt; Explorer &gt; Compact Folders 取选</p><h3 id="安装-开发环境-sdk" tabindex="-1">安装 - 开发环境 SDK</h3><h4 id="安装" tabindex="-1">安装</h4><p>和Java类型，这里也需要一个 SDK (Software Development Kit 软件开发工具包)</p><p>下载：去 <a href="http://golang.org" target="_blank" rel="noopener noreferrer">golang.org</a> 官网下载，国内可以选用中文社区：<a href="https://studygolang.com/dl%EF%BC%8Cwindows%E8%83%BD%E4%B8%8Bzip%E6%88%96msi" target="_blank" rel="noopener noreferrer">https://studygolang.com/dl，windows能下zip或msi</a></p><h4 id="环境结构" tabindex="-1">环境结构</h4><p>安装后的文件夹如下：</p><ul><li>bin/， go的一些常用命令 <ul><li>go.exe， 运行和编译器，类似java.exe</li><li>gofmt.exe， 进行代码格式化的</li></ul></li><li>lib/</li><li>misc/</li><li>pkg/ <ul><li>include/</li><li>tool/</li></ul></li><li>src/， 里面是一些.s或.go文件</li><li>test/， 里面是一些.go文件</li><li>codereview.cfg</li><li>go.env</li><li>PATENTS</li><li>(docs)， 文本类 <ul><li>api/， api存放，里面全是.txt文档</li><li>doc/，html文档</li><li><a href="http://CONTRIBUTING.md" target="_blank" rel="noopener noreferrer">CONTRIBUTING.md</a></li><li>LINCENSE</li><li><a href="http://README.md" target="_blank" rel="noopener noreferrer">README.md</a></li><li><a href="http://SECURITY.md" target="_blank" rel="noopener noreferrer">SECURITY.md</a></li><li>VSRSION</li></ul></li></ul><h4 id="检查" tabindex="-1">检查</h4><div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-bash"><span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">$</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> go</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> version</span><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;"> # 在任意路径下</span></span>
...
<span class="line"><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;"># 例如zip而非msi安装不会自动配置环境变量，就要自己去配置</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="前提知识-windows-dos命令" tabindex="-1">前提知识 - windows dos命令</h3><p>win+R，cmd回车</p><div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-bash"><span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">盘符:</span><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;">		   # 切换盘符</span></span>
...
<span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">del</span><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;">			# 删除文件，Linux中的 rm</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="helloworld" tabindex="-1">HelloWorld</h2><h3 id="项目新建、项目结构" tabindex="-1">项目新建、项目结构</h3><p>准备好Go的项目结构：</p>`,31),t(`div`,{class:`ab-note drop-shadow`},[t(`div`,{class:`ab-list-table-parent`},[t(`table`,{class:`ab-table ab-list-table ab-table-folder`},[t(`tbody`,null,[t(`tr`,{class:`ab-foldable-tr`,tr_level:`0`,is_fold:`false`,able_fold:`true`,type:`folder`},[t(`td`,{rowspan:`1`,onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
          ...
          if (is_all_fold=="true") {
            ...
            const btn_subs = table.querySelectorAll("tr[is_fold='false']>td:first-child");
              btn_subs.forEach((btn_sub) => { btn_sub.click() }) // 注意setAttr版本无断言
          }`},[t(`svg`,{xmlns:`http://www.w3.org/2000/svg`,width:`24`,height:`24`,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":`2`,"stroke-linecap":`round`,"stroke-linejoin":`round`,class:`lucide lucide-fold-vertical-icon lucide-fold-vertical`},[t(`path`,{d:`M12 22v-6`}),t(`path`,{d:`M12 8V2`}),t(`path`,{d:`M4 12H2`}),t(`path`,{d:`M10 12H8`}),t(`path`,{d:`M16 12h-2`}),t(`path`,{d:`M22 12h-2`}),t(`path`,{d:`m15 19-3-3-3 3`}),t(`path`,{d:`m15 5-3 3-3-3`})])])])],-1),n(`<h3 id="编写代码" tabindex="-1">编写代码</h3><p>main.go</p><div class="language-go line-numbers-mode" data-highlighter="shiki" data-ext="go" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-go"><span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">package</span><span style="--shiki-light:#C18401;--shiki-dark:#E5C07B;"> main</span><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;">	// 声明文件所在的包，每个go文件必须有归属的包。包名最好和文件名一致，而且必须存在main包，否则报错：cannot run non-main package</span></span>
...
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>注意项：</p><blockquote><p>声明文件所在的包，每个go文件必须有归属的包。</p><p>这点有点类似Java的包管理，但似乎更严格。也有些类似于Java “所有函数都必须在类里” 的思想 (这点与C/C++不同)</p></blockquote><h3 id="编译与运行" tabindex="-1">编译与运行</h3><p>单文件编译：</p><div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-bash"><span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">$</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> cd</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> goProject/src/goCode/testProject01/main/</span></span>
<span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">$</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> go</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> build</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> test.go</span><span style="--shiki-light:#A0A1A7;--shiki-light-font-style:italic;--shiki-dark:#7F848E;--shiki-dark-font-style:italic;"> # 然后在windows环境直接就能生成小体积的test.exe，这点还是很不错的 (某些语言要生成exe还要做其他工作的，比较典型的如python要pyinstaller等)</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div></div></div><p>直接运行：</p><div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-bash"><span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">$</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> cd</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;"> goProject/src/goCode/testProject01/main/</span></span>

import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as l,c as t,a as e}from"./app-BlR0bcMW.js";const n={},d=e(`<h1 id="多线程-线程参数与数据" tabindex="-1"><a class="header-anchor" href="#多线程-线程参数与数据"><span>多线程 - 线程参数与数据</span></a></h1><h2 id="线程传参" tabindex="-1"><a class="header-anchor" href="#线程传参"><span>线程传参</span></a></h2><h3 id="临时对象-值传递" tabindex="-1"><a class="header-anchor" href="#临时对象-值传递"><span>临时对象（值传递）</span></a></h3><h4 id="引用传递-错误写法" tabindex="-1"><a class="header-anchor" href="#引用传递-错误写法"><span>引用传递（错误写法）</span></a></h4><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>#include &lt;iostream&gt;

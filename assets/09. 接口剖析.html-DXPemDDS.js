import{_ as o}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as p,o as i,c,a as s,b as n,d as e,e as t}from"./app-CFSjtYgt.js";const l={},r=t(`<h1 id="codemirror" tabindex="-1"><a class="header-anchor" href="#codemirror"><span>CodeMirror</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="接口剖析" tabindex="-1"><a class="header-anchor" href="#接口剖析"><span>接口剖析</span></a></h1><h2 id="state包" tabindex="-1"><a class="header-anchor" href="#state包"><span>State包</span></a></h2><div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre class="language-javascript"><code><span class="token keyword">import</span> <span class="token punctuation">{</span>

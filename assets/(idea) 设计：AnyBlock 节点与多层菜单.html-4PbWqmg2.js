import{_ as n,e as a,g as i,f as l,j as e,k as t,o as r}from"./app-DKzaHQwP.js";const o={};function d(c,s){return r(),a("div",null,s[0]||(s[0]=[i('<h1 id="idea-设计-anyblock-节点与多层菜单" tabindex="-1"><a class="header-anchor" href="#idea-设计-anyblock-节点与多层菜单"><span>(idea) 设计：AnyBlock 节点与多层菜单</span></a></h1><h2 id="介绍" tabindex="-1"><a class="header-anchor" href="#介绍"><span>介绍</span></a></h2><h3 id="应用场景" tabindex="-1"><a class="header-anchor" href="#应用场景"><span>应用场景</span></a></h3><p>一是表单、二是节点转用表单</p><h3 id="对比" tabindex="-1"><a class="header-anchor" href="#对比"><span>对比</span></a></h3><ul><li>json类型 <ul><li>类型(8): Number、String、Boolean、Array/Object、null、Value(any)、Whitespace</li><li>但最后两种没怎么见过，只适配6种应该也行</li></ul></li><li>请求表单 - json <ul><li>类型(8)：string、integer/number、boolean、array <strong>/object、null/any</strong></li></ul></li><li>请求表单 - params <ul><li>类型(6): string、integer/number、boolean、array、<strong>file</strong></li></ul></li><li>请求表单 - 表单实体 <ul><li>基本同上，但输入框类型还分：数字类型(是否密码)/文本单多行属性/约束等等</li></ul></li><li>节点表单类型 <ul><li>新增节点输入、节点输出类型<br> (特点：允许给一个字符串作为二次类型、通常没有Key名字，取之替代的是二次类型名)</li></ul></li><li>简化 - Schema码类型 <ul><li>删除了嵌套功能，节点类型删除Object/Array</li><li>删除了约束 (范围、必填等)</li><li>主要属性：&quot;type&quot;、&quot;default&quot;</li></ul></li></ul><h3 id="相似产品" tabindex="-1"><a class="header-anchor" href="#相似产品"><span>相似产品</span></a></h3><p>我记得 plantuml 有一个东西可以用于 UI 页面的绘制，甚至能着色、绘制按钮、显示菜单的展开状态等</p><p>但我这里并不需要，更需要的是稳定的格式</p><h3 id="anyblock-用-card-dir-模拟节点" tabindex="-1"><a class="header-anchor" href="#anyblock-用-card-dir-模拟节点"><span>AnyBlock 用 card+dir 模拟节点</span></a></h3><p>之前是用 card + dir 来模拟节点，例如：</p>',11),l("div",{class:"ab-note drop-shadow"},[l("div",{class:"ab-items ab-card ab-lay-vfall ab-col2"},[l("div",{class:"ab-items-item"},[l("div",{class:"ab-items-title markdown-rendered"},[l("div",null,[l("p",null,"Load Checkpoint")])]),l("div",{class:"ab-items-content markdown-rendered"},[l("div",null,[l("p",null,[e("中文：Checkpoint加载器(简易)"),l("br"),e(" 作用：加载扩散模型")]),l("ul",null,[l("li",null,"Checkpoint名称: 加载大模型"),l("li",null,"(O) 模型"),l("li",null,"(O) CLIP"),l("li",null,"(O) VAE")])])])]),l("div",{class:"ab-items-item"},[l("div",{class:"ab-items-title markdown-rendered"},[l("div",null,[l("p",null,"CLIP Text Encode (Prompt)")])]),l("div",{class:"ab-items-content markdown-rendered"},[l("div",null,[l("p",null,[e("中文：CLIP文本编码器 (提示词) (正面)"),l("br"),e(" 作用：CLIP (ContrastiveLanguageImagePretraining) 理解输入文字的意思")]),l("ul",null,[l("li",null,"(I) CLIO"),l("li",null,"文本"),l("li",null,"(O) 条件")])])])]),l("div",{class:"ab-items-item"},[l("div",{class:"ab-items-title markdown-rendered"},[l("div",null,[l("p",null,"CLIP Text Encode (Prompt)")])]),l("div",{class:"ab-items-content markdown-rendered"},[l("div",null,[l("p",null,"中文：CLIP文本编码器 (提示词) (负面)"),l("ul",null,[l("li",null,"(I) CLIO"),l("li",null,"文本"),l("li",null,"(O) 条件")])])])]),l("div",{class:"ab-items-item"},[l("div",{class:"ab-items-title markdown-rendered"},[l("div",null,[l("p",null,"Empty Latent Image")])]),l("div",{class:"ab-items-content markdown-rendered"},[l("div",null,[l("p",null,[e("中文：空Laten"),l("br"),e(" 作用：潜空间，内部流程中的图像格式 (例如图生图时，先VAE编码转化为Laten数据，然后处理完再解码回图像)，可以用于设置图片大小")]),l("ul",null,[l("li",null,"宽度"),l("li",null,"高度"),l("li",null,"批次大小")])])])]),l("div",{class:"ab-items-item"},[l("div",{class:"ab-items-title markdown-rendered"},[l("div",null,[l("p",null,"KSampler")])]),l("div",{class:"ab-items-content markdown-rendered"},[l("div",null,[l("p",null,"中文：K采样器"),l("div",{class:"ab-note drop-shadow"},[l("button",{class:"ab-table-fold",is_fold:"false"},"全部折叠/展开"),l("table",{class:"ab-table ab-list-table ab-table-folder"},[l("tbody",null,[l("tr",{class:"ab-foldable-tr",tr_level:"0",is_fold:"false",able_fold:"false",type:"(I) 模型",onclick:`
         const tr = this

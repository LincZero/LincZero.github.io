import{_ as n,c as a,b as e,o as p}from"./app-nOKFa9Yh.js";const l={};function i(t,s){return p(),a("div",null,s[0]||(s[0]=[e(`<h1 id="computersystems" tabindex="-1">ComputerSystems</h1><h1 id="目录" tabindex="-1">目录</h1><h1 id="汇编调试" tabindex="-1">汇编调试</h1><h2 id="调试汇编程序" tabindex="-1">调试汇编程序</h2><h3 id="bochs虚拟机-调试神器" tabindex="-1">Bochs虚拟机（调试神器）</h3><p>官网：<a href="http://bochs.sourceforge.net" target="_blank" rel="noopener noreferrer">http://bochs.sourceforge.net</a></p><p>下载地址：<a href="https://sourceforge.net/projects/bochs/files/bochs/2.6.11/" target="_blank" rel="noopener noreferrer">https://sourceforge.net/projects/bochs/files/bochs/2.6.11/</a></p><p>简单介绍：官网左下侧是使用手册，手册齐全、功能丰富、软件迷你仅仅5MB</p><p>使用：下载安装完成后有两个exe：bochs.exe和bochsdbg.exe，调试汇编程序时主要使用到的是后者</p><h3 id="调试过程" tabindex="-1">调试过程</h3><h4 id="配置部分" tabindex="-1">配置部分</h4><ol><li><p>将二进制写入虚拟硬盘</p><p>用FixVhdw程序将bin写入VHD后会告诉你程序写在了哪个物理空间</p><blockquote><p>提示信息：</p><p>虚拟硬盘： D:...\\Worksapce_VirtualBox\\AssemblyTest\\AssemblyTest\\AssemblyTest.vhd<br> VHD规范的原始创建者标识： conectix<br> 创建此文件的程序：vbox<br> 创建此文件的程序版本：06.01<br> 该虚拟磁盘创建于 2021-11-08 13:31:44。<br> 481个柱面；4个磁头；每磁道有17个扇区。<br> 总容量为 16 MB（兆字节）。<br> 该磁盘为固定磁盘（容量固定，文件大小不变）。</p></blockquote></li><li><p>配置FixVhdw，当然这步不是必须的，只是为了方便</p><ul><li>在VBox路径名的选项中，选择VirtualBox安装目录中的VirtualBox.exe，以方便快速执行VBox虚拟机</li><li>在Bochs路径名的选项中，选择Bochs的安装路径下的bochsdbg.exe，以方便快速执行Bochs虚拟机</li><li>在其他程序路径名的选项中，选择Bochs的安装路径下的bochs.exe，该程序不带Debug功能</li></ul></li><li><p>点击写入并执行Bochs虚拟机</p><ul><li>初次启动时需要进行配置</li><li>选择CD通道：中间的Disk&amp;Boot &gt; 左侧的Edit &gt; 弹出框 &gt; ATA Channel 0 &gt; First HD/CD on Channel <ul><li>Type of ATA device下拉框：disk (默认none)</li><li>Path or physical device name：选择对应的虚拟磁盘.vhd文件 (文件筛选要All files)</li><li>填写磁盘物理位置（需要填写之前在FixVhdw中提示的内容），demo中分别是481-4-17 <ul><li>Cylinders 柱面</li><li>Heads 磁头</li><li>Sector per track 每道扇区</li></ul></li></ul></li><li>Boot配置：Boot Options <ul><li><code>Boot drive #1：disk</code> (默认floopy)</li></ul></li><li>最后选择OK完成设置。可以将该配置保存为一个文件，不用每次都设置：点击左侧的Save按钮即可保存，若需加载则点击Load按钮</li><li>点击右侧的Start按钮运行debug用虚拟机，弹出黑框表示已进入调试状态。大黑框是调试窗口，新黑框是输出窗口</li></ul></li></ol><h4 id="调试命令" tabindex="-1">调试命令</h4><p>常用命令</p><ul><li><p>s：单步调试</p></li><li><p>s 200：s后面加数字，表示进行多少次单步调试</p></li><li><p>b：打断点，后跟内存地址，例如：<code>b 0x7c00</code>，会直接跳转到该位置</p></li><li><p>c：contine，继续执行</p></li><li><p>q：quit，退出调试，按两次Enter完全退出。不能点叉号关闭窗口，不然会导致你下一次不能运行</p></li><li><p>r：查看所有通用寄存器的内容（除了通用寄存器外还显示控制寄存器 (IP和EFLAGS) ）</p><div class="language-assembly line-numbers-mode" data-highlighter="shiki" data-ext="assembly" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-assembly"><span class="line"><span>; 可以看到每个寄存器都是16位的</span></span>
...
<span class="line"><span>eflags 0x00000082: id vip vif ac vm rf nt IOPL=0 of df if tf SF zf af pf cf</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div></li><li><p>sreg：查看段寄存器的内容（前4还是6个是段寄存器，后面的我也不指导是什么）</p><div class="language-assembly line-numbers-mode" data-highlighter="shiki" data-ext="assembly" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-assembly"><span class="line"><span>es:0x0000, dh=0x00009300, dl=0x0000ffff, valid=1	; 附加段</span></span>
...
<span class="line"><span>idtr:base=0x0000000000000000, limit=0x3ff</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div></li><li><p>xp /nuf addr：查看物理内存，n=查看多少个单位，u=单位，u可以是b/h/w/g (1/2/4/8字节)，例如：<code>xp /1wx 0x7c0f1</code></p></li></ul><h4 id="正式调试部分" tabindex="-1">正式调试部分</h4><p>调试过程</p><div class="language-assembly line-numbers-mode" data-highlighter="shiki" data-ext="assembly" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-assembly"><span class="line"><span>; 跳转到地址e05b，e05b是BIOS程序的入口</span></span>
...
<span class="line"><span>; ...</span></span>
<span class="line"><span></span></span>
<span class="line"><span>&gt; q</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div><h2 id="nasm技巧" tabindex="-1">nasm技巧</h2><div class="language-assembly line-numbers-mode" data-highlighter="shiki" data-ext="assembly" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-assembly"><span class="line"><span>nasm -f bin start.asm -o start.bin -l start.lst</span></span>
<span class="line"><span># 【技巧】</span></span>
<span class="line"><span># -l：然后后面再加一个.lst扩展名的文件，可以生成一个包括汇编地址、代码以及机器码的文件。可以方便用来调试</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div>`,20)]))}const o=n(l,[["render",i]]),r=JSON.parse('{"path":"/MdNote_Public/01.%20DesignAndDevelop/Develop/02.%20Theory/Computer/02.%20%E8%AE%A1%E7%AE%97%E6%9C%BA%E6%8C%87%E4%BB%A4/01.%20%E6%B1%87%E7%BC%96%E5%9F%BA%E7%A1%80/03.%20%E6%B1%87%E7%BC%96%E8%B0%83%E8%AF%95.html","title":"ComputerSystems","lang":"zh-CN","frontmatter":{"description":"ComputerSystems 目录 汇编调试 调试汇编程序 Bochs虚拟机（调试神器） 官网：http://bochs.sourceforge.net 下载地址：https://sourceforge.net/projects/bochs/files/bochs/2.6.11/ 简单介绍：官网左下侧是使用手册，手册齐全、功能丰富、软件迷你仅仅5MB...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"ComputerSystems\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"],["meta",{"property":"og:url","content":"https://LincZero.github.io/MdNote_Public/01.%20DesignAndDevelop/Develop/02.%20Theory/Computer/02.%20%E8%AE%A1%E7%AE%97%E6%9C%BA%E6%8C%87%E4%BB%A4/01.%20%E6%B1%87%E7%BC%96%E5%9F%BA%E7%A1%80/03.%20%E6%B1%87%E7%BC%96%E8%B0%83%E8%AF%95.html"}],["meta",{"property":"og:site_name","content":"Linc 的小站"}],["meta",{"property":"og:title","content":"ComputerSystems"}],["meta",{"property":"og:description","content":"ComputerSystems 目录 汇编调试 调试汇编程序 Bochs虚拟机（调试神器） 官网：http://bochs.sourceforge.net 下载地址：https://sourceforge.net/projects/bochs/files/bochs/2.6.11/ 简单介绍：官网左下侧是使用手册，手册齐全、功能丰富、软件迷你仅仅5MB..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}]]},"git":{},"readingTime":{"minutes":4.41,"words":1324},"filePathRelative":"MdNote_Public/01. DesignAndDevelop/Develop/02. Theory/Computer/02. 计算机指令/01. 汇编基础/03. 汇编调试.md","excerpt":"\\n<h1>目录</h1>\\n<h1>汇编调试</h1>\\n<h2>调试汇编程序</h2>\\n<h3>Bochs虚拟机（调试神器）</h3>\\n<p>官网：<a href=\\"http://bochs.sourceforge.net\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">http://bochs.sourceforge.net</a></p>\\n<p>下载地址：<a href=\\"https://sourceforge.net/projects/bochs/files/bochs/2.6.11/\\" target=\\"_blank\\" rel=\\"noopener noreferrer\\">https://sourceforge.net/projects/bochs/files/bochs/2.6.11/</a></p>","autoDesc":true,"bioChainData":{"outlink":[],"backlink":[],"localMap":{"nodes":[{"id":"MdNote_Public/01. DesignAndDevelop/Develop/02. Theory/Computer/02. 计算机指令/01. 汇编基础/03. 汇编调试.md","value":{"title":"03. 汇编调试","path":"MdNote_Public/01. DesignAndDevelop/Develop/02. Theory/Computer/02. 计算机指令/01. 汇编基础/03. 汇编调试.md","outlink":[],"backlink":[]}}],"links":[]}}}');export{o as comp,r as data};

import{_ as t}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as s,o as d,c as r,b as e,e as n,d as a,a as l}from"./app-OHhlwNoJ.js";const c={},v=l('<h1 id="c" tabindex="-1"><a class="header-anchor" href="#c"><span>C++</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="可变参数模板-variadic-templates" tabindex="-1"><a class="header-anchor" href="#可变参数模板-variadic-templates"><span>可变参数模板 Variadic Templates</span></a></h1><p>本篇参考：</p>',4),p={href:"https://www.cnblogs.com/qicosmos/p/4325949.html",target:"_blank",rel:"noopener noreferrer"},m={href:"https://blog.csdn.net/alex1997222/article/details/78639991",target:"_blank",rel:"noopener noreferrer"},u={href:"https://www.cnblogs.com/ProjectDD/p/11796998.html",target:"_blank",rel:"noopener noreferrer"},o=l(`<h2 id="可变参数函数" tabindex="-1"><a class="header-anchor" href="#可变参数函数"><span>可变参数函数</span></a></h2><p>三个点<code>...</code>的写法以前就有，但不是在模板里</p><p>printf 源码</p><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>int __cdecl printf (
	const char *fromat,
	...	// 可以接受任意变量
	)
{

import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,a as t}from"./app-Bh75ISgc.js";const e={},o=t(`<h1 id="控制台输出-打印" tabindex="-1"><a class="header-anchor" href="#控制台输出-打印"><span>控制台输出 (打印)</span></a></h1><h2 id="格式化打印" tabindex="-1"><a class="header-anchor" href="#格式化打印"><span>格式化打印</span></a></h2><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code>fmt<span class="token punctuation">.</span><span class="token function">Println</span><span class="token punctuation">(</span><span class="token string">&quot;普通的带换行打印&quot;</span><span class="token punctuation">)</span>

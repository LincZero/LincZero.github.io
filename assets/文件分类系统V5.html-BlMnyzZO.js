...
`,onclick:`
          ...
          if (flag_do_fold) tr.setAttribute("is_fold", tr_isfold=="true"?"false":"true")
        `},[t("td",{rowspan:"1"},[t("div",{class:"ab-list-table-svg"},[t("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 384 512"},[e("!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc."),t("path",{d:"M320 464c8.8 0 16-7.2 16-16l0-288-80 0c-17.7 0-32-14.3-32-32l0-80L64 48c-8.8 0-16 7.2-16 16l0 384c0 8.8 7.2 16 16 16l256 0zM0 64C0 28.7 28.7 0 64 0L229.5 0c17 0 33.3 6.7 45.3 18.7l90.5 90.5c12 12 18.7 28.3 18.7 45.3L384 448c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 64z"})])]),t("div",{class:"ab-list-table-witharrow markdown-rendered"},[t("div",null,[t("p",null,[l("二层 "),t("strong",null,"Er层"),l("等")])])])])])])])],-1),c=t("h2",{id:"每层结构-新",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#每层结构-新"},[t("span",null,"每层结构 (新)")])],-1),f=t("h3",{id:"零层结构-根结构",tabindex:"-1"},[t("a",{class:"header-anchor",href:"#零层结构-根结构"},[t("span",null,"零层结构 (根结构)")])],-1),_=t("p",null,"根结构",-1),b=t("div",{class:"ab-note drop-shadow"},[t("table",{class:"ab-table ab-list-table ab-table-folder"},[t("tbody",null,[t("tr",{class:"ab-foldable-tr",tr_level:"0",is_fold:"false",able_fold:"true",type:"Local根",onclick:`
          const tr = this
          const l_tr = tr.parentNode.querySelectorAll("tr")
          const i = 0
          const tr_level = Number(tr.getAttribute("tr_level"))
...
`,onclick:`
          ...
          if (flag_do_fold) tr.setAttribute("is_fold", tr_isfold=="true"?"false":"true")
        `},[t("td",{rowspan:"1"},[t("div",{class:"ab-list-table-svg"},[t("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 384 512"},[e("!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc."),t("path",{d:"M320 464c8.8 0 16-7.2 16-16l0-288-80 0c-17.7 0-32-14.3-32-32l0-80L64 48c-8.8 0-16 7.2-16 16l0 384c0 8.8 7.2 16 16 16l256 0zM0 64C0 28.7 28.7 0 64 0L229.5 0c17 0 33.3 6.7 45.3 18.7l90.5 90.5c12 12 18.7 28.3 18.7 45.3L384 448c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 64z"})])]),t("div",{class:"ab-list-table-witharrow markdown-rendered"},[t("div",null,[t("p",null,"Public")])])])])])])],-1),u=r('<p>Local和Removable区别</p><ul><li>Local <ul><li>物理: 性能高, 一般是固态硬盘, 空间有限, 一般在1~2T以内, 适合放有性能需求或未归档的东西</li><li>独有: 根部多了一层: C 系统、SoftLocal、Res 资源、Cache 默认位置, 而Removable的根相当于Res</li><li>Res资源: 需要定时归档</li></ul></li><li>Removable (Library) <ul><li>物理: 一般是几~十几T的机器硬盘, 空间最大, 虽然存在移动的可能但可能性较低</li><li>独有: 这里有的Local都可以有, 但有的东西一般不放Local里, 例如软件安装包</li><li>Res资源: 归档状态</li><li>特殊补充: 比Local少了一层, 出于描述统一我们叫Removable根为第二层而非一层. 如果你有强迫症, 想要空写一层Res当然也可以</li></ul></li><li>Removable (Portable) <ul><li>物理: 便携的移动U盘或硬盘, 性能最低</li><li>独有: SoftPortable, C (PCSystem, 维修用)</li><li>Res资源: 工作空间/归档状态</li></ul></li></ul><h3 id="一层结构" tabindex="-1"><a class="header-anchor" href="#一层结构"><span>一层结构</span></a></h3><p>一层结构</p>',4),v=t("div",{class:"ab-note drop-shadow"},[t("table",{class:"ab-table ab-list-table ab-table-folder"},[t("tbody",null,[t("tr",{class:"ab-foldable-tr",tr_level:"0",is_fold:"false",able_fold:"true",type:"Soft结构 (SoftLocal、SoftPackage、SoftPortable的结构一致)",onclick:`
          const tr = this
          const l_tr = tr.parentNode.querySelectorAll("tr")
          const i = 0
          const tr_level = Number(tr.getAttribute("tr_level"))
...
`,onclick:`
          ...
          if (flag_do_fold) tr.setAttribute("is_fold", tr_isfold=="true"?"false":"true")
        `},[t("td",{rowspan:"1"},[t("div",{class:"ab-list-table-svg"},[t("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 384 512"},[e("!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc."),t("path",{d:"M320 464c8.8 0 16-7.2 16-16l0-288-80 0c-17.7 0-32-14.3-32-32l0-80L64 48c-8.8 0-16 7.2-16 16l0 384c0 8.8 7.2 16 16 16l256 0zM0 64C0 28.7 28.7 0 64 0L229.5 0c17 0 33.3 6.7 45.3 18.7l90.5 90.5c12 12 18.7 28.3 18.7 45.3L384 448c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 64z"})])]),t("div",{class:"ab-list-table-witharrow markdown-rendered"},[t("div",null,[t("p",null,"不是Er层")])])])])])])],-1),w=r('<h3 id="er层结构" tabindex="-1"><a class="header-anchor" href="#er层结构"><span>Er层结构</span></a></h3><h4 id="大er层" tabindex="-1"><a class="header-anchor" href="#大er层"><span>大Er层</span></a></h4><p>结构</p><ul><li>Data Er层 - 数据 Er层</li><li>Abst Er层 - 抽象 Er层</li><li>Enti Er层 - 实物 Er层</li></ul><p>在旧笔记名中</p><ul><li><ol><li>设计开发与数据生产</li></ol></li><li><ol start="2"><li>十二门类与纯粹知识</li></ol></li><li><ol start="3"><li>生活技能与生活生产 (部分冲突)</li></ol></li><li>私人</li></ul><h4 id="data-er层" tabindex="-1"><a class="header-anchor" href="#data-er层"><span>Data Er层</span></a></h4><p>Data Er层</p>',8),g=t("div",{class:"ab-note drop-shadow"},[t("table",{class:"ab-table ab-list-table ab-table-folder"},[t("tbody",null,[t("tr",{class:"ab-foldable-tr",tr_level:"0",is_fold:"false",able_fold:"true",type:"Editor",onclick:`
          const tr = this
          const l_tr = tr.parentNode.querySelectorAll("tr")
          const i = 0
          const tr_level = Number(tr.getAttribute("tr_level"))
...
`,onclick:`
          ...
          if (flag_do_fold) tr.setAttribute("is_fold", tr_isfold=="true"?"false":"true")
        `},[t("td",{rowspan:"1"},[t("div",{class:"ab-list-table-svg"},[t("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 384 512"},[e("!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc."),t("path",{d:"M320 464c8.8 0 16-7.2 16-16l0-288-80 0c-17.7 0-32-14.3-32-32l0-80L64 48c-8.8 0-16 7.2-16 16l0 384c0 8.8 7.2 16 16 16l256 0zM0 64C0 28.7 28.7 0 64 0L229.5 0c17 0 33.3 6.7 45.3 18.7l90.5 90.5c12 12 18.7 28.3 18.7 45.3L384 448c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64L0 64z"})])]),t("div",{class:"ab-list-table-witharrow markdown-rendered"},[t("div",null,[t("p",null,"ZOther？")])])])])])])],-1),p=r('<h3 id="q" tabindex="-1"><a class="header-anchor" href="#q"><span>Q</span></a></h3><h4 id="到底是否应该分开专业知识和生活知识" tabindex="-1"><a class="header-anchor" href="#到底是否应该分开专业知识和生活知识"><span>到底是否应该分开专业知识和生活知识？</span></a></h4><p>有两个情况：</p><ul><li>Editor &amp; Other</li><li>十二门类 &amp; 生活技能</li></ul><p>明确Soft不分开，Soft没必要分开得太死，不过万能查看器怎么办</p><h4 id="soft分公有和私有吗" tabindex="-1"><a class="header-anchor" href="#soft分公有和私有吗"><span>Soft分公有和私有吗</span></a></h4><p>目前没见过私有软件，破解软件应该不算？</p><p>至少Soft_Local没有分享忌讳，应该不分</p><h4 id="图床与git" tabindex="-1"><a class="header-anchor" href="#图床与git"><span>图床与Git</span></a></h4><p>图床可以进一步地提高性能分割度，使纯文本笔记能够快速备份和同步</p><h2 id="v5-0-beta3" tabindex="-1"><a class="header-anchor" href="#v5-0-beta3"><span>V5.0 Beta3</span></a></h2><p><strong>（彻底不让Er嵌套了）</strong></p><h3 id="根" tabindex="-1"><a class="header-anchor" href="#根"><span>根</span></a></h3>',13),h=t("div",{class:"ab-note drop-shadow"},[t("table",{class:"ab-table ab-list-table ab-table-folder"},[t("tbody",null,[t("tr",{class:"ab-foldable-tr",tr_level:"0",is_fold:"false",able_fold:"true",type:"Local",onclick:`
          const tr = this
          const l_tr = tr.parentNode.querySelectorAll("tr")
          const i = 0
          const tr_level = Number(tr.getAttribute("tr_level"))

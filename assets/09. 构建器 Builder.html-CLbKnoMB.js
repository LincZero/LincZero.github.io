...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="分析-写法1" tabindex="-1"><a class="header-anchor" href="#分析-写法1"><span>分析 - 写法1</span></a></h4><p>代码结构</p>`,13),m=l(`<h4 id="举例-写法2-构建器" tabindex="-1"><a class="header-anchor" href="#举例-写法2-构建器"><span>举例 - 写法2（构建器）</span></a></h4><p>抽象基类</p><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>class House{									// 【分离1】抽象基类，对象的表示
    //...
};

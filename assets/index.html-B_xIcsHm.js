...
`},[s("td",{rowspan:"1",onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
          ...
          `},[s("svg",{xmlns:"http://www.w3.org/2000/svg",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round",class:"lucide lucide-fold-vertical-icon lucide-fold-vertical"},[s("path",{d:"M12 22v-6"}),s("path",{d:"M12 8V2"}),s("path",{d:"M4 12H2"}),s("path",{d:"M10 12H8"}),s("path",{d:"M16 12h-2"}),s("path",{d:"M22 12h-2"}),s("path",{d:"m15 19-3-3-3 3"}),s("path",{d:"m15 5-3 3-3-3"})])])])],-1),l(`<h2 id="all-workflows" tabindex="-1"><a class="header-anchor" href="#all-workflows"><span>all_workflows</span></a></h2><h3 id="简单工作流" tabindex="-1"><a class="header-anchor" href="#简单工作流"><span>简单工作流</span></a></h3><p>先来看 Github 为 Rust 项目推荐的工作流：</p><ul><li>Rust | 用Cargo构建并测试一个Rust项目</li></ul><p>默认的workflow非常简单优雅 (似乎是 GitHub 托管的一些运行器已预装了 Rust 工具链，不一定会有)</p><div class="language-yml line-numbers-mode" data-highlighter="shiki" data-ext="yml" data-title="yml" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span style="--shiki-light:#E45649;--shiki-dark:#E06C75;">name</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">: </span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">Rust</span></span>
<span class="line"></span>

import{a as e,c as t,d as n,f as r,m as i,u as a}from"./app-s9ZLnBRD.js";var o=JSON.parse(`{"path":"/MdNote_Public/01.%20DesignAndDevelop/Doc/Note%20Skill/Md%E5%AE%9E%E7%94%A8%E6%A0%87%E7%AD%BE2.html","title":"Md实用标签2","lang":"zh-CN","frontmatter":{"create_date":"2025-10-27T00:00:00.000Z","last_date":"2025-10-27T00:00:00.000Z","author":"LincZero","description":"Md实用标签2 致歉 这里是对之前同系列文章的一个补充 在22年我发布过一篇 《Markdown实用的Html标签》 的文章。而现在看来，尽管我对各个平台的兼容性都做了一些兼容性测试、并绘制了兼容性表格。但当时的我对这方面的见解不够成熟、部分内容不够严谨。在此向之前被误导的读者道歉。 主要是 center、font、big、s 等标签的使用。我当初的 ...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Md实用标签2\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"LincZero\\"}]}"],["meta",{"property":"og:url","content":"https://LincZero.github.io/MdNote_Public/01.%20DesignAndDevelop/Doc/Note%20Skill/Md%E5%AE%9E%E7%94%A8%E6%A0%87%E7%AD%BE2.html"}],["meta",{"property":"og:site_name","content":"Linc 的小站"}],["meta",{"property":"og:title","content":"Md实用标签2"}],["meta",{"property":"og:description","content":"Md实用标签2 致歉 这里是对之前同系列文章的一个补充 在22年我发布过一篇 《Markdown实用的Html标签》 的文章。而现在看来，尽管我对各个平台的兼容性都做了一些兼容性测试、并绘制了兼容性表格。但当时的我对这方面的见解不够成熟、部分内容不够严谨。在此向之前被误导的读者道歉。 主要是 center、font、big、s 等标签的使用。我当初的 ..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"article:author","content":"LincZero"}]]},"git":{},"readingTime":{"minutes":5.91,"words":1772},"filePathRelative":"MdNote_Public/01. DesignAndDevelop/Doc/Note Skill/Md实用标签2.md","excerpt":"\\n<h2>致歉</h2>\\n<p>这里是对之前同系列文章的一个补充</p>\\n<p>在22年我发布过一篇 《Markdown实用的Html标签》 的文章。而现在看来，尽管我对各个平台的兼容性都做了一些兼容性测试、并绘制了兼容性表格。但当时的我对这方面的见解不够成熟、部分内容不够严谨。在此向之前被误导的读者道歉。</p>\\n<p>主要是 center、font、big、s 等标签的使用。我当初的 “是否建议” 使用的的说法存在一些问题。</p>\\n<p></p>\\n<h2>过时标签问题</h2>\\n<p>其实从我当初的兼容性测试，已经可以看到一些端倪。如一些平台不支持center标签。我当时只认为是安全性考虑禁用掉部分标签。</p>","autoDesc":true,"bioChainData":{"outlink":[],"backlink":[],"localMap":{"nodes":[{"id":"MdNote_Public/01. DesignAndDevelop/Doc/Note Skill/Md实用标签2.md","value":{"title":"Md实用标签2","path":"MdNote_Public/01. DesignAndDevelop/Doc/Note Skill/Md实用标签2.md","outlink":[],"backlink":[]}}],"links":[]}}}`),s={name:`Md实用标签2.md`};function c(e,o,s,c,l,u){return i(),a(`div`,null,[...o[0]||=[n(`<h1 id="md实用标签2" tabindex="-1">Md实用标签2</h1><h2 id="致歉" tabindex="-1">致歉</h2><p>这里是对之前同系列文章的一个补充</p><p>在22年我发布过一篇 《Markdown实用的Html标签》 的文章。而现在看来，尽管我对各个平台的兼容性都做了一些兼容性测试、并绘制了兼容性表格。但当时的我对这方面的见解不够成熟、部分内容不够严谨。在此向之前被误导的读者道歉。</p><p>主要是 center、font、big、s 等标签的使用。我当初的 “是否建议” 使用的的说法存在一些问题。</p><p><img src="/assets/9896b250-1ce3-45cf-80e6-de3dc71b857d-I0uro-MK.png" alt="" loading="lazy"></p><h2 id="过时标签问题" tabindex="-1">过时标签问题</h2><p>其实从我当初的兼容性测试，已经可以看到一些端倪。如一些平台不支持center标签。我当时只认为是安全性考虑禁用掉部分标签。</p><p>而真实原因是，在HTML5中，部分标签其实是被废弃掉了。只是一些平台依然向下兼容。<br> 对于这部分标签，我们最好是不要去用的！在某些平台无法被支持。<br> 如我之前测试的中不生效的博客平台，又如vuepress等文本编译系统遇到这些标签会直接报错。</p><p>这里列举一些过时标签和替代标签： (<a href="https://blog.csdn.net/guojunwu1977/article/details/133301827" target="_blank" rel="noopener noreferrer">参考文章</a>)</p>`,10),t(`div`,{class:`ab-note drop-shadow`},[t(`div`,{class:`ab-list-table-parent ab-listtable-likelist`},[t(`table`,{class:`ab-table ab-list-table`},[t(`tbody`,null,[t(`tr`,{class:`ab-foldable-tr`,tr_level:`0`,is_fold:`false`,able_fold:`false`,type:"`<applet>` "},[t(`td`,{rowspan:`1`,onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
          ...
          `},[t(`div`,{class:`ab-list-table-witharrow markdown-rendered`},[t(`div`,null,[t(`p`,null,[t(`code`,null,`<marquee>`)])])])]),t(`td`,{rowspan:`1`},[t(`div`,{class:`ab-list-table-witharrow markdown-rendered`},[t(`div`,null,[t(`p`,null,`用于创建滚动的内容，已被CSS的animation属性或JavaScript替代。`)])])])]),t(`tr`,{class:`ab-foldable-tr`,tr_level:`0`,is_fold:`false`,able_fold:`false`,type:"`<menu>` "},[t(`td`,{rowspan:`1`,onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
            ...
            if (flag_do_fold) tr.setAttribute("is_fold", tr_isfold=="true"?"false":"true")
          `},[t(`div`,{class:`ab-list-table-witharrow markdown-rendered`},[t(`div`,null,[t(`p`,null,[t(`code`,null,`<menu>`)])])])]),t(`td`,{rowspan:`1`},[t(`div`,{class:`ab-list-table-witharrow markdown-rendered`},[t(`div`,null,[t(`p`,null,[r(`用于指定菜单列表，已被 `),t(`code`,null,`<ul>`),r(` 标签替代。`)])])])])]),t(`tr`,{class:`ab-foldable-tr`,tr_level:`0`,is_fold:`false`,able_fold:`false`,type:"`<plaintext>` "},[t(`td`,{rowspan:`1`,onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
            const l_tr = tr.parentNode.querySelectorAll("tr")
            const i = 13
          ...
          `},[t(`div`,{class:`ab-list-table-witharrow markdown-rendered`},[t(`div`,null,[t(`p`,null,[t(`code`,null,`<plaintext>`)])])])]),t(`td`,{rowspan:`1`},[t(`div`,{class:`ab-list-table-witharrow markdown-rendered`},[t(`div`,null,[t(`p`,null,[r(`用于指定明文，已被 `),t(`code`,null,`<pre>`),r(` 标签替代。`)])])])])]),t(`tr`,{class:`ab-foldable-tr`,tr_level:`0`,is_fold:`false`,able_fold:`false`,type:"`<s>` "},[t(`td`,{rowspan:`1`,onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
            ...
            if (flag_do_fold) tr.setAttribute("is_fold", tr_isfold=="true"?"false":"true")
          `},[t(`div`,{class:`ab-list-table-witharrow markdown-rendered`},[t(`div`,null,[t(`p`,null,[t(`code`,null,`<s>`)])])])]),t(`td`,{rowspan:`1`},[t(`div`,{class:`ab-list-table-witharrow markdown-rendered`},[t(`div`,null,[t(`p`,null,[r(`用于指定删除线文本，已被CSS的text-decoration: line-through;属性或HTML5的 `),t(`code`,null,`<del>`),r(` 标签替代。`)])])])])]),t(`tr`,{class:`ab-foldable-tr`,tr_level:`0`,is_fold:`false`,able_fold:`false`,type:"`<strike>` "},[t(`td`,{rowspan:`1`,onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
            const l_tr = tr.parentNode.querySelectorAll("tr")
            const i = 15
          ...
          `},[t(`div`,{class:`ab-list-table-witharrow markdown-rendered`},[t(`div`,null,[t(`p`,null,[t(`code`,null,`<strike>`)])])])]),t(`td`,{rowspan:`1`},[t(`div`,{class:`ab-list-table-witharrow markdown-rendered`},[t(`div`,null,[t(`p`,null,[r(`用于指定删除线文本，已被CSS的text-decoration: line-through;属性或HTML5的 `),t(`code`,null,`<del>`),r(` 标签替代。`)])])])])]),t(`tr`,{class:`ab-foldable-tr`,tr_level:`0`,is_fold:`false`,able_fold:`false`,type:"`<u>` "},[t(`td`,{rowspan:`1`,onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
            ...
            if (flag_do_fold) tr.setAttribute("is_fold", tr_isfold=="true"?"false":"true")
          `},[t(`div`,{class:`ab-list-table-witharrow markdown-rendered`},[t(`div`,null,[t(`p`,null,[t(`code`,null,`<u>`)])])])]),t(`td`,{rowspan:`1`},[t(`div`,{class:`ab-list-table-witharrow markdown-rendered`},[t(`div`,null,[t(`p`,null,[r(`用于指定带下划线的文本，已被CSS的text-decoration: underline;属性或HTML5的`),t(`code`,null,`<ins>`),r(` 标签替代。`)])])])])]),t(`tr`,{class:`ab-foldable-tr`,tr_level:`0`,is_fold:`false`,able_fold:`false`,type:"`<xmp>` "},[t(`td`,{rowspan:`1`,onclick:`            const tr = (this.tagName == "TD") ? this.parentNode : this
            const l_tr = tr.parentNode.querySelectorAll("tr")
            const i = 17
            ...
            if (flag_do_fold) tr.setAttribute("is_fold", tr_isfold=="true"?"false":"true")
          `},[t(`div`,{class:`ab-list-table-witharrow markdown-rendered`},[t(`div`,null,[t(`p`,null,[t(`code`,null,`<xmp>`)])])])]),t(`td`,{rowspan:`1`},[t(`div`,{class:`ab-list-table-witharrow markdown-rendered`},[t(`div`,null,[t(`p`,null,[r(`用于指定预格式化的文本，已被 `),t(`code`,null,`<pre>`),r(`标签替代。`)])])])])])])]),t(`button`,{class:`ab-table-fold`,is_fold:`false`,onclick:`          const btn = this;

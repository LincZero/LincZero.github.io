import{_ as c,c as o,e,a as s,d as a,b as p,o as i,r as l}from"./app-C-bjNnVy.js";const u={},d={href:"https://juejin.cn/post/6844903749429919758#heading-1",target:"_blank",rel:"noopener noreferrer"},r={href:"https://blog.csdn.net/qq_39706777/article/details/121975197",target:"_blank",rel:"noopener noreferrer"};function k(v,n){const t=l("ExternalLinkIcon");return i(),o("div",null,[n[4]||(n[4]=e('<h1 id="debounced防抖" tabindex="-1"><a class="header-anchor" href="#debounced防抖"><span>Debounced防抖</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="debounced防抖-1" tabindex="-1"><a class="header-anchor" href="#debounced防抖-1"><span>Debounced防抖</span></a></h1><p>参考：</p>',4)),s("ul",null,[s("li",null,[s("a",d,[n[0]||(n[0]=a("【稀土掘金】javascript函数防抖Debounce")),p(t)]),n[1]||(n[1]=a("（这篇文章很不错，还有很多额外的东西）"))]),s("li",null,[s("a",r,[n[2]||(n[2]=a("【CSDN】JavaScript 防抖、节流：限制事件回调函数的调用次数")),p(t)]),n[3]||(n[3]=a("（这个简易版，不能处理有返回值的情况）"))])]),n[5]||(n[5]=e(`<h2 id="简易版-不能处理有返回值的情况" tabindex="-1"><a class="header-anchor" href="#简易版-不能处理有返回值的情况"><span>简易版（不能处理有返回值的情况）</span></a></h2><div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre class="language-javascript"><code><span class="token keyword">function</span> <span class="token function">debounce</span><span class="token punctuation">(</span><span class="token parameter">fn<span class="token punctuation">,</span>delay</span><span class="token punctuation">)</span><span class="token punctuation">{</span>

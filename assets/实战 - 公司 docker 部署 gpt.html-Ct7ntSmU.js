import{_ as s,c as a,e,o as t}from"./app-EY9a-RQV.js";const o={};function p(c,n){return t(),a("div",null,n[0]||(n[0]=[e(`<h3 id="部署gpt" tabindex="-1"><a class="header-anchor" href="#部署gpt"><span>部署gpt</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 检查</span>

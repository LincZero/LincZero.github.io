...
<span class="line"><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;">pub</span><span style="--shiki-light:#A626A4;--shiki-dark:#C678DD;"> fn</span><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;"> test_fn</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">() {</span></span>
<span class="line"><span style="--shiki-light:#4078F2;--shiki-dark:#61AFEF;">    println!</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">(</span><span style="--shiki-light:#50A14F;--shiki-dark:#98C379;">&quot;This is a test function.&quot;</span><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">);</span></span>
<span class="line"><span style="--shiki-light:#383A42;--shiki-dark:#ABB2BF;">}</span></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="对比" tabindex="-1">对比</h3><ul><li>转换：把 <code>&lt;folderName&gt;/mod.rs</code> 重命名为 <code>&lt;folderName&gt;.rs</code> 即可将方式一转换为方式二</li><li>共同点：都符合后面的规则</li></ul><p>注意：一个文件必属于一个名为 <code>&lt;fileName&gt;</code> 的模块</p><p>模块声明后想要使用，必须具备以下条件：</p><ol><li>存在模块入口。 <ul><li>有文件夹：<code>&lt;folderName&gt;/mod.rs</code> 或 <code>&lt;folderName&gt;.rs</code>，且在里面 <code>pub mod xx</code> 暴露出模块</li><li>无文件夹：<code>&lt;fileName&gt;.rs</code></li></ul></li><li>存在声明引入。在要使用的地方 <code>mod &lt;folderName&gt;;</code></li></ol>`,6)])])}const k=e(r,[["render",h]]),o=JSON.parse('{"path":"/MdNote_Public/01.%20DesignAndDevelop/Develop/01.%20Language/Rust/%E5%AD%A6%E4%B9%A0/07.%20%E6%A8%A1%E5%9D%97%E5%BA%93/03.%20%E6%A8%A1%E5%9D%97%20Module.html","title":"模块 Module","lang":"zh-CN","frontmatter":{"description":"模块 Module 在本章节，我们将深入讲讲 Rust 的代码构成单元：模块。 作用：使用模块可以将包中的代码按照功能性进行重组，最终实现更好的可读性及易用性。同时，我们还能非常灵活地去控制代码的可见性，进一步强化 Rust 的安全性。 模块的嵌套 创建嵌套模块 小旅馆，sorry，是小餐馆，相信大家都挺熟悉的，学校外的估计也没少去，那么咱就用小餐馆为...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"模块 Module\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"],["meta",{"property":"og:url","content":"https://LincZero.github.io/MdNote_Public/01.%20DesignAndDevelop/Develop/01.%20Language/Rust/%E5%AD%A6%E4%B9%A0/07.%20%E6%A8%A1%E5%9D%97%E5%BA%93/03.%20%E6%A8%A1%E5%9D%97%20Module.html"}],["meta",{"property":"og:site_name","content":"Linc 的小站"}],["meta",{"property":"og:title","content":"模块 Module"}],["meta",{"property":"og:description","content":"模块 Module 在本章节，我们将深入讲讲 Rust 的代码构成单元：模块。 作用：使用模块可以将包中的代码按照功能性进行重组，最终实现更好的可读性及易用性。同时，我们还能非常灵活地去控制代码的可见性，进一步强化 Rust 的安全性。 模块的嵌套 创建嵌套模块 小旅馆，sorry，是小餐馆，相信大家都挺熟悉的，学校外的估计也没少去，那么咱就用小餐馆为..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}]]},"git":{},"readingTime":{"minutes":24.95,"words":7486},"filePathRelative":"MdNote_Public/01. DesignAndDevelop/Develop/01. Language/Rust/学习/07. 模块库/03. 模块 Module.md","excerpt":"\\n<p>在本章节，我们将深入讲讲 Rust 的代码构成单元：模块。</p>\\n<p>作用：使用模块可以将包中的代码按照功能性进行重组，最终实现更好的可读性及易用性。同时，我们还能非常灵活地去控制代码的可见性，进一步强化 Rust 的安全性。</p>\\n<h2>模块的嵌套</h2>\\n<h3>创建嵌套模块</h3>\\n<p>小旅馆，sorry，是小餐馆，相信大家都挺熟悉的，学校外的估计也没少去，那么咱就用小餐馆为例，来看看 Rust 的模块该如何使用。</p>\\n<p>使用 <code>cargo new --lib restaurant</code> 创建一个小餐馆，注意，这里创建的是一个库类型的 <code>Package</code>，然后将以下代码放入 <code>src/lib.rs</code> 中：</p>","autoDesc":true,"bioChainData":{"outlink":[],"backlink":[],"localMap":{"nodes":[{"id":"MdNote_Public/01. DesignAndDevelop/Develop/01. Language/Rust/学习/07. 模块库/03. 模块 Module.md","value":{"title":"03. 模块 Module","path":"MdNote_Public/01. DesignAndDevelop/Develop/01. Language/Rust/学习/07. 模块库/03. 模块 Module.md","outlink":[],"backlink":[]}}],"links":[]}}}');export{k as comp,o as data};

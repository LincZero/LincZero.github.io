...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="简单嵌套-qquickwidget" tabindex="-1"><a class="header-anchor" href="#简单嵌套-qquickwidget"><span>简单嵌套（ QQuickWidget）</span></a></h3>`,26)),e("p",null,[n[1]||(n[1]=s("参考：")),e("a",o,[n[0]||(n[0]=s("【简书】QWidget 和 QML窗口 相互嵌套")),i(a)])]),n[9]||(n[9]=t(`<p>QWidget界面和QML窗口相互嵌套都是需要借助 quickwidgets 这个模块中的类 这里使用的是QQuickWidget，这个类是继承QWidget的，就和 QWidget 一样使用就行</p><p>.cpp</p><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>#include &lt;QApplication&gt;
...
Rectangle <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="qwidget-嵌套-qml-并交互" tabindex="-1"><a class="header-anchor" href="#qwidget-嵌套-qml-并交互"><span>QWidget 嵌套 QML 并交互</span></a></h3><p>参考：</p>`,8)),e("ul",null,[e("li",null,[e("a",u,[n[2]||(n[2]=s("【CSDN】qwidget嵌入qml界面")),i(a)]),n[3]||(n[3]=s(" 原创"))]),e("li",null,[e("a",v,[n[4]||(n[4]=s("【CSDN】QWidget调用QML界面，并交互(上)")),i(a)]),n[5]||(n[5]=s(" 原创"))]),e("li",null,[e("a",m,[n[6]||(n[6]=s("【CSDN】qt 中 qwidget 嵌入 qml")),i(a)]),n[7]||(n[7]=s(" 原创"))])]),n[10]||(n[10]=t(`<p>原理</p><ol><li><p>使用QQuickView 类提供一个用于显示 Qt Quick 用户界面的窗口。</p></li><li><p>使用QWidget::createWindowContainer()函数，将QtQuick组件嵌入到QWidget中，该函数直接返回qwidget指针。</p></li><li><p>如果不需要交互就到此为止了。步骤 3 进行交互</p><p>使用QQmlContext 类定义 QML 引擎中的上下文。通过该类可实现C++和qml属性数据的交互，比如读取qml控件中的公开属性（成员变量）。</p></li></ol><p>实现</p><ol><li>通过 QQuickView 类添加qml控件代码文件：</li></ol><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>QQuickView *mQuickView = new QQuickView();

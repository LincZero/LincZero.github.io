import{_ as k,c as r,a as i,d as t,b as B,w as n,r as h,o as p,e as s}from"./app-CjGre04A.js";const A={};function c(u,l){const o=h("VueFlow"),d=h("Tabs");return p(),r("div",null,[l[6]||(l[6]=i("h1",{id:"nodeflow-列表语法",tabindex:"-1"},"NodeFlow 列表语法",-1)),l[7]||(l[7]=i("h2",{id:"介绍-一种基于markdown列表的便于输入的节点描述语法",tabindex:"-1"},"介绍，一种基于Markdown列表的便于输入的节点描述语法",-1)),l[8]||(l[8]=i("p",null,"新增一种能手写的格式，说真的有时设计语法比开发成就感还强……大家讨论讨论语法，看有没有什么可以优化的地方",-1)),l[9]||(l[9]=i("ol",null,[i("li",null,"该语法可以和AnyBlock插件配合，从列表进行声明"),i("li",null,"参考了：JSON、JSONL、YAML、Mermaid/Mehrmaid 流程图语法")],-1)),l[10]||(l[10]=i("h2",{id:"示例",tabindex:"-1"},"示例",-1)),l[11]||(l[11]=i("h3",{id:"语法示例",tabindex:"-1"},"语法示例",-1)),t(d,{id:"27",data:[{id:"Plugin effect (插件效果)"},{id:"md source code (md源码)"}]},{title0:n(({value:e,isActive:a})=>l[0]||(l[0]=[s("Plugin effect (插件效果)")])),title1:n(({value:e,isActive:a})=>l[1]||(l[1]=[s("md source code (md源码)")])),tab0:n(({value:e,isActive:a})=>[t(o,{type:"nodeflow-list",data:`- nodes
  - NodeTitle
    - only name, i
    - i2, i, *i2
    - i3, i, mul line
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#ABB2BF"}},"```")])])]),i("div",{class:"line-numbers","aria-hidden":"true",style:{"counter-reset":"line-number 0"}},[i("div",{class:"line-number"})])],-1)])),_:1}),l[12]||(l[12]=i("h3",{id:"实际用例",tabindex:"-1"},"实际用例",-1)),t(d,{id:"38",data:[{id:"Plugin effect (插件效果)"},{id:"md source code (md源码)"}]},{title0:n(({value:e,isActive:a})=>l[3]||(l[3]=[s("Plugin effect (插件效果)")])),title1:n(({value:e,isActive:a})=>l[4]||(l[4]=[s("md source code (md源码)")])),tab0:n(({value:e,isActive:a})=>[t(o,{type:"nodeflow-list",data:`- nodes
  - node1:KSample
    - Latent, o
    - model, i
    - positive, i
...
`),i("span",{class:"line"},[i("span",{style:{"--shiki-light":"#383A42","--shiki-dark":"#ABB2BF"}},"```")])])]),i("div",{class:"line-numbers","aria-hidden":"true",style:{"counter-reset":"line-number 0"}},[i("div",{class:"line-number"})])],-1)])),_:1}),l[13]||(l[13]=i("h3",{id:"超简化",tabindex:"-1"},"超简化",-1)),t(o,{type:"nodeflow-list",data:`
- nodes
  - GroupA
    - a1
    - a2

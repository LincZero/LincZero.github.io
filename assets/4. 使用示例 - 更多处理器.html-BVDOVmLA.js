...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></div></div></div><h4 id="其他标题" tabindex="-1"><a class="header-anchor" href="#其他标题"><span>其他标题</span></a></h4><div class="ab-note drop-shadow"><div class="markdown-rendered"><div><p>引用块1 引用块2</p></div></div></div><div class="ab-note drop-shadow"><div class="markdown-rendered"><div><ul><li>1 <ul><li>2 <ul><li>3</li></ul></li><li>2</li></ul></li></ul></div></div></div><h2 id="折叠" tabindex="-1"><a class="header-anchor" href="#折叠"><span>折叠</span></a></h2><p>这个是我在写 anyblock 之前，使用dataviewjs强行模拟 list2table 效果的代码，内容比较长所以拿过来演示 [fold]</p><div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre class="language-javascript"><code><span class="token keyword">const</span> keyword <span class="token operator">=</span> <span class="token string">&quot;%&quot;</span><span class="token operator">+</span><span class="token string">&quot;toTable&quot;</span> <span class="token comment">// 不能合并</span>

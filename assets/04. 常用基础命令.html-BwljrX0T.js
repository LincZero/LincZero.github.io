import{_ as n,c as i,a as l,o as a}from"./app-G9P12kHM.js";const s={};function d(t,e){return a(),i("div",null,e[0]||(e[0]=[l(`<h1 id="mysql" tabindex="-1"><a class="header-anchor" href="#mysql"><span>MySQL</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h2 id="数据库层级命令" tabindex="-1"><a class="header-anchor" href="#数据库层级命令"><span>数据库层级命令</span></a></h2><div class="language-mysql line-numbers-mode" data-ext="mysql" data-title="mysql"><pre class="language-mysql"><code>SHOW DATABASES;                          -- 显示所有数据库

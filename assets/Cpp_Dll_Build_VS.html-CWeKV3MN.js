import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as i,c as n,a as l}from"./app-Dtl9Pch1.js";const d={},s=l(`<h1 id="dll-compiled-by-all-language" tabindex="-1"><a class="header-anchor" href="#dll-compiled-by-all-language"><span>DLL Compiled By All Language</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="vs-cpp-dll-build" tabindex="-1"><a class="header-anchor" href="#vs-cpp-dll-build"><span>VS_Cpp_Dll_Build</span></a></h1><p>VS &gt; 创建新项目 &gt; 动态链接库</p><h2 id="工程模板" tabindex="-1"><a class="header-anchor" href="#工程模板"><span>工程模板</span></a></h2><p>工程结构</p><blockquote><p>Dll1</p><ul><li>头文件 <ul><li>framework.h</li><li>pch.h</li></ul></li><li>源文件 <ul><li>dllmain.cpp 【不同】</li><li>pch.cpp</li></ul></li></ul></blockquote><p>framework.h</p><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>#pragma once

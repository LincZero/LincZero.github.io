import{_ as n,e as a,g as e,o as i}from"./app-DBoTYUT8.js";const l={};function p(d,s){return i(),a("div",null,s[0]||(s[0]=[e(`<h1 id="mysql" tabindex="-1"><a class="header-anchor" href="#mysql"><span>MySQL</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="sql命令" tabindex="-1"><a class="header-anchor" href="#sql命令"><span>SQL命令</span></a></h1><h2 id="use-使用数据库" tabindex="-1"><a class="header-anchor" href="#use-使用数据库"><span>USE（使用数据库）</span></a></h2><div class="language-mysql line-numbers-mode" data-highlighter="shiki" data-ext="mysql" data-title="mysql" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>-- SQL不分大小写，一般&#39;命令&#39;大写其他小写</span></span>

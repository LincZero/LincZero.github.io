import{_ as t,c as d,e as i,b as n,o as s,r as a}from"./app-EY9a-RQV.js";const r={};function c(v,e){const l=a("Mermaid");return s(),d("div",null,[e[0]||(e[0]=i('<h1 id="模板模式-template-method" tabindex="-1"><a class="header-anchor" href="#模板模式-template-method"><span>模板模式 Template Method</span></a></h1><p>极简一句话：我定义好一个有多项工作的流程，交给你定义这些工作的内容</p><p>全程 <code>模板方法模式</code>，有时简称 <code>模板方法</code>，有时简称 <code>模板模式</code></p><h2 id="所属分类——-组件协作-模式" tabindex="-1"><a class="header-anchor" href="#所属分类——-组件协作-模式"><span>所属分类——“组件协作” 模式</span></a></h2><ul><li><p>“组件协作” 模式</p><ul><li><p>现代软件专业分工之后的第一个结果是 “框架与应用程序的划分”</p><p>“组件协作” 模式通过<code>晚期绑定</code>，来实现框架与应用程序之间的松耦合，是二者之间协作时常用的模式</p></li><li><p>其实应该是指的是程序库和运行代码之间的协作时的松耦合吧</p></li></ul></li><li><p>典型模式</p><ul><li>模板方法 Template Method</li><li>策略模式 Strategy</li><li>观察模式 Observer（也叫事件模式 Event）</li></ul></li></ul><h2 id="动机-motivation" tabindex="-1"><a class="header-anchor" href="#动机-motivation"><span>动机（Motivation）</span></a></h2><h3 id="简概" tabindex="-1"><a class="header-anchor" href="#简概"><span>简概</span></a></h3><ul><li>在软件构建过程中，对于某一项任务，它常常有<strong>稳定</strong>的整体操作结构，但各个子步骤却有很多<strong>改变</strong>的需求，或者由于固有的原因（比如框架与应用之间的关系）而无法和任务的整体结构同时实现</li><li>如何在确定稳定操作结构的前提下，来灵活应对各个子步骤的变化或者晚期实现需求？</li></ul><h3 id="核心-提供模板、早绑定变晚绑定" tabindex="-1"><a class="header-anchor" href="#核心-提供模板、早绑定变晚绑定"><span>核心：提供模板、早绑定变晚绑定</span></a></h3><p>比较早绑定变晚绑定</p><ul><li>区别 <ul><li>早绑定：一个晚的东西绑定一个早的东西，即 “晚绑定早”，传统主流写法</li><li>晚绑定：一个早的东西绑定一个晚的东西，面向对象的写法、<strong>Template Method的面向对象设计模式</strong></li></ul></li></ul>',11)),n(l,{id:"mermaid-99",code:"eJxLL0osyFAIceJyinYsKMjJTE4syczPi9XVfdo289nmqU92NMQ/m77y+e6JT9fN0tW1c4z2yUwqSiyqjOVyhjPhinf1xD+bOQuu2AXFSC4ATb8xrg=="}),e[1]||(e[1]=i(`<ul><li>比较 <ul><li>这里是假设 “程序主流程”，是属于相对稳定的东西，是一个Template Method</li><li>那么在这个例子中，晚绑定能把变化的东西抽离出来，减少运行代码中需要写的东西</li></ul></li><li>形象比喻 <ul><li>早绑定：我打印了一份表格（早对象），里面大多数空格已经自动填好了，让对方将剩下的内容（晚对象）给填上即可</li><li>晚绑定：我告诉你你需要提交一个表格，大多数内容告诉你了，让对方将自己要自定义的东西给补充进去再顺便把表格给打出来</li></ul></li></ul><h3 id="代码体现" tabindex="-1"><a class="header-anchor" href="#代码体现"><span>代码体现</span></a></h3><p>按一定流程分别实现多个函数，这些函数有的是库类提供的，有的是应用程序开发人员提供的</p><h4 id="举例-写法1" tabindex="-1"><a class="header-anchor" href="#举例-写法1"><span>举例 - 写法1</span></a></h4><p>程序库代码</p><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>// 程序库开发人员
class Library{
public:
	void step1(){
		// ...

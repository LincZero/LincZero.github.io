import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as e,c as a,a as s}from"./app-D9ahr8AM.js";const i={},t=s(`<h1 id="linux命令-网络配置" tabindex="-1"><a class="header-anchor" href="#linux命令-网络配置"><span>Linux命令_网络配置</span></a></h1><p>Linux网络配置方法简介</p><h2 id="配置ip地址-ip-ifconfig" tabindex="-1"><a class="header-anchor" href="#配置ip地址-ip-ifconfig"><span>配置IP地址 (ip/ifconfig)</span></a></h2><h3 id="命令行方式-重启丢失" tabindex="-1"><a class="header-anchor" href="#命令行方式-重启丢失"><span>命令行方式（重启丢失）</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 使用ifconfig (interface config)</span>

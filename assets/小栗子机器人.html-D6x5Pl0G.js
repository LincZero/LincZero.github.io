import{_ as i}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as n,c as e,e as d}from"./app-CoO7IlkE.js";const l={},s=d(`<p>很久之前就被封了，没法用，但API文档和SDK还留着，可以作为参考</p><p>接口：可以查看小栗子API助手</p><ul><li>本地文件/小栗子框架 <ul><li>其他 <ul><li>API助手2.0</li><li>易语言API伴侣</li></ul></li><li>CornerstoneSDK-1.0.2 (C)</li><li>SDK_2.8.8.0</li><li>httpapi_new</li></ul></li></ul><p>其中，HTTP API 文档：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>1.2.2.4

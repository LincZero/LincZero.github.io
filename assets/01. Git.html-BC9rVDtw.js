import{_ as c}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as l,o,c as d,a as n,b as s,d as e,e as a}from"./app-CxgS3Mrc.js";const r={},p=a('<h1 id="git" tabindex="-1"><a class="header-anchor" href="#git"><span>Git</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="git-1" tabindex="-1"><a class="header-anchor" href="#git-1"><span>Git</span></a></h1><p>参考：</p>',4),u=n("strong",null,"主要参考（比较全）",-1),m={href:"https://www.cnblogs.com/LEPENGYANG/p/15915736.html",target:"_blank",rel:"noopener noreferrer"},v={href:"https://www.bilibili.com/video/BV15K4y1H7SV",target:"_blank",rel:"noopener noreferrer"},b=n("li",null,"《GitHub入门与实践》",-1),h=n("li",null,"git有中文的官方手册可见",-1),g={href:"https://www.bbsmax.com/A/D854jlZVzE/",target:"_blank",rel:"noopener noreferrer"},k=n("h2",{id:"入门",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#入门"},[n("span",null,"入门")])],-1),f=n("p",null,"版本管理 VCS（Version Control Systems）",-1),E=a("<li><p>原始的版本管理</p><ul><li>拷贝一份继续写，重复这个过程</li><li>缺点：电脑里多个版本的代码</li></ul></li><li><p>本地代码管理工具 RCS（Revision Control System）</p><ul><li>RCS是记录每一次更新的差异，而不是记录每次更新的完整版本</li><li>缺点：使用与个人管理代码，但难以在团队协作上</li></ul></li><li><p>CVCS</p><ul><li>中央版本控制服务器 CVCS（Centralized Version Control Systems），上面有个版本数据库 首先由某人新建项目并上传初始代码，员工可将代码拷贝下来再传回去</li><li>缺点：团队同时编辑同一份文件时会比较麻烦 如果大家划分不同模块那相安无事。但往往产品的模块划分通常不太好，藕合严重。又或者有核心代码，几乎所有功能都与之有关，出问题都要去修它。 团队协作时，经常会同时编辑同一份文件</li></ul></li>",3),_=n("p",null,"Git",-1),w=n("li",null,[n("p",null,"Bitkeeper不再免费使用，Linus一怒之下撸了个git 目前被广泛采用，并催生了如github、gitee等代码管理的在线仓库，让开源变得简单 是个分布式代码版本管理工具")],-1),x=n("li",null,[n("p",null,"分布式"),n("ul",null,[n("li",null,"SVN是集中化管理，有中央版本控制服务器 CVCS（Centralized Version Control Systems），如果服务器出了问题那么谁也提交不了代码"),n("li",null,[n("strong",null,"git可以在本地化开发，不影响开发")])])],-1),y=n("li",null,[n("p",null,"版本管理")],-1),A=n("p",null,"git工作流程",-1),C=a('<h2 id="一些原理-实现原理与思想原理" tabindex="-1"><a class="header-anchor" href="#一些原理-实现原理与思想原理"><span>一些原理（实现原理与思想原理）</span></a></h2><h3 id="本地仓库原理" tabindex="-1"><a class="header-anchor" href="#本地仓库原理"><span>本地仓库原理</span></a></h3><p>分为本地仓库和最终push的远程仓库</p><p>所以说就算离线也是可以使用git工具的</p><ul><li>commit后，就会将工作的项目传到本地仓库</li><li>push后，则会将本地仓库同步给远程仓库</li></ul><h3 id="版本管理原理" tabindex="-1"><a class="header-anchor" href="#版本管理原理"><span>版本管理原理</span></a></h3><p>【注：pull=fetch+merge】</p><h3 id="多人协同开发原理" tabindex="-1"><a class="header-anchor" href="#多人协同开发原理"><span>多人协同开发原理</span></a></h3><h3 id="一些颜色" tabindex="-1"><a class="header-anchor" href="#一些颜色"><span>一些颜色</span></a></h3><ul><li>绿色</li><li>黄色</li><li>红色</li><li>A</li><li>U</li><li>D</li></ul><h2 id="git命令" tabindex="-1"><a class="header-anchor" href="#git命令"><span>Git命令</span></a></h2><p>下载：https://git-scm.com/download/win</p><p>该软件包括命令行git已经图形化界面的git客户端</p><h3 id="使用流程" tabindex="-1"><a class="header-anchor" href="#使用流程"><span>使用流程</span></a></h3><h4 id="提交到远程" tabindex="-1"><a class="header-anchor" href="#提交到远程"><span>提交到远程</span></a></h4><p>git工作流程：</p>',16),G=a(`<p>代码更新（简单记下来就是add commit push）</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">git</span> <span class="token function">add</span> <span class="token builtin class-name">.</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="解决冲突" tabindex="-1"><a class="header-anchor" href="#解决冲突"><span>解决冲突</span></a></h3>`,10),V={href:"https://www.cnblogs.com/LEPENGYANG/p/15915736.html",target:"_blank",rel:"noopener noreferrer"},S=a(`<div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 1.查看远程分支</span>

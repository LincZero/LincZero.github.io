import{_ as r,c as u,e as s,a as n,d as e,b as l,o as v,r as d}from"./app-C-bjNnVy.js";const o={},c={href:"https://doc.qt.io/qt-5/plugins-howto.html",target:"_blank",rel:"noopener noreferrer"},m={href:"https://blog.51cto.com/u_9291927/2107320#h11",target:"_blank",rel:"noopener noreferrer"},p={href:"https://bbs.csdn.net/topics/390843246?page=1",target:"_blank",rel:"noopener noreferrer"},b={href:"https://doc.qt.io/qt-6/qtdesigner-customwidgetplugin-example.html",target:"_blank",rel:"noopener noreferrer"},g={href:"https://doc.qt.io/qt-6/qtwidgets-widgets-analogclock-example.html",target:"_blank",rel:"noopener noreferrer"},h={href:"https://doc.qt.io/qt-6/qtdesigner-worldtimeclockplugin-example.html",target:"_blank",rel:"noopener noreferrer"},Q={href:"https://doc.qt.io/qt-6/qtwidgets-tools-echoplugin-example.html",target:"_blank",rel:"noopener noreferrer"},k={href:"https://doc.qt.io/qt-6/qtwidgets-tools-styleplugin-example.html",target:"_blank",rel:"noopener noreferrer"},q={href:"https://doc.qt.io/qt-6/plugins-howto.html",target:"_blank",rel:"noopener noreferrer"},P={href:"https://doc.qt.io/qt-6/qtplugin.html",target:"_blank",rel:"noopener noreferrer"},C={href:"http://c.biancheng.net/view/3871.html",target:"_blank",rel:"noopener noreferrer"},T={href:"https://blog.csdn.net/u011370855/article/details/82924752",target:"_blank",rel:"noopener noreferrer"},E={href:"https://doc.qt.io/qt-5/plugins-howto.html",target:"_blank",rel:"noopener noreferrer"},f={href:"https://itzhai.cn/xuexijiaocheng/1115.html",target:"_blank",rel:"noopener noreferrer"},x={href:"http://xn--Linuxxxx-775t.so",target:"_blank",rel:"noopener noreferrer"},y={href:"https://blog.csdn.net/Mr_robot_strange/article/details/108469284",target:"_blank",rel:"noopener noreferrer"},I={href:"https://blog.csdn.net/lv75543255/article/details/8797574",target:"_blank",rel:"noopener noreferrer"},S={href:"http://www.qtcn.org/bbs/read-htm-tid-90117.html",target:"_blank",rel:"noopener noreferrer"},L={href:"https://github.com/feiyangqingyun/qucsdk",target:"_blank",rel:"noopener noreferrer"},D={href:"https://gitee.com/feiyangqingyun/QUCSDK",target:"_blank",rel:"noopener noreferrer"};function w(A,i){const t=d("ExternalLinkIcon"),a=d("Mermaid");return v(),u("div",null,[i[65]||(i[65]=s('<h1 id="qt" tabindex="-1"><a class="header-anchor" href="#qt"><span>Qt</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="dll-so-插件文件-创建插件" tabindex="-1"><a class="header-anchor" href="#dll-so-插件文件-创建插件"><span>.dll.so 插件文件 &amp; 创建插件</span></a></h1><p>注：插件的笔记之前因为系统崩溃而坏掉了（5k多字啊，大大的惨），所以我不得不重新写了一遍，所以内容可能会有点缺失</p><p>可另参考另一篇笔记：<strong>Dev &gt; Tools &gt; 辅助文件 &gt; 动态库和静态库</strong></p><p>参考</p>',6)),n("ul",null,[n("li",null,[n("a",c,[i[0]||(i[0]=e("【Qt官网】How to Create Qt Plugins")),l(t)])]),n("li",null,[n("a",m,[i[1]||(i[1]=e("【51CTO博客】Qt高级——Qt插件开发")),l(t)]),i[2]||(i[2]=e("，介绍了多种不同种类的插件"))]),i[3]||(i[3]=n("li",null,[e("https://blog.csdn.net/Mr_robot_strange/article/details/108469284，"),n("strong",null,"自定义到设计师界面")],-1))]),i[66]||(i[66]=s(`<h2 id="各种插件" tabindex="-1"><a class="header-anchor" href="#各种插件"><span>各种插件</span></a></h2><h3 id="template的lib和插件" tabindex="-1"><a class="header-anchor" href="#template的lib和插件"><span>TEMPLATE的LIB和插件</span></a></h3><div class="language-properties line-numbers-mode" data-ext="properties" data-title="properties"><pre class="language-properties"><code><span class="token key attr-name">TEMPLATE</span> <span class="token punctuation">=</span> <span class="token value attr-value">LIB</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>包括lib、dll</p><p>其中插件是特殊的LIB模板</p><p>共同点和区别</p><table><thead><tr><th>C/C++文件</th><th>LIB模板</th><th>插件</th></tr></thead><tbody><tr><td></td><td></td><td>本质上也是LIB模板</td></tr><tr><td>与要使用的项目一同编译</td><td>不一同编译，生成dll和lib文件<br>补充：dll和lib区别在与何时链接</td><td>不一同编译，生成dll和lib文件<br>补充：dll和lib区别在与何时链接</td></tr><tr><td>同项目通过头文件使用</td><td>其他项目通过头文件使用</td><td>其他项目通过接口类的头文件使用</td></tr></tbody></table><h3 id="sharedplugin-qtplugin" tabindex="-1"><a class="header-anchor" href="#sharedplugin-qtplugin"><span>SharedPlugin &amp; QtPlugin</span></a></h3><blockquote><h4 id="分类" tabindex="-1"><a class="header-anchor" href="#分类"><span>分类</span></a></h4></blockquote><p>Qt支持两种插件方式：高级 API 和低级 API。</p><p>高级 API 指的的为Qt软件本身定制插件；</p><p>低级 API 指的是为自己写的软件定制插件。</p><p>这篇文章主要讲的是如何编写使用一个低级 API，文章属于入门级的，只是简单使用</p><blockquote><h4 id="区别" tabindex="-1"><a class="header-anchor" href="#区别"><span>区别</span></a></h4></blockquote><ul><li>SharedPlugin <ul><li>库 <ul><li>QtPlugin（定义接口集），QPluginLoader（加载插件）</li></ul></li><li>.pro <ul><li>指定DESTDIR，使情况INCLUDEPATH</li></ul></li><li>接口文件 <ul><li><code>#include &lt;QtPlugin&gt;</code></li><li>需要自定义接口</li></ul></li><li>.h <ul><li><code>#include 接口文件</code>并继承</li><li>声明宏：<code>Q_OBJECT</code>、<code>Q_PLUGIN_METADATA(IID 插件的标识符)</code>、<code>Q_INTERFACES(插件名)</code></li><li>需要实现插件接口</li><li>无<code>keys()</code>和<code>creator()</code></li></ul></li><li>使用插件 <ul><li>手动查找目录加载插件</li></ul></li></ul></li><li>QtPlugin <ul><li>库 <ul><li>QLibrary</li></ul></li><li>.pro <ul><li>指定DESTDIR，有<code>CONFIG += plugin</code></li></ul></li><li>接口文件 <ul><li>不需要自己定义</li></ul></li><li>.h <ul><li><code>#include 接口文件</code>并继承</li><li>声明宏：<code>Q_OBJECT</code>、<code>Q_PLUGIN_METADATA(IID 插件的标识符)</code>、<code>Q_INTERFACES(插件名)</code></li><li>需要实现插件接口</li><li>有<code>keys()</code>和<code>creator()</code></li></ul></li><li>使用插件 <ul><li>配置QApplication一下即可，甚至可以不改源代码直接用命令行实现</li></ul></li></ul></li><li>Qt4DesignerCustomWidget <ul><li>略</li></ul></li></ul><h3 id="qt-plugin-dll" tabindex="-1"><a class="header-anchor" href="#qt-plugin-dll"><span>Qt_Plugin &amp; DLL</span></a></h3>`,16)),n("p",null,[i[5]||(i[5]=e("参考地址：")),n("a",p,[i[4]||(i[4]=e("【CSDN】QT插件和普通动态库的差别？！")),l(t)])]),i[67]||(i[67]=s('<p>Qt 插件本身是动态库，除此之外，它定义了一组专用的接口，从动态库中导出，供 Qt 的插件管理体系发现和调用。 <strong>（即Qt插件在动态库的基础上多了一组专用接口）</strong></p><p>当你选择 Qt 插件项目模板时， QtCreator 会自动为你插入专用接口相关的模板代码。</p><p>假如你从一个白板做起，实现一个动态库，要想客户方调用，还是需要导出 N 多的函数。</p><p>而 Qt 这种，只是它约定了你需要导出什么函数、什么类、怎样查询你导出的接口，它定义了一套规范而已。</p><h3 id="关于库文件后缀" tabindex="-1"><a class="header-anchor" href="#关于库文件后缀"><span>关于库文件后缀</span></a></h3><p>Linux/Unix 系统里静态库扩展名一般是 .a，动态库扩展名一般是 .so 。Windows 系统里 VC 编译器用的静态库扩展名一般是 .lib，动态库扩展名一般是 .dll 。</p><p>MinGW 比较特殊，是将 GNU 工具集和链接库从 Linux/Unix 系统移植到 Windows 里， 有意思的情况就出现了，MinGW 使用的静态库扩展名为 .a ，而其动态库扩展名则为 .dll， .a 仅在生成目标程序过程中使用，.dll 则是在目标程序运行时使用。</p><h3 id="官网提供的插件example" tabindex="-1"><a class="header-anchor" href="#官网提供的插件example"><span>官网提供的插件Example</span></a></h3><p>官网有很多关于插件的Example</p><p>Example中搜索Plugin后的结果</p>',10)),n("table",null,[i[37]||(i[37]=n("thead",null,[n("tr",null,[n("th",null,"Name"),n("th",null,"Translate"),n("th",null,"Tag"),n("th",null,"Contain")])],-1)),n("tbody",null,[i[27]||(i[27]=n("tr",null,[n("td",null,"【Desginer】"),n("td"),n("td"),n("td")],-1)),n("tr",null,[n("td",null,[n("a",b,[i[6]||(i[6]=e("Custom widget Plugin Example")),l(t)]),i[8]||(i[8]=n("br",null,null,-1)),n("a",g,[i[7]||(i[7]=e("Analog Clock Example")),l(t)]),i[9]||(i[9]=e("（非插件）"))]),i[10]||(i[10]=n("td",null,[e("自定义控件"),n("br"),e("模拟时钟")],-1)),i[11]||(i[11]=n("td",null,[e("custom designer plugin widget"),n("br"),e("analog android clock ios widgets")],-1)),i[12]||(i[12]=n("td",null,[e("Designer Plugin"),n("br"),e("Non-Plugin Version")],-1))]),n("tr",null,[n("td",null,[n("a",h,[i[13]||(i[13]=e("World Time Clock Plugin Example")),l(t)]),i[14]||(i[14]=n("br",null,null,-1)),i[15]||(i[15]=e("+ World Time Colock Builder Example"))]),i[16]||(i[16]=n("td",null,"世界时钟",-1)),i[17]||(i[17]=n("td",null,[e("clock designer plugin time world"),n("br"),e("builder clock designer time world")],-1)),i[18]||(i[18]=n("td",null,[e("Designer Plugin"),n("br"),e("Normal")],-1))]),i[28]||(i[28]=n("tr",null,[n("td",null,"Container Extension Example"),n("td",null,"容器扩展"),n("td",null,"container designer extension"),n("td")],-1)),i[29]||(i[29]=n("tr",null,[n("td",null,"Task Muenu Extension Example"),n("td",null,"任务菜单"),n("td",null,"designer extension menu task"),n("td")],-1)),i[30]||(i[30]=n("tr",null,[n("td",null,"【Widget】"),n("td"),n("td"),n("td")],-1)),n("tr",null,[n("td",null,[n("a",Q,[i[19]||(i[19]=e("Echo Plugin Example")),l(t)])]),i[20]||(i[20]=n("td",null,"回声插件",-1)),i[21]||(i[21]=n("td",null,"echo plugin widget",-1)),i[22]||(i[22]=n("td",null,"SharedPlugin",-1))]),n("tr",null,[n("td",null,[n("a",k,[i[23]||(i[23]=e("Style Plugin Example")),l(t)])]),i[24]||(i[24]=n("td",null,"风格插件",-1)),i[25]||(i[25]=n("td",null,"plugin style widgets",-1)),i[26]||(i[26]=n("td",null,"QtPlugin - QStylePlugin",-1))]),i[31]||(i[31]=n("tr",null,[n("td",null,"Plugin & PaintBasic Tools Example"),n("td",null,"绘画"),n("td",null,"basic paint plug tools widgets"),n("td")],-1)),i[32]||(i[32]=n("tr",null,[n("td",null,"Plugin & Paint Example"),n("td",null,"绘画"),n("td",null,"paint plug widget"),n("td")],-1)),i[33]||(i[33]=n("tr",null,[n("td",null,"Plugin & Paint Extra Filters Example"),n("td",null,"绘画"),n("td",null,"extra filters paint plug widgets"),n("td")],-1)),i[34]||(i[34]=n("tr",null,[n("td",null,"【QML/Quick】"),n("td"),n("td"),n("td")],-1)),i[35]||(i[35]=n("tr",null,[n("td",null,"QML Plugin Example"),n("td",null,"QML插件"),n("td",null,"plugin qml"),n("td")],-1)),i[36]||(i[36]=n("tr",null,[n("td",null,"Qt Quick Controls - Flat Style"),n("td",null,"扁平化插件"),n("td",null,"android controls flat quick style"),n("td")],-1))])]),n("ul",null,[n("li",null,[i[43]||(i[43]=e("其他参考链接 ")),n("ul",null,[n("li",null,[n("a",q,[i[38]||(i[38]=e("【Qt官网】如何创建Qt插件 ")),l(t)]),i[39]||(i[39]=e("（Qt6.1 > 如何创建Qt插件）"))]),n("li",null,[n("a",P,[i[40]||(i[40]=e("【Qt官网】<QtPlugin>-定义插件")),l(t)]),i[41]||(i[41]=e("（Qt6.1 > Qt核心 > 插件类 > <QtPlugin>-定义插件）"))]),n("li",null,[n("a",C,[i[42]||(i[42]=e("【C语言中文网】Qt编程涉及的属于和名词")),l(t)])])])])]),i[68]||(i[68]=n("h2",{id:"【sharedplugin】qtplugin-qpluginloader",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#【sharedplugin】qtplugin-qpluginloader"},[n("span",null,"【SharedPlugin】QtPlugin + QPluginLoader")])],-1)),i[69]||(i[69]=n("p",null,"参考",-1)),n("ul",null,[n("li",null,[n("a",T,[i[44]||(i[44]=e("【CSDN】QT插件框架")),l(t)]),i[45]||(i[45]=e("，含demo"))])]),i[70]||(i[70]=s('<h3 id="原理简概" tabindex="-1"><a class="header-anchor" href="#原理简概"><span>原理简概</span></a></h3><p>原理</p><ul><li>原理：一个应用程序插件就是实现了一个或多个<code>接口</code>（<em>interface</em>）</li><li>接口：由专有的纯虚函数组成的类</li><li>应用程序和插件之间的通信：通过接口的<code>虚表</code>（<em>virtual table</em>）来完成的</li></ul><h3 id="实战-项目模板" tabindex="-1"><a class="header-anchor" href="#实战-项目模板"><span>实战 - 项目模板</span></a></h3><h4 id="创建项目模板" tabindex="-1"><a class="header-anchor" href="#创建项目模板"><span>创建项目模板</span></a></h4><p>库创建流程</p><ul><li>新建一个C库。文件 &gt; 新建项目 &gt; Library &gt; C库</li><li>【配置选择】Type 类型 <ul><li>Shared Library，动态库（默认项）</li><li>Statically Linked Library，静态链接库</li><li>Qt Plugin，Qt插件</li></ul></li><li>【配置选择】Qt module 模块 <ul><li>这个无关紧要，后期可以在.pro文件里改<code>Qt += XXX</code></li><li>当前面的Type选择了Shared Library / Statically Linked Library <ul><li>None</li><li>Core（默认项）</li><li>Gui</li><li>Widgets</li></ul></li><li>当前面的Type选择了Qt Plugin。这里选项更具体的解释见后面的表格 <ul><li>QAccessiblePlugin</li><li>QGenericPlugin，默认项</li><li>QIconEnginePlugin</li><li>QImageIOPlugin</li><li>QScriptExtensionPlugin</li><li>QSqlDriverPlugin</li><li>QStylePlugin</li></ul></li></ul></li><li>【配置选择】Qt插件名称 <ul><li>当前面的Type选择了Shared Library / Statically Linked Library <ul><li>根据库名自动起名</li></ul></li><li>当前面的Type选择了Qt Plugin <ul><li>根据选择的Qt module自动起名</li></ul></li></ul></li></ul><h4 id="项目模板结构" tabindex="-1"><a class="header-anchor" href="#项目模板结构"><span>项目模板结构</span></a></h4><p>略</p><h4 id="使用流程" tabindex="-1"><a class="header-anchor" href="#使用流程"><span>使用流程</span></a></h4>',10)),l(a,{id:"mermaid-780",code:""}),i[71]||(i[71]=s(`<h3 id="实战-网络demo" tabindex="-1"><a class="header-anchor" href="#实战-网络demo"><span>实战 - 网络demo</span></a></h3><h4 id="_1-准备接口集" tabindex="-1"><a class="header-anchor" href="#_1-准备接口集"><span>(1) 准备接口集</span></a></h4><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>#ifndef MAININTERFACE_H

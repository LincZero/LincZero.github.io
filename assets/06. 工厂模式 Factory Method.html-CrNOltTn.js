...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="分析-写法2" tabindex="-1"><a class="header-anchor" href="#分析-写法2"><span>分析 - 写法2</span></a></h4><p>（红色表示稳定）</p><p>代码结构</p>`,28),v=e("p",null,"运行时",-1),o=n('<p><code>面向接口编程</code>的一个显著特点是变量声明为抽象基类，写法2符合这一点，而且符合了<code>依赖倒置原则</code>——依赖抽象而不是实现细节</p><p>而且绕过了new方式以避开对具体类的依赖</p><p><mark>Q</mark>：为什么运行函数不直接传入Splitter进高层模块里</p><h2 id="设计模式" tabindex="-1"><a class="header-anchor" href="#设计模式"><span>设计模式</span></a></h2><h3 id="模式定义" tabindex="-1"><a class="header-anchor" href="#模式定义"><span>模式定义</span></a></h3><blockquote><p>定义一个用于创建对象的接口，让子类决定实例化哪一个类。 Factory Method使得一个类的实例化延迟（目的：解耦，手段︰虚函数）到子类。</p><p>——《设计模式》GoF</p></blockquote><h3 id="结构-structure" tabindex="-1"><a class="header-anchor" href="#结构-structure"><span>结构（Structure）</span></a></h3><blockquote><h4 id="新" tabindex="-1"><a class="header-anchor" href="#新"><span>新</span></a></h4></blockquote><p>原写法</p>',9),u=e("p",null,"修改后",-1),p=e("p",null,"使用时",-1),m=e("blockquote",null,[e("p",null,"这个例子其实比较难说明使用的意义，"),e("p",null,"只能说用BinarySplitterFactory代替BinarySplitter，使得BinarySplitter的创建由在main中延迟到了在MainForm中"),e("p",null,"使用场景有点类似于Web图片的懒加载、插件本体的慢加载等")],-1),b=e("blockquote",null,[e("h4",{id:"旧",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#旧"},[e("span",null,"旧")])])],-1),h=e("p",null,"（红色表示稳定）",-1),E=n('<h3 id="结合代码" tabindex="-1"><a class="header-anchor" href="#结合代码"><span>结合代码</span></a></h3><ul><li>Product相当于例程的ISplitter，ConcreteProduct相当于例程的BinarySplitter等类</li><li>Creator相当于例程的SplitterFactory，ConcreteCreaotr相当于例程的SplitterFactory等类</li></ul><h3 id="要点总结" tabindex="-1"><a class="header-anchor" href="#要点总结"><span>要点总结</span></a></h3><ul><li>Factory Method模式用于<strong>隔离类对象的使用者和具体类型</strong>之间的耦合关系。面对一个经常变化的具体类型，紧耦合关系（new）会导致软件的脆弱</li><li>Factory Method模式通过面向对象的手法，将所要创建的具体对象工作<strong>延迟</strong>到子类，从而实现一种<strong>扩展</strong>（而非更改）的策略，较好地解决了这种紧耦合关系</li><li>Factory Method模式解决 “单个对象” 的需求变化。缺点在于要求创建方法/参数相同</li></ul>',4);function A(F,S){const i=a("Mermaid");return r(),s("div",null,[c,l(i,{id:"mermaid-121",code:""}),v,l(i,{id:"mermaid-125",code:""}),o,l(i,{id:"mermaid-160",code:"eJxLzkksLnbJTEwvSszlAnMU3DJzUoMLcjJLSlKLoEIhFSVoIgGZySWlRejqwjJTUvPhYgBRziLF"}),u,l(i,{id:"mermaid-164",code:""}),p,m,l(i,{id:"mermaid-179",code:"eJxLzkksLnbJTEwvSszlAnMUchMz87hAhIKurp2CU2ZeYlFlcEFOZklJapFbYnJJflElQtoXyHDLL8q1UniyZ8HT7Uuf9jU937ibiwurNiwGQu3Eqryai9O5KDWxJBUmrqGp4AnXWIvLEhtdXbizoMbDuEAT0VRrKaRBvcTpVFpSkp8Xn5yTmZwNtKkotaS0KA/FQgARW2+1"}),b,h,l(i,{id:"mermaid-188",code:""}),E])}const B=t(d,[["render",A],["__file","06. 工厂模式 Factory Method.html.vue"]]),x=JSON.parse('{"path":"/MdNote_Public/01.%20%E8%AE%BE%E8%AE%A1%E5%BC%80%E5%8F%91%E4%B8%8E%E6%95%B0%E6%8D%AE%E7%94%9F%E4%BA%A7/Develop/03.%20Tools/02.%20%E7%AE%A1%E7%90%86%E5%B1%82/01.%20%E5%A4%9A%E7%B1%BB%E7%AE%A1%E7%90%86/%E8%AE%BE%E8%AE%A1%E6%A8%A1%E5%BC%8F/%E3%80%8AC__%E8%AE%BE%E8%AE%A1%E6%A8%A1%E5%BC%8F%E3%80%8B%E8%A7%86%E9%A2%91_%E6%9D%8E%E5%BB%BA%E5%BF%A0/06.%20%E5%B7%A5%E5%8E%82%E6%A8%A1%E5%BC%8F%20Factory%20Method.html","title":"工厂模式 Factory Method","lang":"zh-CN","frontmatter":{"description":"工厂模式 Factory Method 全程 工厂方法模式，有时简称 工厂方法，有时简称 工厂模式 所属分类——“对象创建” 模式 “对象创建” 模式 通过 “对象创建” 模式绕开new，来避免对象创建（new）过程中所导致的紧耦合（依赖具体类），从而支持对象创建的稳定。 它是接口抽象之后的第一步工作。 典型模式 工厂模式 Factory Method...","head":[["meta",{"property":"og:url","content":"http://192.168.0.101:8080/MdNote_Public/01.%20%E8%AE%BE%E8%AE%A1%E5%BC%80%E5%8F%91%E4%B8%8E%E6%95%B0%E6%8D%AE%E7%94%9F%E4%BA%A7/Develop/03.%20Tools/02.%20%E7%AE%A1%E7%90%86%E5%B1%82/01.%20%E5%A4%9A%E7%B1%BB%E7%AE%A1%E7%90%86/%E8%AE%BE%E8%AE%A1%E6%A8%A1%E5%BC%8F/%E3%80%8AC__%E8%AE%BE%E8%AE%A1%E6%A8%A1%E5%BC%8F%E3%80%8B%E8%A7%86%E9%A2%91_%E6%9D%8E%E5%BB%BA%E5%BF%A0/06.%20%E5%B7%A5%E5%8E%82%E6%A8%A1%E5%BC%8F%20Factory%20Method.html"}],["meta",{"property":"og:site_name","content":"Linc 的小站"}],["meta",{"property":"og:title","content":"工厂模式 Factory Method"}],["meta",{"property":"og:description","content":"工厂模式 Factory Method 全程 工厂方法模式，有时简称 工厂方法，有时简称 工厂模式 所属分类——“对象创建” 模式 “对象创建” 模式 通过 “对象创建” 模式绕开new，来避免对象创建（new）过程中所导致的紧耦合（依赖具体类），从而支持对象创建的稳定。 它是接口抽象之后的第一步工作。 典型模式 工厂模式 Factory Method..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"article:author","content":"LincZero"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"工厂模式 Factory Method\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"LincZero\\",\\"url\\":\\"https://github.com/LincZero/\\"}]}"]]},"headers":[{"level":1,"title":"工厂模式 Factory Method","slug":"工厂模式-factory-method","link":"#工厂模式-factory-method","children":[{"level":2,"title":"所属分类——“对象创建” 模式","slug":"所属分类——-对象创建-模式","link":"#所属分类——-对象创建-模式","children":[]},{"level":2,"title":"动机（Motivation）","slug":"动机-motivation","link":"#动机-motivation","children":[{"level":3,"title":"简概","slug":"简概","link":"#简概","children":[]},{"level":3,"title":"核心：对象的晚创建，原来的早创建对象由工厂类进行代替","slug":"核心-对象的晚创建-原来的早创建对象由工厂类进行代替","link":"#核心-对象的晚创建-原来的早创建对象由工厂类进行代替","children":[]},{"level":3,"title":"代码体现","slug":"代码体现","link":"#代码体现","children":[{"level":4,"title":"举例 - 写法1","slug":"举例-写法1","link":"#举例-写法1","children":[]},{"level":4,"title":"分析 - 写法1","slug":"分析-写法1","link":"#分析-写法1","children":[]},{"level":4,"title":"举例 - 写法2","slug":"举例-写法2","link":"#举例-写法2","children":[]},{"level":4,"title":"分析 - 写法2","slug":"分析-写法2","link":"#分析-写法2","children":[]}]}]},{"level":2,"title":"设计模式","slug":"设计模式","link":"#设计模式","children":[{"level":3,"title":"模式定义","slug":"模式定义","link":"#模式定义","children":[]},{"level":3,"title":"结构（Structure）","slug":"结构-structure","link":"#结构-structure","children":[]},{"level":3,"title":"结合代码","slug":"结合代码","link":"#结合代码","children":[]},{"level":3,"title":"要点总结","slug":"要点总结","link":"#要点总结","children":[]}]}]}],"git":{"createdTime":null,"updatedTime":null,"contributors":[]},"readingTime":{"minutes":5.48,"words":1645},"filePathRelative":"MdNote_Public/01. 设计开发与数据生产/Develop/03. Tools/02. 管理层/01. 多类管理/设计模式/《C++设计模式》视频_李建忠/06. 工厂模式 Factory Method.md","autoDesc":true}');export{B as comp,x as data};

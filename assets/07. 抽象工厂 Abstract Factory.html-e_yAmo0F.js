...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="分析-写法2-工厂方法" tabindex="-1"><a class="header-anchor" href="#分析-写法2-工厂方法"><span>分析 - 写法2（工厂方法）</span></a></h4><p>代码结构</p>`,25),v=c("p",null,"运行时",-1),o=i(`<p>分析，存在的问题</p><ul><li>工厂之间具有关联性</li></ul><h4 id="举例-写法3-抽象工厂" tabindex="-1"><a class="header-anchor" href="#举例-写法3-抽象工厂"><span>举例 - 写法3（抽象工厂）</span></a></h4><p>抽象基类</p><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>// 数据库访问有关基类
class IDBConnection{		// 数据库连接

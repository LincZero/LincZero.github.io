import{_ as a}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as s,o as r,c as u,a as e,b as n,d as i,e as t}from"./app-CYOpdadG.js";const c={},o=t('<h1 id="qt" tabindex="-1"><a class="header-anchor" href="#qt"><span>Qt</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="dll-so-插件文件-创建插件" tabindex="-1"><a class="header-anchor" href="#dll-so-插件文件-创建插件"><span>.dll.so 插件文件 &amp; 创建插件</span></a></h1><p>注：插件的笔记之前因为系统崩溃而坏掉了（5k多字啊，大大的惨），所以我不得不重新写了一遍，所以内容可能会有点缺失</p><p>可另参考另一篇笔记：<strong>Dev &gt; Tools &gt; 辅助文件 &gt; 动态库和静态库</strong></p><p>参考</p>',6),v={href:"https://doc.qt.io/qt-5/plugins-howto.html",target:"_blank",rel:"noopener noreferrer"},m={href:"https://blog.51cto.com/u_9291927/2107320#h11",target:"_blank",rel:"noopener noreferrer"},p=e("li",null,[n("https://blog.csdn.net/Mr_robot_strange/article/details/108469284，"),e("strong",null,"自定义到设计师界面")],-1),b=t(`<h2 id="各种插件" tabindex="-1"><a class="header-anchor" href="#各种插件"><span>各种插件</span></a></h2><h3 id="template的lib和插件" tabindex="-1"><a class="header-anchor" href="#template的lib和插件"><span>TEMPLATE的LIB和插件</span></a></h3><div class="language-properties line-numbers-mode" data-ext="properties" data-title="properties"><pre class="language-properties"><code><span class="token key attr-name">TEMPLATE</span> <span class="token punctuation">=</span> <span class="token value attr-value">LIB</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>包括lib、dll</p><p>其中插件是特殊的LIB模板</p><p>共同点和区别</p><table><thead><tr><th>C/C++文件</th><th>LIB模板</th><th>插件</th></tr></thead><tbody><tr><td></td><td></td><td>本质上也是LIB模板</td></tr><tr><td>与要使用的项目一同编译</td><td>不一同编译，生成dll和lib文件<br>补充：dll和lib区别在与何时链接</td><td>不一同编译，生成dll和lib文件<br>补充：dll和lib区别在与何时链接</td></tr><tr><td>同项目通过头文件使用</td><td>其他项目通过头文件使用</td><td>其他项目通过接口类的头文件使用</td></tr></tbody></table><h3 id="sharedplugin-qtplugin" tabindex="-1"><a class="header-anchor" href="#sharedplugin-qtplugin"><span>SharedPlugin &amp; QtPlugin</span></a></h3><blockquote><h4 id="分类" tabindex="-1"><a class="header-anchor" href="#分类"><span>分类</span></a></h4></blockquote><p>Qt支持两种插件方式：高级 API 和低级 API。</p><p>高级 API 指的的为Qt软件本身定制插件；</p><p>低级 API 指的是为自己写的软件定制插件。</p><p>这篇文章主要讲的是如何编写使用一个低级 API，文章属于入门级的，只是简单使用</p><blockquote><h4 id="区别" tabindex="-1"><a class="header-anchor" href="#区别"><span>区别</span></a></h4></blockquote><ul><li>SharedPlugin <ul><li>库 <ul><li>QtPlugin（定义接口集），QPluginLoader（加载插件）</li></ul></li><li>.pro <ul><li>指定DESTDIR，使情况INCLUDEPATH</li></ul></li><li>接口文件 <ul><li><code>#include &lt;QtPlugin&gt;</code></li><li>需要自定义接口</li></ul></li><li>.h <ul><li><code>#include 接口文件</code>并继承</li><li>声明宏：<code>Q_OBJECT</code>、<code>Q_PLUGIN_METADATA(IID 插件的标识符)</code>、<code>Q_INTERFACES(插件名)</code></li><li>需要实现插件接口</li><li>无<code>keys()</code>和<code>creator()</code></li></ul></li><li>使用插件 <ul><li>手动查找目录加载插件</li></ul></li></ul></li><li>QtPlugin <ul><li>库 <ul><li>QLibrary</li></ul></li><li>.pro <ul><li>指定DESTDIR，有<code>CONFIG += plugin</code></li></ul></li><li>接口文件 <ul><li>不需要自己定义</li></ul></li><li>.h <ul><li><code>#include 接口文件</code>并继承</li><li>声明宏：<code>Q_OBJECT</code>、<code>Q_PLUGIN_METADATA(IID 插件的标识符)</code>、<code>Q_INTERFACES(插件名)</code></li><li>需要实现插件接口</li><li>有<code>keys()</code>和<code>creator()</code></li></ul></li><li>使用插件 <ul><li>配置QApplication一下即可，甚至可以不改源代码直接用命令行实现</li></ul></li></ul></li><li>Qt4DesignerCustomWidget <ul><li>略</li></ul></li></ul><h3 id="qt-plugin-dll" tabindex="-1"><a class="header-anchor" href="#qt-plugin-dll"><span>Qt_Plugin &amp; DLL</span></a></h3>`,16),g={href:"https://bbs.csdn.net/topics/390843246?page=1",target:"_blank",rel:"noopener noreferrer"},h=t('<p>Qt 插件本身是动态库，除此之外，它定义了一组专用的接口，从动态库中导出，供 Qt 的插件管理体系发现和调用。 <strong>（即Qt插件在动态库的基础上多了一组专用接口）</strong></p><p>当你选择 Qt 插件项目模板时， QtCreator 会自动为你插入专用接口相关的模板代码。</p><p>假如你从一个白板做起，实现一个动态库，要想客户方调用，还是需要导出 N 多的函数。</p><p>而 Qt 这种，只是它约定了你需要导出什么函数、什么类、怎样查询你导出的接口，它定义了一套规范而已。</p><h3 id="关于库文件后缀" tabindex="-1"><a class="header-anchor" href="#关于库文件后缀"><span>关于库文件后缀</span></a></h3><p>Linux/Unix 系统里静态库扩展名一般是 .a，动态库扩展名一般是 .so 。Windows 系统里 VC 编译器用的静态库扩展名一般是 .lib，动态库扩展名一般是 .dll 。</p><p>MinGW 比较特殊，是将 GNU 工具集和链接库从 Linux/Unix 系统移植到 Windows 里， 有意思的情况就出现了，MinGW 使用的静态库扩展名为 .a ，而其动态库扩展名则为 .dll， .a 仅在生成目标程序过程中使用，.dll 则是在目标程序运行时使用。</p><h3 id="官网提供的插件example" tabindex="-1"><a class="header-anchor" href="#官网提供的插件example"><span>官网提供的插件Example</span></a></h3><p>官网有很多关于插件的Example</p><p>Example中搜索Plugin后的结果</p>',10),Q=e("thead",null,[e("tr",null,[e("th",null,"Name"),e("th",null,"Translate"),e("th",null,"Tag"),e("th",null,"Contain")])],-1),_=e("tr",null,[e("td",null,"【Desginer】"),e("td"),e("td"),e("td")],-1),k={href:"https://doc.qt.io/qt-6/qtdesigner-customwidgetplugin-example.html",target:"_blank",rel:"noopener noreferrer"},q=e("br",null,null,-1),C={href:"https://doc.qt.io/qt-6/qtwidgets-widgets-analogclock-example.html",target:"_blank",rel:"noopener noreferrer"},P=e("td",null,[n("自定义控件"),e("br"),n("模拟时钟")],-1),E=e("td",null,[n("custom designer plugin widget"),e("br"),n("analog android clock ios widgets")],-1),T=e("td",null,[n("Designer Plugin"),e("br"),n("Non-Plugin Version")],-1),f={href:"https://doc.qt.io/qt-6/qtdesigner-worldtimeclockplugin-example.html",target:"_blank",rel:"noopener noreferrer"},x=e("br",null,null,-1),y=e("td",null,"世界时钟",-1),I=e("td",null,[n("clock designer plugin time world"),e("br"),n("builder clock designer time world")],-1),S=e("td",null,[n("Designer Plugin"),e("br"),n("Normal")],-1),L=e("tr",null,[e("td",null,"Container Extension Example"),e("td",null,"容器扩展"),e("td",null,"container designer extension"),e("td")],-1),w=e("tr",null,[e("td",null,"Task Muenu Extension Example"),e("td",null,"任务菜单"),e("td",null,"designer extension menu task"),e("td")],-1),A=e("tr",null,[e("td",null,"【Widget】"),e("td"),e("td"),e("td")],-1),D={href:"https://doc.qt.io/qt-6/qtwidgets-tools-echoplugin-example.html",target:"_blank",rel:"noopener noreferrer"},W=e("td",null,"回声插件",-1),B=e("td",null,"echo plugin widget",-1),N=e("td",null,"SharedPlugin",-1),O={href:"https://doc.qt.io/qt-6/qtwidgets-tools-styleplugin-example.html",target:"_blank",rel:"noopener noreferrer"},M=e("td",null,"风格插件",-1),G=e("td",null,"plugin style widgets",-1),U=e("td",null,"QtPlugin - QStylePlugin",-1),F=e("tr",null,[e("td",null,"Plugin & PaintBasic Tools Example"),e("td",null,"绘画"),e("td",null,"basic paint plug tools widgets"),e("td")],-1),R=e("tr",null,[e("td",null,"Plugin & Paint Example"),e("td",null,"绘画"),e("td",null,"paint plug widget"),e("td")],-1),z=e("tr",null,[e("td",null,"Plugin & Paint Extra Filters Example"),e("td",null,"绘画"),e("td",null,"extra filters paint plug widgets"),e("td")],-1),H=e("tr",null,[e("td",null,"【QML/Quick】"),e("td"),e("td"),e("td")],-1),j=e("tr",null,[e("td",null,"QML Plugin Example"),e("td",null,"QML插件"),e("td",null,"plugin qml"),e("td")],-1),X=e("tr",null,[e("td",null,"Qt Quick Controls - Flat Style"),e("td",null,"扁平化插件"),e("td",null,"android controls flat quick style"),e("td")],-1),V={href:"https://doc.qt.io/qt-6/plugins-howto.html",target:"_blank",rel:"noopener noreferrer"},$={href:"https://doc.qt.io/qt-6/qtplugin.html",target:"_blank",rel:"noopener noreferrer"},J={href:"http://c.biancheng.net/view/3871.html",target:"_blank",rel:"noopener noreferrer"},K=e("h2",{id:"【sharedplugin】qtplugin-qpluginloader",tabindex:"-1"},[e("a",{class:"header-anchor",href:"#【sharedplugin】qtplugin-qpluginloader"},[e("span",null,"【SharedPlugin】QtPlugin + QPluginLoader")])],-1),Z=e("p",null,"参考",-1),Y={href:"https://blog.csdn.net/u011370855/article/details/82924752",target:"_blank",rel:"noopener noreferrer"},ee=t('<h3 id="原理简概" tabindex="-1"><a class="header-anchor" href="#原理简概"><span>原理简概</span></a></h3><p>原理</p><ul><li>原理：一个应用程序插件就是实现了一个或多个<code>接口</code>（<em>interface</em>）</li><li>接口：由专有的纯虚函数组成的类</li><li>应用程序和插件之间的通信：通过接口的<code>虚表</code>（<em>virtual table</em>）来完成的</li></ul><h3 id="实战-项目模板" tabindex="-1"><a class="header-anchor" href="#实战-项目模板"><span>实战 - 项目模板</span></a></h3><h4 id="创建项目模板" tabindex="-1"><a class="header-anchor" href="#创建项目模板"><span>创建项目模板</span></a></h4><p>库创建流程</p><ul><li>新建一个C库。文件 &gt; 新建项目 &gt; Library &gt; C库</li><li>【配置选择】Type 类型 <ul><li>Shared Library，动态库（默认项）</li><li>Statically Linked Library，静态链接库</li><li>Qt Plugin，Qt插件</li></ul></li><li>【配置选择】Qt module 模块 <ul><li>这个无关紧要，后期可以在.pro文件里改<code>Qt += XXX</code></li><li>当前面的Type选择了Shared Library / Statically Linked Library <ul><li>None</li><li>Core（默认项）</li><li>Gui</li><li>Widgets</li></ul></li><li>当前面的Type选择了Qt Plugin。这里选项更具体的解释见后面的表格 <ul><li>QAccessiblePlugin</li><li>QGenericPlugin，默认项</li><li>QIconEnginePlugin</li><li>QImageIOPlugin</li><li>QScriptExtensionPlugin</li><li>QSqlDriverPlugin</li><li>QStylePlugin</li></ul></li></ul></li><li>【配置选择】Qt插件名称 <ul><li>当前面的Type选择了Shared Library / Statically Linked Library <ul><li>根据库名自动起名</li></ul></li><li>当前面的Type选择了Qt Plugin <ul><li>根据选择的Qt module自动起名</li></ul></li></ul></li></ul><h4 id="项目模板结构" tabindex="-1"><a class="header-anchor" href="#项目模板结构"><span>项目模板结构</span></a></h4><p>略</p><h4 id="使用流程" tabindex="-1"><a class="header-anchor" href="#使用流程"><span>使用流程</span></a></h4>',10),ne=t(`<h3 id="实战-网络demo" tabindex="-1"><a class="header-anchor" href="#实战-网络demo"><span>实战 - 网络demo</span></a></h3><h4 id="_1-准备接口集" tabindex="-1"><a class="header-anchor" href="#_1-准备接口集"><span>(1) 准备接口集</span></a></h4><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>#ifndef MAININTERFACE_H

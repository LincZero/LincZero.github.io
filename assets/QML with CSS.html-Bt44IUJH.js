import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,e}from"./app-Df0PcTb6.js";const t={},p=e(`<h2 id="原生qml的麻烦之处" tabindex="-1"><a class="header-anchor" href="#原生qml的麻烦之处"><span>原生QML的麻烦之处</span></a></h2><p>在QML文档上直接上样式是有点麻烦的，而且如果你本身就比较熟悉CSS，那么用CSS样式无疑更好</p><p>例如：实现单边边框在QML中是麻烦的，参考：https://codeantenna.com/a/KYFKNlv9CA</p><div class="language-javascript line-numbers-mode" data-ext="js" data-title="js"><pre class="language-javascript"><code>Rectangle <span class="token punctuation">{</span>

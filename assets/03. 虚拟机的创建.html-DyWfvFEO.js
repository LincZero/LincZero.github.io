import{_ as t}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as l,e,a,b as n}from"./app-C7SjGLJX.js";const r="/assets/image 9-BUON3QE3.webp",i={},o=e(`<h1 id="虚拟机的创建" tabindex="-1"><a class="header-anchor" href="#虚拟机的创建"><span>虚拟机的创建</span></a></h1><h2 id="创建虚拟机" tabindex="-1"><a class="header-anchor" href="#创建虚拟机"><span>创建虚拟机</span></a></h2><h3 id="创建虚拟机方式" tabindex="-1"><a class="header-anchor" href="#创建虚拟机方式"><span>创建虚拟机方式</span></a></h3><p>比如我们要创建ubuntu 22.04的虚拟机，参考官网资料： https://app.vagrantup.com/ubuntu/boxes/jammy64</p><h4 id="方式一-vagrantfile" tabindex="-1"><a class="header-anchor" href="#方式一-vagrantfile"><span>方式一：Vagrantfile</span></a></h4><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token comment"># 1. 创建Vagrantfile文件，并填充内容</span>

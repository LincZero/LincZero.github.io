...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="举例-写法2-1" tabindex="-1"><a class="header-anchor" href="#举例-写法2-1"><span>举例 - 写法2</span></a></h4><p>重构思路</p><ul><li>状态可能会增多，而Operation却相对稳定。所以让状态去继承同一个抽象基类，状态去实现Operation，以便进行扩展</li></ul><p>代码结构</p>`,29)),i(t,{id:"mermaid-120",code:""}),e[1]||(e[1]=n('<h2 id="设计模式" tabindex="-1"><a class="header-anchor" href="#设计模式"><span>设计模式</span></a></h2><h3 id="模式定义" tabindex="-1"><a class="header-anchor" href="#模式定义"><span>模式定义</span></a></h3><blockquote><p>允许一个对象在其内部状态改变时改变它的行为。从而使对象看起来似乎修改了其行为。</p><p>——《设计模式》GoF</p></blockquote><h3 id="结构-structure" tabindex="-1"><a class="header-anchor" href="#结构-structure"><span>结构（Structure）</span></a></h3><p>（红色表示稳定）</p>',5)),i(t,{id:"mermaid-141",code:""}),i(t,{id:"mermaid-142",code:"eJxLL0osyFDwCeJyjHbOzytJrShReNrW+nTdzuezWp517X2xceHT+bueb9wdq6v3tKf16YTVz3raX07q0NO1c4oOLkksSVV43rXtWUMjunLr5JzE4mIFR4Wi1BQo2wnE5gKzXVLTQByFtMycHCvlNMs0neKSovzsVCtlY2NjKFu3PDOlJMPKpKDCmgsAA0xLcg=="}),e[2]||(e[2]=n('<h3 id="要点总结" tabindex="-1"><a class="header-anchor" href="#要点总结"><span>要点总结</span></a></h3><ul><li>State模式将所有与一个特定状态相关的行为都放入一个State的子类对象中，在对象状态切换时，切换相应的对象； 但同时维持State的接口，这样实现了<strong>具体操作与状态转换之间的解耦</strong>。</li><li>为不同的状态引入不同的对象使得<strong>状态转换变得更加明确</strong>，而且可以保证不会出现状态不一致的情况，因为<strong>转换是原子性的</strong>——即要么彻底转换过来，要么不转换。</li><li>如果State对象没有实例变量，那么各个上下文可以共享同一个State对象，从而节省对象开销。</li></ul><h3 id="个人体会" tabindex="-1"><a class="header-anchor" href="#个人体会"><span>个人体会</span></a></h3><p>和策略模式非常相像。感觉是多了 “状态转换” 的需求，通过状态类包含pNext指针来实现</p>',4))])}const u=l(r,[["render",v],["__file","16. 状态模式 State.html.vue"]]),m=JSON.parse('{"path":"/MdNote_Public/01.%20DesignAndDevelop/Develop/03.%20Tools/02.%20%E7%AE%A1%E7%90%86%E5%B1%82/01.%20%E5%A4%9A%E7%B1%BB%E7%AE%A1%E7%90%86/%E8%AE%BE%E8%AE%A1%E6%A8%A1%E5%BC%8F/%E3%80%8AC__%E8%AE%BE%E8%AE%A1%E6%A8%A1%E5%BC%8F%E3%80%8B%E8%A7%86%E9%A2%91_%E6%9D%8E%E5%BB%BA%E5%BF%A0/16.%20%E7%8A%B6%E6%80%81%E6%A8%A1%E5%BC%8F%20State.html","title":"《C++设计模式》视频_李建忠","lang":"zh-CN","frontmatter":{"description":"《C++设计模式》视频_李建忠 目录 [toc] 状态模式 State 所属分类——“状态变化” 模式 \\"状态变化\\" 模式 在组件构建过程中，某些对象的状态经常面临变化，如何对这些变化进行有效的管理？同时又维持高层模块的稳定？ “状态变化\\" 模式为这一问题提供了一种解决方案 典型模式 状态模式 State 备忘录模式 Memento 动机（Motiva...","head":[["meta",{"property":"og:url","content":"https://LincZero.github.io/undefined/MdNote_Public/01.%20DesignAndDevelop/Develop/03.%20Tools/02.%20%E7%AE%A1%E7%90%86%E5%B1%82/01.%20%E5%A4%9A%E7%B1%BB%E7%AE%A1%E7%90%86/%E8%AE%BE%E8%AE%A1%E6%A8%A1%E5%BC%8F/%E3%80%8AC__%E8%AE%BE%E8%AE%A1%E6%A8%A1%E5%BC%8F%E3%80%8B%E8%A7%86%E9%A2%91_%E6%9D%8E%E5%BB%BA%E5%BF%A0/16.%20%E7%8A%B6%E6%80%81%E6%A8%A1%E5%BC%8F%20State.html"}],["meta",{"property":"og:site_name","content":"Linc 的小站"}],["meta",{"property":"og:title","content":"《C++设计模式》视频_李建忠"}],["meta",{"property":"og:description","content":"《C++设计模式》视频_李建忠 目录 [toc] 状态模式 State 所属分类——“状态变化” 模式 \\"状态变化\\" 模式 在组件构建过程中，某些对象的状态经常面临变化，如何对这些变化进行有效的管理？同时又维持高层模块的稳定？ “状态变化\\" 模式为这一问题提供了一种解决方案 典型模式 状态模式 State 备忘录模式 Memento 动机（Motiva..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"article:author","content":"LincZero"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"《C++设计模式》视频_李建忠\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"LincZero\\",\\"url\\":\\"https://github.com/LincZero/\\"}]}"]]},"headers":[{"level":1,"title":"《C++设计模式》视频_李建忠","slug":"《c-设计模式》视频-李建忠","link":"#《c-设计模式》视频-李建忠","children":[]},{"level":1,"title":"目录","slug":"目录","link":"#目录","children":[]},{"level":1,"title":"状态模式 State","slug":"状态模式-state","link":"#状态模式-state","children":[{"level":2,"title":"所属分类——“状态变化” 模式","slug":"所属分类——-状态变化-模式","link":"#所属分类——-状态变化-模式","children":[]},{"level":2,"title":"动机（Motivation）","slug":"动机-motivation","link":"#动机-motivation","children":[{"level":3,"title":"简概","slug":"简概","link":"#简概","children":[]},{"level":3,"title":"代码体现","slug":"代码体现","link":"#代码体现","children":[{"level":4,"title":"举例 - 写法1","slug":"举例-写法1","link":"#举例-写法1","children":[]},{"level":4,"title":"举例 - 写法2","slug":"举例-写法2","link":"#举例-写法2","children":[]},{"level":4,"title":"举例 - 写法2","slug":"举例-写法2-1","link":"#举例-写法2-1","children":[]}]}]},{"level":2,"title":"设计模式","slug":"设计模式","link":"#设计模式","children":[{"level":3,"title":"模式定义","slug":"模式定义","link":"#模式定义","children":[]},{"level":3,"title":"结构（Structure）","slug":"结构-structure","link":"#结构-structure","children":[]},{"level":3,"title":"要点总结","slug":"要点总结","link":"#要点总结","children":[]},{"level":3,"title":"个人体会","slug":"个人体会","link":"#个人体会","children":[]}]}]}],"git":{"createdTime":null,"updatedTime":null,"contributors":[]},"readingTime":{"minutes":4.55,"words":1365},"filePathRelative":"MdNote_Public/01. DesignAndDevelop/Develop/03. Tools/02. 管理层/01. 多类管理/设计模式/《C++设计模式》视频_李建忠/16. 状态模式 State.md","excerpt":"\\n<h1>目录</h1>\\n<p>[toc]</p>\\n<h1>状态模式 State</h1>\\n<h2>所属分类——“状态变化” 模式</h2>\\n<ul>\\n<li>\\"状态变化\\" 模式\\n<ul>\\n<li>在组件构建过程中，<strong>某些对象的状态经常面临变化</strong>，如何对这些变化进行有效的管理？同时又维持高层模块的稳定？\\n“状态变化\\" 模式为这一问题提供了一种解决方案</li>\\n</ul>\\n</li>\\n<li>典型模式\\n<ul>\\n<li>状态模式 State</li>\\n<li>备忘录模式 Memento</li>\\n</ul>\\n</li>\\n</ul>\\n<h2>动机（Motivation）</h2>","autoDesc":true,"bioChainData":{"outlink":[],"backlink":[],"localMap":{"nodes":[{"id":"MdNote_Public/01. DesignAndDevelop/Develop/03. Tools/02. 管理层/01. 多类管理/设计模式/《C++设计模式》视频_李建忠/16. 状态模式 State.md","value":{"title":"16. 状态模式 State","path":"MdNote_Public/01. DesignAndDevelop/Develop/03. Tools/02. 管理层/01. 多类管理/设计模式/《C++设计模式》视频_李建忠/16. 状态模式 State.md","outlink":[],"backlink":[]}}],"links":[]}}}');export{u as comp,m as data};

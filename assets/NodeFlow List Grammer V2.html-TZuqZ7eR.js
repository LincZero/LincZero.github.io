...
- edges
  ...
  - a1,r, c11,l
  - a1,r, d,l
`}),n[12]||(n[12]=i("h2",{id:"实际用例参考",tabindex:"-1"},"实际用例参考",-1)),t(o,{data:[{id:"Plugin effect (插件效果)"},{id:"md source code (md源码)"}]},{title0:e(({value:l,isActive:a})=>n[3]||(n[3]=[s("Plugin effect (插件效果)")])),title1:e(({value:l,isActive:a})=>n[4]||(n[4]=[s("md source code (md源码)")])),tab0:e(({value:l,isActive:a})=>[t(d,{type:"nodeflow-list",data:`- nodes
  - node1:KSample
    - Latent, o
    - model, i
    - positive, i

...
venv					<span class="token comment"># （基本同Python安装目录）python虚拟环境</span>
	...
	pyvenv.cfg
main.py
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="windows下编译" tabindex="-1"><a class="header-anchor" href="#windows下编译"><span>Windows下编译</span></a></h2><h3 id="编译" tabindex="-1"><a class="header-anchor" href="#编译"><span>编译</span></a></h3>`,18),v={href:"https://blog.csdn.net/weixin_35055546/article/details/113642957",target:"_blank",rel:"noopener noreferrer"},p=i(`<ul><li>双击PCbuild/pcbuild.sln，打开解决方案，切换到debug win32</li><li>解决方案右键 &gt; 属性 &gt; 配置属性 &gt; 配置 仅勾选项目python和pythoncore（这里仅编译python和pythoncore，其他模块暂时忽略）</li><li>再“生成解决方案”，生成目录为PCbuild/win32</li><li>将项目python设为启动项目(默认状态即是启动项目)，点击调试，运行得到如下控制台，可以像平时使用python一样，与之交互。</li></ul><h3 id="编译后的目录" tabindex="-1"><a class="header-anchor" href="#编译后的目录"><span>编译后的目录</span></a></h3><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code>python.exe
python.pdb
python37.dll
python37.exp
python37.lib

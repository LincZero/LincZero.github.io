import{_ as i,c as p,a as e,b as s,d as a,e as l,o as c,r as o}from"./app-Dk2XlTVI.js";const u={},d={href:"http://www.boost.org/doc/libs/1_49_0/libs/regex/doc/html/boost_regex/syntax/perl_syntax.html",target:"_blank",rel:"noopener noreferrer"},r={href:"https://github.com/hchunhui/librime-lua",target:"_blank",rel:"noopener noreferrer"};function k(v,n){const t=o("ExternalLinkIcon");return c(),p("div",null,[n[11]||(n[11]=e(`<h1 id="schema-yaml-详解" tabindex="-1"><a class="header-anchor" href="#schema-yaml-详解"><span>Schema.yaml 详解</span></a></h1><blockquote><p>原文: https://github.com/LEOYoon-Tsaw/Rime_collections/blob/master/Rime_description.md 更新时间：2022/04/26</p></blockquote><h2 id="开始之前" tabindex="-1"><a class="header-anchor" href="#开始之前"><span>开始之前</span></a></h2><div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre class="language-yaml"><code><span class="token comment"># Rime schema</span>

import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,a as e}from"./app-CMEFroyS.js";const i={},t=e(`<h1 id="pyqt-node-editor" tabindex="-1"><a class="header-anchor" href="#pyqt-node-editor"><span>PyQt_Node_Editor</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="类的实现与设计" tabindex="-1"><a class="header-anchor" href="#类的实现与设计"><span>类的实现与设计</span></a></h1><h2 id="节点编辑器实现" tabindex="-1"><a class="header-anchor" href="#节点编辑器实现"><span>节点编辑器实现</span></a></h2><h3 id="使用原理" tabindex="-1"><a class="header-anchor" href="#使用原理"><span>使用原理</span></a></h3><p>![image-20220523122936511](02. 类的实现与设计.assets/image-20220523122936511.png)</p><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>ads::CDockWidget* dockWidget = new ads::CDockWidget(i.value());

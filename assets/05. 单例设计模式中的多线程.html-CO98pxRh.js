import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as i,c as n,e as l}from"./app-DtBZtuIa.js";const s={},d=l(`<h1 id="多线程-单例设计模式中的多线程" tabindex="-1"><a class="header-anchor" href="#多线程-单例设计模式中的多线程"><span>多线程 - 单例设计模式中的多线程</span></a></h1><h2 id="单例设计模式简概" tabindex="-1"><a class="header-anchor" href="#单例设计模式简概"><span>单例设计模式简概</span></a></h2><h3 id="设计模式简概" tabindex="-1"><a class="header-anchor" href="#设计模式简概"><span>设计模式简概</span></a></h3><p><mark>（详见设计模式相关的笔记）</mark></p><p>略</p><h3 id="单例模式例程" tabindex="-1"><a class="header-anchor" href="#单例模式例程"><span>单例模式例程</span></a></h3><p><mark>（详见设计模式相关的笔记）</mark></p><p>在设计模式中，使用频率比较高</p><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>class Single
{
private:
    Single(){}

import{a as e,c as t,f as n,g as r,h as i,m as a,p as o,u as s}from"./app-s9ZLnBRD.js";var c=JSON.parse(`{"path":"/MdNote_Public/ProductDoc/Plugin/NodeFlow/README.show.html","title":"README.show","lang":"zh-CN","frontmatter":{"description":"README.show comfyui - samply comfyui - complex obsidian canvas list （list grammar 更多案例和语法规则详见 ./docs/zh/NodeFlow List Grammer ） vueflow/reactflow Github Action Workflow (use lis...","head":[["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"README.show\\",\\"image\\":[\\"\\"],\\"dateModified\\":null,\\"author\\":[]}"],["meta",{"property":"og:url","content":"https://LincZero.github.io/MdNote_Public/ProductDoc/Plugin/NodeFlow/README.show.html"}],["meta",{"property":"og:site_name","content":"Linc 的小站"}],["meta",{"property":"og:title","content":"README.show"}],["meta",{"property":"og:description","content":"README.show comfyui - samply comfyui - complex obsidian canvas list （list grammar 更多案例和语法规则详见 ./docs/zh/NodeFlow List Grammer ） vueflow/reactflow Github Action Workflow (use lis..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"zh-CN"}]]},"git":{},"readingTime":{"minutes":29.95,"words":8986},"filePathRelative":"MdNote_Public/ProductDoc/Plugin/NodeFlow/README.show.md","excerpt":"\\n<h2>comfyui - samply</h2>\\n<h2>comfyui - complex</h2>\\n<h2>obsidian canvas</h2>\\n<h2>list</h2>\\n<p>（list grammar 更多案例和语法规则详见 <a class=\\"route-link nolebase-route-link-invalid\\" href=\\"#\\" target=\\"_target\\">./docs/zh/NodeFlow List Grammer</a> ）</p>\\n\\n<h2>vueflow/reactflow</h2>\\n<h2>Github Action Workflow</h2>\\n","autoDesc":true,"bioChainData":{"outlink":[{"title":"README.Demo","link":"MdNote_Public/ProductDoc/Plugin/NodeFlow/README.Demo.html"}],"backlink":[],"localMap":{"nodes":[{"id":"MdNote_Public/ProductDoc/Plugin/NodeFlow/README.show.md","value":{"title":"README.show","path":"MdNote_Public/ProductDoc/Plugin/NodeFlow/README.show.md","outlink":["MdNote_Public/ProductDoc/Plugin/NodeFlow/README.Demo.md"],"backlink":[]}},{"id":"MdNote_Public/ProductDoc/Plugin/NodeFlow/README.Demo.md","value":{"title":"README.Demo","path":"MdNote_Public/ProductDoc/Plugin/NodeFlow/README.Demo.md","outlink":[],"backlink":[]}}],"links":[{"source":"MdNote_Public/ProductDoc/Plugin/NodeFlow/README.show.md","target":"MdNote_Public/ProductDoc/Plugin/NodeFlow/README.Demo.md"}]}}}`),l={name:`README.show.md`};function u(e,c,l,u,d,f){let p=i(`VueFlow`),m=i(`Tabs`),h=i(`RouteLink`);return a(),s(`div`,null,[c[5]||=t(`h1`,{id:`readme-show`,tabindex:`-1`},`README.show`,-1),c[6]||=t(`h2`,{id:`comfyui-samply`,tabindex:`-1`},`comfyui - samply`,-1),o(p,{type:`nodeflow-comfyui`,data:`{
  "last_node_id": 10,
  "last_link_id": 9,
  "nodes": [
    {
...
`}),c[9]||=t(`h2`,{id:`list`,tabindex:`-1`},`list`,-1),c[10]||=t(`p`,null,[n(`（list grammar 更多案例和语法规则详见 `),t(`a`,{class:`route-link nolebase-route-link-invalid`,href:`#`,target:`_target`},`./docs/zh/NodeFlow List Grammer`),n(` ）`)],-1),o(m,{data:[{id:`Plugin effect (插件效果)`},{id:`md source code (md源码)`}]},{title0:r(({value:e,isActive:t})=>[...c[0]||=[n(`Plugin effect (插件效果)`,-1)]]),title1:r(({value:e,isActive:t})=>[...c[1]||=[n(`md source code (md源码)`,-1)]]),tab0:r(({value:e,isActive:t})=>[o(p,{type:`nodeflow-list`,data:`- nodes
  - node1:KSample
    - Latent, o
    - model, i
    - positive, i
...
`})]),tab1:r(({value:e,isActive:r})=>[...c[2]||=[t(`div`,{class:`language-md line-numbers-mode`,"data-highlighter":`shiki`,"data-ext":`md`,style:{"--shiki-light":`#383A42`,"--shiki-dark":`#abb2bf`,"--shiki-light-bg":`#FAFAFA`,"--shiki-dark-bg":`#282c34`}},[t(`pre`,{class:`shiki shiki-themes one-light one-dark-pro vp-code`},[t(`code`,{class:`language-md`},[t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},"```nodeflow-list")]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`- nodes`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`  - node1:KSample`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - Latent, o`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - model, i`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - positive, i`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - negative, i`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - Latent, i`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - seed,`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - control_after_generate,, randomize`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - steps,, 20`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - CFG,, 8.0`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - sampler_name,, euler`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - scheduler,, normal`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - denoise,, 1.00`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - io defaultTest, i , test`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - io defaultTest, o, test`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - t1:noValueTest,`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - t2:,, noKeyTest`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`      mul lines test`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`  - node2:KSample`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - 潜空间, o`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - 模型, i`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - 正面条件, i`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - 负面条件, i`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - 潜空间, i`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - 种子,`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - 运行后操作,`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - 步数,`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - CFG,`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - 采样器/采样方法,`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - 调度器,`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`    - 降噪,`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`  - translate`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`- edges`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`  - node1,Latent, translate,l`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},`  - translate,r, node2, 潜空间`)]),n(`
`),t(`span`,{class:`line`},[t(`span`,{style:{"--shiki-light":`#383A42`,"--shiki-dark":`#ABB2BF`}},"```")])])]),t(`div`,{class:`line-numbers`,"aria-hidden":`true`,style:{"counter-reset":`line-number 0`}},[t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`}),t(`div`,{class:`line-number`})])],-1)]]),_:1}),c[11]||=t(`h2`,{id:`vueflow-reactflow`,tabindex:`-1`},`vueflow/reactflow`,-1),o(p,{type:`nodeflow-vueflow`,data:`{
  "nodes": [
...
`}),c[12]||=t(`h2`,{id:`github-action-workflow`,tabindex:`-1`},`Github Action Workflow`,-1),c[13]||=t(`p`,null,`(use list grammer)`,-1),c[14]||=t(`p`,null,`This is an example workflow for my personal website (这是我个人网站的一个示例工作流程)`,-1),o(p,{type:`nodeflow-list`,data:`- nodes
  - build
  - report-build-status
  - deploy
...
- edges
  ...
  - build,r, deploy,l
`}),c[15]||=t(`h2`,{id:`listitem`,tabindex:`-1`},`listitem`,-1),t(`p`,null,[c[4]||=n(`see `,-1),o(h,{to:`/MdNote_Public/ProductDoc/Plugin/NodeFlow/README.Demo.html`},{default:r(()=>[...c[3]||=[n(`./README.Demo`,-1)]]),_:1})])])}var d=e(l,[[`render`,u]]);export{c as _pageData,d as default};
import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as n,c as t,a as l}from"./app-D9ahr8AM.js";const i={},a=l(`<h1 id="c" tabindex="-1"><a class="header-anchor" href="#c"><span>C++</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="仿函数" tabindex="-1"><a class="header-anchor" href="#仿函数"><span>仿函数</span></a></h1><h2 id="大小比较仿函数" tabindex="-1"><a class="header-anchor" href="#大小比较仿函数"><span>大小比较仿函数</span></a></h2><ul><li><p><strong>“ 所有 algorithms，其内最终涉及元素本身的操作，无非就是比大小 ”</strong></p></li><li><p>仿函数的用法</p><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>bool strLonger(const string&amp; s1, const string&amp; s2){

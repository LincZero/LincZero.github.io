import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as l,c as a,e as n}from"./app-yixEWCFr.js";const i={},d=n(`<h1 id="dll-compiled-by-all-language" tabindex="-1"><a class="header-anchor" href="#dll-compiled-by-all-language"><span>DLL Compiled By All Language</span></a></h1><h1 id="目录" tabindex="-1"><a class="header-anchor" href="#目录"><span>目录</span></a></h1><h1 id="eprogram-dll-use" tabindex="-1"><a class="header-anchor" href="#eprogram-dll-use"><span>EProgram_Dll_Use</span></a></h1><h2 id="工程模板" tabindex="-1"><a class="header-anchor" href="#工程模板"><span>工程模板</span></a></h2><p>创建控制台程序即可</p><p>程序集1</p><div class="language-c++ line-numbers-mode" data-ext="c++" data-title="c++"><pre class="language-c++"><code>.版本 2

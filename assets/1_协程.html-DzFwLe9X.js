import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,a as t}from"./app-BLOlimVU.js";const p={},e=t(`<h1 id="协程" tabindex="-1"><a class="header-anchor" href="#协程"><span>协程</span></a></h1><h2 id="协程-goroutine" tabindex="-1"><a class="header-anchor" href="#协程-goroutine"><span>协程 (Goroutine)</span></a></h2><h3 id="启动协程-go关键字" tabindex="-1"><a class="header-anchor" href="#启动协程-go关键字"><span>启动协程 (go关键字)</span></a></h3><p>语言级的并发，语法非常简单，只要调用函数 (还能是立即执行函数) 前加一个 <code>go</code> 关键词，体现了go的&quot;优雅哲学&quot;</p><div class="language-go line-numbers-mode" data-ext="go" data-title="go"><pre class="language-go"><code><span class="token keyword">package</span> main 

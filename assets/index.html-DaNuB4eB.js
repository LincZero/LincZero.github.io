...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="自用conda-公司" tabindex="-1"><a class="header-anchor" href="#自用conda-公司"><span>自用conda (公司)</span></a></h4>`,184)),s("ul",null,[n[4]||(n[4]=s("li",null,"ubuntu 20.04",-1)),s("li",null,[n[2]||(n[2]=a("conda3 ")),s("s",null,[s("a",u,[n[0]||(n[0]=a("2023.09-0-Linux-x86_64")),t(e)])]),n[3]||(n[3]=a()),s("a",v,[n[1]||(n[1]=a("mini版")),t(e)])]),n[5]||(n[5]=s("li",null,"python 3.9.0",-1)),n[6]||(n[6]=s("li",null,"git",-1))]),n[8]||(n[8]=i(`<div class="language-docker line-numbers-mode" data-ext="docker" data-title="docker"><pre class="language-docker"><code><span class="token comment"># 使用 Ubuntu 20.04 作为基础镜像</span>
<span class="token instruction"><span class="token keyword">FROM</span> ubuntu:20.04</span>
